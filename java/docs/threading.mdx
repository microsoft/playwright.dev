...
execution is paused use [Page.waitForTimeout()](/api/class-page.mdx#page-wait-for-timeout) or [Frame.waitForTimeout()](/api/class-frame.mdx#frame-wait-for-timeout):
