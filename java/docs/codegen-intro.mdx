...
###### 
<ProgressiveImage image={require("../images/getting-started/record-test-java.webp")} alt="recording a test" />
...
###### 
<ProgressiveImage image={require("../images/getting-started/pick-locator-java.webp")} alt="picking a locator" />
