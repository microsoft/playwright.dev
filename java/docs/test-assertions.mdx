...
- `values`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="locator-assertions-to-have-values-option-values"/> &#60;[List]<[String]|[Pattern]>&#62; Expected options currently selected.<a href="#locator-assertions-to-have-values-option-values" class="list-anchor">#</a>
