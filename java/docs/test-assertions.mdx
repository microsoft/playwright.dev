...
- `value`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="locator-assertions-to-have-attribute-option-value"/> &#60;[String]|[Pattern]&#62; Optional expected attribute value. If missing, method will assert attribute presence. <font size="2">Added in: v1.18</font><a href="#locator-assertions-to-have-attribute-option-value" class="list-anchor">#</a>
