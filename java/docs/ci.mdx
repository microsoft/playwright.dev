...
pool:
  vmImage: ubuntu-latest
container: mcr.microsoft.com/playwright/java:v1.37.0-jammy
...
executors:
  pw-jammy-development:
    docker:
      - image: mcr.microsoft.com/playwright/java:v1.37.0-jammy
```
...
```groovy
pipeline {
   agent { docker { image 'mcr.microsoft.com/playwright/java:v1.37.0-jammy' } }
   stages {
      stage('e2e-tests') {
         steps {
