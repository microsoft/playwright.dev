...
pool:
  vmImage: ubuntu-latest
container: mcr.microsoft.com/playwright/java:v1.41.1-jammy
...
executors:
  pw-jammy-development:
    docker:
      - image: mcr.microsoft.com/playwright/java:v1.41.1-jammy
```
...
```groovy
pipeline {
   agent { docker { image 'mcr.microsoft.com/playwright/java:v1.41.1-jammy' } }
   stages {
      stage('e2e-tests') {
         steps {
