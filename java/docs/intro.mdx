...
Running it downloads the Playwright package and installs browser binaries for Chromium, Firefox and WebKit. To modify this behavior see [installation parameters](./installation.mdx).
...
Command Line Interface [CLI](./cli.mdx) can be used to record user interactions and generate Java code.
