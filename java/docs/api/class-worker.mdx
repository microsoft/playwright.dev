...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="worker-wait-for-close-param-options"/> &#60;`Worker.WaitForCloseOptions`&#62;<a href="#worker-wait-for-close-param-options" class="list-anchor">#</a>
  - `setTimeout`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="worker-wait-for-close-option-timeout"/> &#60;[double]&#62; Maximum time to wait for in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can be changed by using the [BrowserContext.setDefaultTimeout(timeout)](./api/class-browsercontext.mdx#browser-context-set-default-timeout).<a href="#worker-wait-for-close-option-timeout" class="list-anchor">#</a>
- `callback`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="worker-wait-for-close-param-callback"/> &#60;[Runnable]&#62; Callback that performs the action triggering the event.<a href="#worker-wait-for-close-param-callback" class="list-anchor">#</a>
