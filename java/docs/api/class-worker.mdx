...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>worker.onClose(handler)</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>worker.evaluateHandle</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.10</font><span style={{visibility: 'hidden'}}>worker.waitForClose</span>
