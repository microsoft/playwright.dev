...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="worker-wait-for-close-option-options"/> &#60;`Worker.WaitForCloseOptions`&#62;<a href="#worker-wait-for-close-option-options" class="list-anchor">#</a>
