...
- `options` &#60;`Worker.WaitForCloseOptions`&#62;
  - `setTimeout` &#60;[double]&#62; Maximum time to wait for in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can be changed by using the [BrowserContext.setDefaultTimeout()](/api/class-browsercontext.mdx#browser-context-set-default-timeout). <font size="2">Added in: v1.9</font><a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="worker-wait-for-close-option-timeout"/><a href="#worker-wait-for-close-option-timeout" class="list-anchor">#</a>
- `callback` &#60;[Runnable]&#62; Callback that performs the action triggering the event. <font size="2">Added in: v1.9</font><a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="worker-wait-for-close-option-callback"/><a href="#worker-wait-for-close-option-callback" class="list-anchor">#</a>
