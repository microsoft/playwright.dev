...
- `callback`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="worker-wait-for-close-option-callback"/> &#60;[Runnable]&#62; Callback that performs the action triggering the event.<a href="#worker-wait-for-close-option-callback" class="list-anchor">#</a>
