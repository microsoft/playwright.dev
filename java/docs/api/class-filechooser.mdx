...
- `files` [Path] | [Path]&#91;&#93; | `FilePayload` | `FilePayload`&#91;&#93;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="file-chooser-set-files-option-files"/><a href="#file-chooser-set-files-option-files" class="list-anchor">#</a>
  - `setName` [String]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="file-chooser-set-files-option-files-name"/><a href="#file-chooser-set-files-option-files-name" class="list-anchor">#</a>
    
    File name
  - `setMimeType` [String]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="file-chooser-set-files-option-files-mime-type"/><a href="#file-chooser-set-files-option-files-mime-type" class="list-anchor">#</a>
    
    File type
  - `setBuffer` [byte&#91;&#93;]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="file-chooser-set-files-option-files-buffer"/><a href="#file-chooser-set-files-option-files-buffer" class="list-anchor">#</a>
