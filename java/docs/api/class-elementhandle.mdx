...
- `options` `ElementHandle.ScreenshotOptions` *(optional)*
  ...
  - `setMaskColor` [String] *(optional)* <font size="2">Added in: v1.34</font><a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="element-handle-screenshot-option-mask-color"/><a href="#element-handle-screenshot-option-mask-color" class="list-anchor">#</a>
