...
**Returns**
- [null] | PausedDetails<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="debugger-paused-details-return"/><a href="#debugger-paused-details-return" class="list-anchor">#</a>
  - `location` Location
    - `file` [String]
