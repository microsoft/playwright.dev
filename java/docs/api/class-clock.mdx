...
- `options` `Clock.InstallOptions` *(optional)*
  - `setTime` [int] | [String] | [Date] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="clock-install-option-time"/><a href="#clock-install-option-time" class="list-anchor">#</a>
