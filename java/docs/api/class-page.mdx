...
- `options` `Page.AddLocatorHandlerOptions` *(optional)*
  - `setAllowStayingVisible` [boolean] *(optional)* <font size="2">Added in: v1.44</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-add-locator-handler-option-allow-staying-visible"/><a href="#page-add-locator-handler-option-allow-staying-visible" class="list-anchor">#</a>
...
- `handler` [Consumer]&lt;[Locator]&gt; <font size="2">Added in: v1.44</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-add-locator-handler-option-handler"/><a href="#page-add-locator-handler-option-handler" class="list-anchor">#</a>
