...
manually via [Page.onDialog(handler)](/api/class-page.mdx#page-event-dialog) event.
:::
...
with [Page.onRequestFinished(handler)](/api/class-page.mdx#page-event-request-finished) event and not with [Page.onRequestFailed(handler)](/api/class-page.mdx#page-event-request-failed). A request will only be considered
