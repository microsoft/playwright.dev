...
- `options` `Page.AriaSnapshotOptions` *(optional)*
  ...
  - `setMode` `enum AriaSnapshotMode { AI, DEFAULT }` *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-aria-snapshot-option-mode"/><a href="#page-aria-snapshot-option-mode" class="list-anchor">#</a>
  ...
  - `setTimeout` [double] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-aria-snapshot-option-timeout"/><a href="#page-aria-snapshot-option-timeout" class="list-anchor">#</a>
...
- `options` `Page.ConsoleMessagesOptions` *(optional)*
  - `setFilter` `enum ConsoleMessagesFilter { ALL, SINCE_NAVIGATION }` *(optional)* <font size="2">Added in: v1.59</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-console-messages-option-filter"/><a href="#page-console-messages-option-filter" class="list-anchor">#</a>
...
- `options` `Page.ContentOptions` *(optional)*
  - `setIncludeShadow` [boolean] *(optional)* <font size="2">Added in: v1.64</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-content-option-include-shadow"/><a href="#page-content-option-include-shadow" class="list-anchor">#</a>
...
- `options` `Page.DragAndDropOptions` *(optional)*
  ...
  - `setNoWaitAfter` [boolean] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-drag-and-drop-option-no-wait-after"/><a href="#page-drag-and-drop-option-no-wait-after" class="list-anchor">#</a>
    ...
    This option has no effect.
  - `setScroll` `enum ScrollMode { AUTO, NONE }` *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-drag-and-drop-option-scroll"/><a href="#page-drag-and-drop-option-scroll" class="list-anchor">#</a>
...
- `options` `Page.GetByRoleOptions` *(optional)*
  ...
  - `setDescription` [String] | [Pattern] *(optional)* <font size="2">Added in: v1.60</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-get-by-role-option-description"/><a href="#page-get-by-role-option-description" class="list-anchor">#</a>
...
### onDialogClosed(handler) {/* #page-event-dialog-closed */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.63</font><x-search>page.onDialogClosed(handler)</x-search>
...
- `options` `Page.CheckOptions` *(optional)*
  ...
  - `setScroll` `enum ScrollMode { AUTO, NONE }` *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-check-option-scroll"/><a href="#page-check-option-scroll" class="list-anchor">#</a>
...
- `options` `Page.ClickOptions` *(optional)*
  ...
  - `setPosition` Position *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-click-option-position"/><a href="#page-click-option-position" class="list-anchor">#</a>
    ...
    A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
  - `setScroll` `enum ScrollMode { AUTO, NONE }` *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-click-option-scroll"/><a href="#page-click-option-scroll" class="list-anchor">#</a>
...
- `options` `Page.DblclickOptions` *(optional)*
  ...
  - `setPosition` Position *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-dblclick-option-position"/><a href="#page-dblclick-option-position" class="list-anchor">#</a>
    ...
    A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
  - `setScroll` `enum ScrollMode { AUTO, NONE }` *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-dblclick-option-scroll"/><a href="#page-dblclick-option-scroll" class="list-anchor">#</a>
...
- `options` `Page.HoverOptions` *(optional)*
  ...
  - `setPosition` Position *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-hover-option-position"/><a href="#page-hover-option-position" class="list-anchor">#</a>
    ...
    A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
  - `setScroll` `enum ScrollMode { AUTO, NONE }` *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-hover-option-scroll"/><a href="#page-hover-option-scroll" class="list-anchor">#</a>
...
- `options` `Page.SetCheckedOptions` *(optional)*
  ...
  - `setPosition` Position *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-set-checked-option-position"/><a href="#page-set-checked-option-position" class="list-anchor">#</a>
    ...
    A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
  - `setScroll` `enum ScrollMode { AUTO, NONE }` *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-set-checked-option-scroll"/><a href="#page-set-checked-option-scroll" class="list-anchor">#</a>
...
- `options` `Page.TapOptions` *(optional)*
  ...
  - `setPosition` Position *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-tap-option-position"/><a href="#page-tap-option-position" class="list-anchor">#</a>
    ...
    A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
  - `setScroll` `enum ScrollMode { AUTO, NONE }` *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-tap-option-scroll"/><a href="#page-tap-option-scroll" class="list-anchor">#</a>
...
- `options` `Page.UncheckOptions` *(optional)*
  ...
  - `setPosition` Position *(optional)* <font size="2">Added in: v1.11</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-uncheck-option-position"/><a href="#page-uncheck-option-position" class="list-anchor">#</a>
    ...
    A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
  - `setScroll` `enum ScrollMode { AUTO, NONE }` *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-uncheck-option-scroll"/><a href="#page-uncheck-option-scroll" class="list-anchor">#</a>
