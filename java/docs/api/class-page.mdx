...
- `handler` `LocatorHandler`<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-handle-locator-option-handler"/><a href="#page-handle-locator-option-handler" class="list-anchor">#</a>
