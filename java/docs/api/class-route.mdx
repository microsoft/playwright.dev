...
- `options` &#60;`Route.FulfillOptions`&#62;
  ...
  - `setResponse`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fulfill-option-response"/> &#60;[FetchResponse]&#62; [FetchResponse] to fulfill route's request with. Individual fields of the response (such as headers) can be overridden using fulfill options.<a href="#route-fulfill-option-response" class="list-anchor">#</a>
