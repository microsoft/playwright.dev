...
- `options` `BrowserType.LaunchPersistentContextOptions` *(optional)*
  ...
  - `setContrast` [null] | `enum ForcedColors { NO_PREFERENCE, MORE }` *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-launch-persistent-context-option-contrast"/><a href="#browser-type-launch-persistent-context-option-contrast" class="list-anchor">#</a>
