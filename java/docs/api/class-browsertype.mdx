...
- `options` `BrowserType.LaunchPersistentContextOptions` *(optional)*
  ...
  - `setClientCertificates` [List]&lt;ClientCertificates&gt; *(optional)* <font size="2">Added in: 1.46</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-launch-persistent-context-option-client-certificates"/><a href="#browser-type-launch-persistent-context-option-client-certificates" class="list-anchor">#</a>
    - `setUrl` [String] <font size="2">Added in: 1.46</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-launch-persistent-context-option-url"/><a href="#browser-type-launch-persistent-context-option-url" class="list-anchor">#</a>
      
      Glob pattern to match the URLs that the certificate is valid for.
    - `setCerts` [List]&lt;Certs&gt; <font size="2">Added in: 1.46</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-launch-persistent-context-option-certs"/><a href="#browser-type-launch-persistent-context-option-certs" class="list-anchor">#</a>
