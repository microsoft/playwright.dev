...
- `script`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="selectors-register-option-script"/> &#60;[String]|[Path]&#62; Script that evaluates to a selector engine instance.<a href="#selectors-register-option-script" class="list-anchor">#</a>
