...
- `options` `Keyboard.TypeOptions` *(optional)*
  ...
  - `setNamedKeys` [boolean] *(optional)* <font size="2">Added in: v1.61</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="keyboard-type-option-named-keys"/><a href="#keyboard-type-option-named-keys" class="list-anchor">#</a>
