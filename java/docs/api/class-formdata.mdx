...
- `value` [String] | [boolean] | [int] | [Path] | Value<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-append-option-value"/><a href="#form-data-append-option-value" class="list-anchor">#</a>
  - `setName` [String]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-append-option-value-name"/><a href="#form-data-append-option-value-name" class="list-anchor">#</a>
    
    File name
  - `setMimeType` [String]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-append-option-value-mime-type"/><a href="#form-data-append-option-value-mime-type" class="list-anchor">#</a>
    
    File type
  - `setBuffer` [byte&#91;&#93;]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-append-option-value-buffer"/><a href="#form-data-append-option-value-buffer" class="list-anchor">#</a>
...
- `value` [String] | [boolean] | [int] | [Path] | Value<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-set-option-value"/><a href="#form-data-set-option-value" class="list-anchor">#</a>
  - `setName` [String]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-set-option-value-name"/><a href="#form-data-set-option-value-name" class="list-anchor">#</a>
    
    File name
  - `setMimeType` [String]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-set-option-value-mime-type"/><a href="#form-data-set-option-value-mime-type" class="list-anchor">#</a>
    
    File type
  - `setBuffer` [byte&#91;&#93;]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-set-option-value-buffer"/><a href="#form-data-set-option-value-buffer" class="list-anchor">#</a>
