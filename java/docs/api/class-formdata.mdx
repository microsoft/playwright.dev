...
- `value` [String] | [boolean] | [int] | [Path] | Value<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-append-option-value"/><a href="#form-data-append-option-value" class="list-anchor">#</a>
  - `setName` [String] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-append-option-name"/><a href="#form-data-append-option-name" class="list-anchor">#</a>
    
    File name
  - `setMimeType` [String] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-append-option-mime-type"/><a href="#form-data-append-option-mime-type" class="list-anchor">#</a>
    
    File type
  - `setBuffer` [byte&#91;&#93;] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-append-option-buffer"/><a href="#form-data-append-option-buffer" class="list-anchor">#</a>
...
- `value` [String] | [boolean] | [int] | [Path] | Value<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-set-option-value"/><a href="#form-data-set-option-value" class="list-anchor">#</a>
  - `setName` [String] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-set-option-name"/><a href="#form-data-set-option-name" class="list-anchor">#</a>
    
    File name
  - `setMimeType` [String] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-set-option-mime-type"/><a href="#form-data-set-option-mime-type" class="list-anchor">#</a>
    
    File type
  - `setBuffer` [byte&#91;&#93;] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-set-option-buffer"/><a href="#form-data-set-option-buffer" class="list-anchor">#</a>
