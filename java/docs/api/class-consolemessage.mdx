...
[ConsoleMessage] objects are dispatched by page via the [Page.onConsoleMessage(handler)](./api/class-page.mdx#pageonconsolemessagehandler) event.


- [ConsoleMessage.args()](./api/class-consolemessage.mdx#consolemessageargs)
- [ConsoleMessage.location()](./api/class-consolemessage.mdx#consolemessagelocation)
- [ConsoleMessage.text()](./api/class-consolemessage.mdx#consolemessagetext)
- [ConsoleMessage.type()](./api/class-consolemessage.mdx#consolemessagetype)
