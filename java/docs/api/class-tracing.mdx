...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-start-option-options"/> &#60;`Tracing.StartOptions`&#62;<a href="#tracing-start-option-options" class="list-anchor">#</a>
...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-stop-option-options"/> &#60;`Tracing.StopOptions`&#62;<a href="#tracing-stop-option-options" class="list-anchor">#</a>
