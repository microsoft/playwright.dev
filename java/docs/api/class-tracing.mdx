...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-start-param-options"/> &#60;`Tracing.StartOptions`&#62;<a href="#tracing-start-param-options" class="list-anchor">#</a>
...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-stop-param-options"/> &#60;`Tracing.StopOptions`&#62;<a href="#tracing-stop-param-options" class="list-anchor">#</a>
