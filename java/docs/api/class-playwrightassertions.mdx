...
- [PlaywrightAssertions.assertThat(page)](./api/class-playwrightassertions.mdx#playwright-assertions-assert-that)

## PlaywrightAssertions.assertThat(page) {#playwright-assertions-assert-that}
- `page`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="playwright-assertions-assert-that-option-page"/> &#60;[Page]&#62; [Page] object to use for assertions.<a href="#playwright-assertions-assert-that-option-page" class="list-anchor">#</a>
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="playwright-assertions-assert-that-return"/> &#60;[PageAssertions]&#62;<a href="#playwright-assertions-assert-that-return" class="list-anchor">#</a>
