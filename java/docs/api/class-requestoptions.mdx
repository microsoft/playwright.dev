...
#### Parameters
- `failOnStatusCode` &#60;[boolean]&#62; Whether to throw on response codes other than 2xx and 3xx. By default response object is returned for all status codes.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-options-set-fail-on-status-code-option-fail-on-status-code"/><a href="#request-options-set-fail-on-status-code-option-fail-on-status-code" class="list-anchor">#</a>
...
#### Parameters
- `form` &#60;[FormData]&#62; Form data to be serialized as html form using `application/x-www-form-urlencoded` encoding and sent as this request body.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-options-set-form-option-form"/><a href="#request-options-set-form-option-form" class="list-anchor">#</a>
...
#### Parameters
- `name` &#60;[String]&#62; Header name.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-options-set-header-option-name"/><a href="#request-options-set-header-option-name" class="list-anchor">#</a>
- `value` &#60;[String]&#62; Header value.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-options-set-header-option-value"/><a href="#request-options-set-header-option-value" class="list-anchor">#</a>
...
#### Parameters
- `ignoreHTTPSErrors` &#60;[boolean]&#62; Whether to ignore HTTPS errors when sending network requests.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-options-set-ignore-https-errors-option-ignore-https-errors"/><a href="#request-options-set-ignore-https-errors-option-ignore-https-errors" class="list-anchor">#</a>
...
#### Parameters
- `maxRedirects` &#60;[int]&#62; Maximum number of request redirects that will be followed automatically. An error will be thrown if the number is exceeded. Defaults to `20`. Pass `0` to not follow redirects.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-options-set-max-redirects-option-max-redirects"/><a href="#request-options-set-max-redirects-option-max-redirects" class="list-anchor">#</a>
...
#### Parameters
- `method` &#60;[String]&#62; Request method, e.g. [POST](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods/POST).<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-options-set-method-option-method"/><a href="#request-options-set-method-option-method" class="list-anchor">#</a>
...
#### Parameters
- `form` &#60;[FormData]&#62; Form data to be serialized as html form using `multipart/form-data` encoding and sent as this request body.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-options-set-multipart-option-form"/><a href="#request-options-set-multipart-option-form" class="list-anchor">#</a>
...
#### Parameters
- `name` &#60;[String]&#62; Parameter name.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-options-set-query-param-option-name"/><a href="#request-options-set-query-param-option-name" class="list-anchor">#</a>
- `value` &#60;[String]|[boolean]|[int]&#62; Parameter value.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-options-set-query-param-option-value"/><a href="#request-options-set-query-param-option-value" class="list-anchor">#</a>
...
#### Parameters
- `timeout` &#60;[double]&#62; Request timeout in milliseconds.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-options-set-timeout-option-timeout"/><a href="#request-options-set-timeout-option-timeout" class="list-anchor">#</a>
