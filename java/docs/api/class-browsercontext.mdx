...
**Returns**
- [boolean]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-is-closed-return"/><a href="#browser-context-is-closed-return" class="list-anchor">#</a>
...
- `options` `BrowserContext.StorageStateOptions` *(optional)*
  - `setCredentials` [boolean] *(optional)* <font size="2">Added in: v1.61</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-storage-state-option-credentials"/><a href="#browser-context-storage-state-option-credentials" class="list-anchor">#</a>
  ...
  - `setOpfs` [boolean] *(optional)* <font size="2">Added in: v1.63</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-storage-state-option-opfs"/><a href="#browser-context-storage-state-option-opfs" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.61</font><x-search>browserContext.credentials()</x-search>
...
### onDialogClosed(handler) {/* #browser-context-event-dialog-closed */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.63</font><x-search>browserContext.onDialogClosed(handler)</x-search>

Emitted when a JavaScript dialog in any page belonging to this context has been closed, either by [Dialog.accept()](/api/class-dialog.mdx#dialog-accept), by [Dialog.dismiss()](/api/class-dialog.mdx#dialog-dismiss), or manually by the user in the headed browser.

**Usage**

```java
BrowserContext.onDialogClosed(handler)
```
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.onDownload(handler)</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.onFrameAttached(handler)</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.onFrameDetached(handler)</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.onFrameNavigated(handler)</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.onPageClose(handler)</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.onPageLoad(handler)</x-search>
