...
#### Parameters
- `script` &#60;[String]|[Path]&#62; Script to be evaluated in all pages in the browser context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-add-init-script-option-script"/><a href="#browser-context-add-init-script-option-script" class="list-anchor">#</a>
...
#### Parameters
- `urls` &#60;[String]|[List]<[String]>&#62; Optional list of URLs.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-cookies-option-urls"/><a href="#browser-context-cookies-option-urls" class="list-anchor">#</a>
...
- `callback` &#60;`BindingCallback`&#62; Callback function that will be called in the Playwright's context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-expose-binding-option-callback"/><a href="#browser-context-expose-binding-option-callback" class="list-anchor">#</a>
- `options` &#60;`BrowserContext.ExposeBindingOptions`&#62;
  - `setHandle` &#60;[boolean]&#62; Whether to pass the argument as a handle, instead of passing by value. When passing a handle, only one argument is supported. When passing by value, multiple arguments are supported.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-expose-binding-option-handle"/><a href="#browser-context-expose-binding-option-handle" class="list-anchor">#</a>
...
- `callback` &#60;`FunctionCallback`&#62; Callback function that will be called in the Playwright's context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-expose-function-option-callback"/><a href="#browser-context-expose-function-option-callback" class="list-anchor">#</a>
...
- `options` &#60;`BrowserContext.GrantPermissionsOptions`&#62;
  - `setOrigin` &#60;[String]&#62; The [origin] to grant permissions to, e.g. "https://example.com".<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-grant-permissions-option-origin"/><a href="#browser-context-grant-permissions-option-origin" class="list-anchor">#</a>
...
- `handler` &#60;[Consumer]<[Route]>&#62; handler function to route the request.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-route-option-handler"/><a href="#browser-context-route-option-handler" class="list-anchor">#</a>
- `options` &#60;`BrowserContext.RouteOptions`&#62;
  - `setTimes` &#60;[int]&#62; How often a route should be used. By default it will be used every time. <font size="2">Added in: v1.15</font><a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-route-option-times"/><a href="#browser-context-route-option-times" class="list-anchor">#</a>
...
- `options` &#60;`BrowserContext.RouteFromHAROptions`&#62;
  - `setNotFound` &#60;`enum HarNotFound { ABORT, FALLBACK }`&#62; If set to 'abort' any request not found in the HAR file will be aborted.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-route-from-har-option-not-found"/><a href="#browser-context-route-from-har-option-not-found" class="list-anchor">#</a>
...
#### Parameters
- `timeout` &#60;[double]&#62; Maximum navigation time in milliseconds<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-set-default-navigation-timeout-option-timeout"/><a href="#browser-context-set-default-navigation-timeout-option-timeout" class="list-anchor">#</a>
...
#### Parameters
- `timeout` &#60;[double]&#62; Maximum time in milliseconds<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-set-default-timeout-option-timeout"/><a href="#browser-context-set-default-timeout-option-timeout" class="list-anchor">#</a>
...
- `options` &#60;`BrowserContext.WaitForPageOptions`&#62;
  - `setPredicate` &#60;[Predicate]<[Page]>&#62; Receives the [Page] object and resolves to truthy value when the waiting should resolve.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-wait-for-page-option-predicate"/><a href="#browser-context-wait-for-page-option-predicate" class="list-anchor">#</a>
  - `setTimeout` &#60;[double]&#62; Maximum time to wait for in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can be changed by using the [BrowserContext.setDefaultTimeout()](/api/class-browsercontext.mdx#browser-context-set-default-timeout).<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-wait-for-page-option-timeout"/><a href="#browser-context-wait-for-page-option-timeout" class="list-anchor">#</a>
- `callback` &#60;[Runnable]&#62; Callback that performs the action triggering the event.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-wait-for-page-option-callback"/><a href="#browser-context-wait-for-page-option-callback" class="list-anchor">#</a>
