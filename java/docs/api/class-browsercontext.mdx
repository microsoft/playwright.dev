...
**Returns**
- [boolean]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-is-closed-or-closing-return"/><a href="#browser-context-is-closed-or-closing-return" class="list-anchor">#</a>
