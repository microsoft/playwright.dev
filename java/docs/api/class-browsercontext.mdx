...
### removeCookies {#browser-context-remove-cookies}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.43</font><x-search>browserContext.removeCookies</x-search>
...
**Arguments**
- `filter` Filter<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-remove-cookies-option-filter"/><a href="#browser-context-remove-cookies-option-filter" class="list-anchor">#</a>
...
**Returns**
- [void]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-remove-cookies-return"/><a href="#browser-context-remove-cookies-return" class="list-anchor">#</a>
