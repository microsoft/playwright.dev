...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.onClose(handler)</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.onPage(handler)</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>browserContext.onRequest(handler)</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>browserContext.onRequestFailed(handler)</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>browserContext.onRequestFinished(handler)</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>browserContext.onResponse(handler)</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>browserContext.waitForPage</span>
