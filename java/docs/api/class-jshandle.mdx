...
JSHandle represents an in-page JavaScript object. JSHandles can be created with the [Page.evaluateHandle(expression[, arg])](./api/class-page.mdx#pageevaluatehandleexpression-arg) method.
...
JSHandle instances can be used as an argument in [Page.evalOnSelector(selector, expression[, arg])](./api/class-page.mdx#pageevalonselectorselector-expression-arg), [Page.evaluate(expression[, arg])](./api/class-page.mdx#pageevaluateexpression-arg) and [Page.evaluateHandle(expression[, arg])](./api/class-page.mdx#pageevaluatehandleexpression-arg) methods.
...
See [Page.evaluateHandle(expression[, arg])](./api/class-page.mdx#pageevaluatehandleexpression-arg) for more details.
