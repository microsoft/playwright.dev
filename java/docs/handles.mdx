...
:::note
It is recommended to use selector-based actions like [Page.click(selector[, options])](./api/class-page.mdx#page-click) rather than using the [ElementHandle] for input actions, unless your use case specifically requires the use of handles.
:::
