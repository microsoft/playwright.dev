...
* **Language bindings**. Playwright is available for [Node.js](https://github.com/microsoft/playwright) [Python](https://github.com/microsoft/playwright-python), [.NET](https://github.com/microsoft/playwright-dotnet) and [Java](https://github.com/microsoft/playwright-java). Learn more about [supported languages](./languages.mdx).
* **Deploy tests to CI**. First-party [Docker image](./docker.mdx) and [GitHub Actions](./ci.mdx#github-actions) support to deploy tests to [your preferred CI/CD provider](./ci.mdx).
