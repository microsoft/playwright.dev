...
JSHandle instances can be used as an argument in [Page.evalOnSelector(selector, expression[, arg])](./api/class-page.mdx#page-eval-on-selector), [Page.evaluate(expression[, arg])](./api/class-page.mdx#page-evaluate) and [Page.evaluateHandle(expression[, arg])](./api/class-page.mdx#page-evaluate-handle) methods.
