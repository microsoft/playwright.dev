...
- `options` `FrameLocator.GetByRoleOptions` *(optional)*
  ...
  - `setDescription` [String] | [Pattern] *(optional)* <font size="2">Added in: v1.60</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-locator-get-by-role-option-description"/><a href="#frame-locator-get-by-role-option-description" class="list-anchor">#</a>
