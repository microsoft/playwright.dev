...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.15</font><span style={{visibility: 'hidden'}}>tracing.startChunk</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.15</font><span style={{visibility: 'hidden'}}>tracing.stopChunk</span>
