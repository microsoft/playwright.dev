...
**Arguments**
- `handler` [Consumer]&lt;&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="web-socket-route-on-close-option-handler"/><a href="#web-socket-route-on-close-option-handler" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>webSocketRoute.protocols</x-search>
...
**Returns**
- [List]&lt;[String]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="web-socket-route-protocols-return"/><a href="#web-socket-route-protocols-return" class="list-anchor">#</a>
