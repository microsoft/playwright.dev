...
The [Trace Viewer](/docs/trace-viewer-intro) shows a timeline of every action with DOM snapshots
(before and after), screenshots, network requests and responses, console messages, and timing.
