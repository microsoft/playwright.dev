...
- [page.on('close')](./class-page.md#pageonclose)
- [page.on('console')](./class-page.md#pageonconsole)
- [page.on('crash')](./class-page.md#pageoncrash)
- [page.on('dialog')](./class-page.md#pageondialog)
- [page.on('domcontentloaded')](./class-page.md#pageondomcontentloaded)
- [page.on('download')](./class-page.md#pageondownload)
- [page.on('filechooser')](./class-page.md#pageonfilechooser)
- [page.on('frameattached')](./class-page.md#pageonframeattached)
- [page.on('framedetached')](./class-page.md#pageonframedetached)
- [page.on('framenavigated')](./class-page.md#pageonframenavigated)
- [page.on('load')](./class-page.md#pageonload)
...
- [page.on('requestfinished')](./class-page.md#pageonrequestfinished)
- [page.on('response')](./class-page.md#pageonresponse)
- [page.on('websocket')](./class-page.md#pageonwebsocket)
- [page.on('worker')](./class-page.md#pageonworker)
...
- [page.addScriptTag(params)](./class-page.md#pageaddscripttagparams)
- [page.addStyleTag(params)](./class-page.md#pageaddstyletagparams)
- [page.bringToFront()](./class-page.md#pagebringtofront)
...
- [page.exposeBinding(name, callback[, options])](./class-page.md#pageexposebindingname-callback-options)
- [page.exposeFunction(name, callback)](./class-page.md#pageexposefunctionname-callback)
...
- [page.video()](./class-page.md#pagevideo)
...
Emitted when a JavaScript dialog appears, such as `alert`, `prompt`, `confirm` or `beforeunload`. Playwright can respond to the dialog via [dialog.accept([promptText])](./class-dialog.md#dialogacceptprompttext) or [dialog.dismiss()](./class-dialog.md#dialogdismiss) methods.
...
Emitted when a file chooser is supposed to appear, such as after clicking the  `<input type=file>`. Playwright can respond to it via setting the input files using [fileChooser.setFiles(files[, options])](./class-filechooser.md#filechoosersetfilesfiles-options) that can be uploaded after that.
...
Emitted when the page opens a new tab or window. This event is emitted in addition to the [browserContext.on('page')](./class-browsercontext.md#browsercontextonpage), but only for popups relevant to this page.
...
> **NOTE** Use [page.waitForLoadState([state, options])](./class-page.md#pagewaitforloadstatestate-options) to wait until the page gets to a particular state (you should not need it in most cases).

## page.on('request')
- type: <[Request]>

Emitted when a page issues a request. The [request] object is read-only. In order to intercept and mutate requests, see [page.route(url, handler)](./class-page.md#pagerouteurl-handler) or [browserContext.route(url, handler)](./class-browsercontext.md#browsercontextrouteurl-handler).
...
> **NOTE** HTTP Error responses, such as 404 or 503, are still successful responses from HTTP standpoint, so request will complete with [page.on('requestfinished')](./class-page.md#pageonrequestfinished) event and not with [page.on('requestfailed')](./class-page.md#pageonrequestfailed).
...
Shortcut for main frame's [frame.$(selector)](./class-frame.md#frameselector).
...
Shortcut for main frame's [frame.$$(selector)](./class-frame.md#frameselector-1).
...
If `pageFunction` returns a [Promise], then [page.$eval(selector, pageFunction[, arg])](./class-page.md#pageevalselector-pagefunction-arg) would wait for the promise to resolve and return its value.
...
Shortcut for main frame's [frame.$eval(selector, pageFunction[, arg])](./class-frame.md#frameevalselector-pagefunction-arg).
...
If `pageFunction` returns a [Promise], then [page.$$eval(selector, pageFunction[, arg])](./class-page.md#pageevalselector-pagefunction-arg-1) would wait for the promise to resolve and return its value.
...
> **NOTE** The order of evaluation of multiple scripts installed via [browserContext.addInitScript(script[, arg])](./class-browsercontext.md#browsercontextaddinitscriptscript-arg) and [page.addInitScript(script[, arg])](./class-page.md#pageaddinitscriptscript-arg) is not defined.
...
Shortcut for main frame's [frame.addScriptTag(params)](./class-frame.md#frameaddscripttagparams).
...
Shortcut for main frame's [frame.addStyleTag(params)](./class-frame.md#frameaddstyletagparams).
...
1. Use [page.mouse](./class-page.md#pagemouse) to click in the center of the element.
1. Wait for initiated navigations to either succeed or fail, unless `noWaitAfter` option is set.
1. Ensure that the element is now checked. If not, this method rejects.

When all steps combined have not finished during the specified `timeout`, this method rejects with a [TimeoutError]. Passing zero timeout disables this.

Shortcut for main frame's [frame.check(selector[, options])](./class-frame.md#framecheckselector-options).
...
1. Wait for [actionability](./actionability.md) checks on the matched element, unless `force` option is set. If the element is detached during the checks, the whole action is retried.
1. Scroll the element into view if needed.
1. Use [page.mouse](./class-page.md#pagemouse) to click in the center of the element, or the specified `position`.
1. Wait for initiated navigations to either succeed or fail, unless `noWaitAfter` option is set.

When all steps combined have not finished during the specified `timeout`, this method rejects with a [TimeoutError]. Passing zero timeout disables this.

Shortcut for main frame's [frame.click(selector[, options])](./class-frame.md#frameclickselector-options).
...
> and should be handled manually via [page.on('dialog')](./class-page.md#pageondialog) event.
...
1. Wait for [actionability](./actionability.md) checks on the matched element, unless `force` option is set. If the element is detached during the checks, the whole action is retried.
1. Scroll the element into view if needed.
1. Use [page.mouse](./class-page.md#pagemouse) to double click in the center of the element, or the specified `position`.
...
Shortcut for main frame's [frame.dblclick(selector[, options])](./class-frame.md#framedblclickselector-options).
...
Shortcut for main frame's [frame.evaluate(pageFunction[, arg])](./class-frame.md#frameevaluatepagefunction-arg).
...
See [browserContext.exposeBinding(name, callback[, options])](./class-browsercontext.md#browsercontextexposebindingname-callback-options) for the context-wide version.
...
See [browserContext.exposeFunction(name, callback)](./class-browsercontext.md#browsercontextexposefunctionname-callback) for context-wide exposed function.
...
To send fine-grained keyboard events, use [page.type(selector, text[, options])](./class-page.md#pagetypeselector-text-options).

Shortcut for main frame's [frame.fill(selector, value[, options])](./class-frame.md#framefillselector-value-options)
...
Shortcut for main frame's [frame.focus(selector[, options])](./class-frame.md#framefocusselector-options).
...
## page.goBack([options])
- `options` <[Object]>
  - `timeout` <[number]> Maximum operation time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the [browserContext.setDefaultNavigationTimeout(timeout)](./class-browsercontext.md#browsercontextsetdefaultnavigationtimeouttimeout), [browserContext.setDefaultTimeout(timeout)](./class-browsercontext.md#browsercontextsetdefaulttimeouttimeout), [page.setDefaultNavigationTimeout(timeout)](./class-page.md#pagesetdefaultnavigationtimeouttimeout) or [page.setDefaultTimeout(timeout)](./class-page.md#pagesetdefaulttimeouttimeout) methods.
...
- `options` <[Object]>
  - `referer` <[string]> Referer header value. If provided it will take preference over the referer header value set by [page.setExtraHTTPHeaders(headers)](./class-page.md#pagesetextrahttpheadersheaders).
  - `timeout` <[number]> Maximum operation time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the [browserContext.setDefaultNavigationTimeout(timeout)](./class-browsercontext.md#browsercontextsetdefaultnavigationtimeouttimeout), [browserContext.setDefaultTimeout(timeout)](./class-browsercontext.md#browsercontextsetdefaulttimeouttimeout), [page.setDefaultNavigationTimeout(timeout)](./class-page.md#pagesetdefaultnavigationtimeouttimeout) or [page.setDefaultTimeout(timeout)](./class-page.md#pagesetdefaulttimeouttimeout) methods.
  - `waitUntil` <"load"|"domcontentloaded"|"networkidle"> When to consider operation succeeded, defaults to `load`. Events can be either:
    * `'domcontentloaded'` - consider operation to be finished when the `DOMContentLoaded` event is fired.
    * `'load'` - consider operation to be finished when the `load` event is fired.
...
Shortcut for main frame's [frame.goto(url[, options])](./class-frame.md#framegotourl-options)
...
1. Wait for [actionability](./actionability.md) checks on the matched element, unless `force` option is set. If the element is detached during the checks, the whole action is retried.
1. Scroll the element into view if needed.
1. Use [page.mouse](./class-page.md#pagemouse) to hover over the center of the element, or the specified `position`.
1. Wait for initiated navigations to either succeed or fail, unless `noWaitAfter` option is set.

When all steps combined have not finished during the specified `timeout`, this method rejects with a [TimeoutError]. Passing zero timeout disables this.

Shortcut for main frame's [frame.hover(selector[, options])](./class-frame.md#framehoverselector-options).
...
`page.pdf()` generates a pdf of the page with `print` css media. To generate a pdf with `screen` media, call [page.emulateMedia(params)](./class-page.md#pageemulatemediaparams) before calling `page.pdf()`:
...
Focuses the element, and then uses [keyboard.down(key)](./class-keyboard.md#keyboarddownkey) and [keyboard.up(key)](./class-keyboard.md#keyboardupkey).
...
Page routes take precedence over browser context routes (set up with [browserContext.route(url, handler)](./class-browsercontext.md#browsercontextrouteurl-handler)) when request matches both handlers.
...
Shortcut for main frame's [frame.selectOption(selector, values[, options])](./class-frame.md#frameselectoptionselector-values-options)
...
> **NOTE** [page.setDefaultNavigationTimeout(timeout)](./class-page.md#pagesetdefaultnavigationtimeouttimeout) takes priority over [page.setDefaultTimeout(timeout)](./class-page.md#pagesetdefaulttimeouttimeout), [browserContext.setDefaultTimeout(timeout)](./class-browsercontext.md#browsercontextsetdefaulttimeouttimeout) and [browserContext.setDefaultNavigationTimeout(timeout)](./class-browsercontext.md#browsercontextsetdefaultnavigationtimeouttimeout).
...
In the case of multiple pages in a single browser, each page can have its own viewport size. However, [browser.newContext([options])](./class-browser.md#browsernewcontextoptions) allows to set viewport size (and more) for all pages in the context at once.
...
1. Wait for [actionability](./actionability.md) checks on the matched element, unless `force` option is set. If the element is detached during the checks, the whole action is retried.
1. Scroll the element into view if needed.
1. Use [page.touchscreen](./class-page.md#pagetouchscreen) to tap the center of the element, or the specified `position`.
1. Wait for initiated navigations to either succeed or fail, unless `noWaitAfter` option is set.
...
Shortcut for main frame's [frame.tap(selector[, options])](./class-frame.md#frametapselector-options).
...
Returns the page's title. Shortcut for main frame's [frame.title()](./class-frame.md#frametitle).
...
Sends a `keydown`, `keypress`/`input`, and `keyup` event for each character in the text. `page.type` can be used to send fine-grained keyboard events. To fill values in form fields, use [page.fill(selector, value[, options])](./class-page.md#pagefillselector-value-options).

To press a special key, like `Control` or `ArrowDown`, use [keyboard.press(key[, options])](./class-keyboard.md#keyboardpresskey-options).
...
Shortcut for main frame's [frame.type(selector, text[, options])](./class-frame.md#frametypeselector-text-options).
...
Shortcut for main frame's [frame.uncheck(selector[, options])](./class-frame.md#frameuncheckselector-options).
...
Removes a route created with [page.route(url, handler)](./class-page.md#pagerouteurl-handler). When `handler` is not specified, removes all routes for the `url`.

## page.url()
- returns: <[string]>

Shortcut for main frame's [frame.url()](./class-frame.md#frameurl).
...
Shortcut for main frame's [frame.waitForFunction(pageFunction[, arg, options])](./class-frame.md#framewaitforfunctionpagefunction-arg-options).
...
Shortcut for main frame's [frame.waitForLoadState([state, options])](./class-frame.md#framewaitforloadstatestate-options).
...
Shortcut for main frame's [frame.waitForNavigation([options])](./class-frame.md#framewaitfornavigationoptions).
...
- `options` <[Object]>
  - `timeout` <[number]> Maximum wait time in milliseconds, defaults to 30 seconds, pass `0` to disable the timeout. The default value can be changed by using the [page.setDefaultTimeout(timeout)](./class-page.md#pagesetdefaulttimeouttimeout) method.
...
- `options` <[Object]>
  - `timeout` <[number]> Maximum wait time in milliseconds, defaults to 30 seconds, pass `0` to disable the timeout. The default value can be changed by using the [browserContext.setDefaultTimeout(timeout)](./class-browsercontext.md#browsercontextsetdefaulttimeouttimeout) or [page.setDefaultTimeout(timeout)](./class-page.md#pagesetdefaulttimeouttimeout) methods.
...
Shortcut for main frame's [frame.waitForTimeout(timeout)](./class-frame.md#framewaitfortimeouttimeout).
