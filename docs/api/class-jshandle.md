...
JSHandle instances can be used as an argument in [`page.$eval(selector, pageFunction[, arg])`](#pageevalselector-pagefunction-arg), [`page.evaluate(pageFunction[, arg])`](api/class-page.md#pageevaluatepagefunction-arg) and [`page.evaluateHandle(pageFunction[, arg])`](#pageevaluatehandlepagefunction-arg) methods.
