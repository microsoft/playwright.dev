...
* [page.on('frameattached')](./class-page.md#pageonframeattached) - fired when the frame gets attached to the page. A Frame can be attached to the page only once.
* [page.on('framenavigated')](./class-page.md#pageonframenavigated) - fired when the frame commits navigation to a different URL.
* [page.on('framedetached')](./class-page.md#pageonframedetached) - fired when the frame gets detached from the page.  A Frame can be detached from the page only once.
...
- [frame.$(selector)](./class-frame.md#frameselector)
- [frame.$$(selector)](./class-frame.md#frameselector-1)
...
- [frame.addScriptTag(params)](./class-frame.md#frameaddscripttagparams)
- [frame.addStyleTag(params)](./class-frame.md#frameaddstyletagparams)
- [frame.check(selector[, options])](./class-frame.md#framecheckselector-options)
- [frame.childFrames()](./class-frame.md#framechildframes)
...
To send fine-grained keyboard events, use [frame.type(selector, text[, options])](./class-frame.md#frametypeselector-text-options).
...
Sends a `keydown`, `keypress`/`input`, and `keyup` event for each character in the text. `frame.type` can be used to send fine-grained keyboard events. To fill values in form fields, use [frame.fill(selector, value[, options])](./class-frame.md#framefillselector-value-options).
