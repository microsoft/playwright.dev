...
- `expression`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-evaluate-option-expression"/> &#60;[string]&#62; JavaScript expression to be evaluated in the browser context. If the expresion evaluates to a function, the function is automatically invoked.<a href="#js-handle-evaluate-option-expression" class="list-anchor">#</a>
...
- `expression`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-evaluate-handle-option-expression"/> &#60;[string]&#62; JavaScript expression to be evaluated in the browser context. If the expresion evaluates to a function, the function is automatically invoked.<a href="#js-handle-evaluate-handle-option-expression" class="list-anchor">#</a>
