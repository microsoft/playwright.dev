...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>fileChooser.Element</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>fileChooser.IsMultiple</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>fileChooser.Page</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>fileChooser.SetFilesAsync</span>
...
- `options` `FileChooserSetFilesOptions?` *(optional)*
  ...
  - `Timeout` [double]? *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="file-chooser-set-files-option-timeout"/><a href="#file-chooser-set-files-option-timeout" class="list-anchor">#</a>
