...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.11</font><span style={{visibility: 'hidden'}}>video.DeleteAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>video.PathAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.11</font><span style={{visibility: 'hidden'}}>video.SaveAsAsync</span>
