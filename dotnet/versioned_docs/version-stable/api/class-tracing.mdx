...
- `options` `TracingStartOptions?` *(optional)*
  - `AriaSnapshots` [bool]? *(optional)* <font size="2">Added in: v1.63</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="tracing-start-option-aria-snapshots"/><a href="#tracing-start-option-aria-snapshots" class="list-anchor">#</a>
  ...
  - `ScreenSnapshots` [bool]? *(optional)* <font size="2">Added in: v1.63</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="tracing-start-option-screen-snapshots"/><a href="#tracing-start-option-screen-snapshots" class="list-anchor">#</a>
