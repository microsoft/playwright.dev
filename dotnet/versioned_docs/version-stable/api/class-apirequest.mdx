...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.16</font><span style={{visibility: 'hidden'}}>apiRequest.NewContextAsync</span>
...
- `options` `ApiRequestNewContextOptions?` *(optional)*
  ...
  - `Timeout` [double]? *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="api-request-new-context-option-timeout"/><a href="#api-request-new-context-option-timeout" class="list-anchor">#</a>
