...
You don't have to change your code, just use your testing harness or [BrowserType.LaunchAsync(options)](/api/class-browsertype.mdx#browser-type-launch) as usual.
