...
###### 
<ProgressiveImage image={require("../images/getting-started/record-test-csharp.webp")} alt="recording a test" />
...
###### 
<ProgressiveImage image={require("../images/getting-started/pick-locator-csharp.webp")} alt="picking a locator" />
