...
Create a test that emulates the users `"colorScheme"`. Supported values are 'light', 'dark', 'no-preference'. You can also emulate the media type with [Page.EmulateMediaAsync()](/api/class-page.mdx#page-emulate-media).
