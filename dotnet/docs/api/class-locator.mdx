...
- `options` `LocatorPressSequentiallyOptions?` *(optional)*
  ...
  - `NamedKeys` [bool]? *(optional)* <font size="2">Added in: v1.61</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-press-sequentially-option-named-keys"/><a href="#locator-press-sequentially-option-named-keys" class="list-anchor">#</a>
