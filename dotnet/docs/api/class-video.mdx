...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.11</font><x-search>video.DeleteAsync</x-search>
...
**Returns**
- [string]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="video-path-return"/><a href="#video-path-return" class="list-anchor">#</a>

---

### SaveAsAsync {#video-save-as}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.11</font><x-search>video.SaveAsAsync</x-search>
...
- `options` `VideoStartOptions?` *(optional)*
  - `Annotate` Annotate? *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="video-start-option-annotate"/><a href="#video-start-option-annotate" class="list-anchor">#</a>
