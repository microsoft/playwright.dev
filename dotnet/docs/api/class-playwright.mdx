...
Returns a dictionary of devices to be used with [Browser.NewContextAsync(…)](./api/class-browser.mdx#browsernewcontextasync) or [Browser.NewPageAsync(…)](./api/class-browser.mdx#browsernewpageasync).
