...
Returns a dictionary of devices to be used with [Browser.NewContextAsync(options)](./api/class-browser.mdx#browsernewcontextasyncoptions) or [Browser.NewPageAsync(options)](./api/class-browser.mdx#browsernewpageasyncoptions).
