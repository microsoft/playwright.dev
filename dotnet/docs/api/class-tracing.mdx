...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>tracing.StartAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.15</font><span style={{visibility: 'hidden'}}>tracing.StartChunkAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>tracing.StopAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.15</font><span style={{visibility: 'hidden'}}>tracing.StopChunkAsync</span>
