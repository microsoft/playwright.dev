...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-start-option-options"/> &#60;`TracingStartOptions?`&#62;<a href="#tracing-start-option-options" class="list-anchor">#</a>
...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-stop-option-options"/> &#60;`TracingStopOptions?`&#62;<a href="#tracing-stop-option-options" class="list-anchor">#</a>
  - `Path`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-stop-option-path"/> &#60;[string]?&#62; Export trace into the file with the given name.<a href="#tracing-stop-option-path" class="list-anchor">#</a>
