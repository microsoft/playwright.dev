...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-start-param-options"/> &#60;`TracingStartOptions?`&#62;<a href="#tracing-start-param-options" class="list-anchor">#</a>
...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-stop-param-options"/> &#60;`TracingStopOptions?`&#62;<a href="#tracing-stop-param-options" class="list-anchor">#</a>
