...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>route.AbortAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>route.ContinueAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.23</font><span style={{visibility: 'hidden'}}>route.FallbackAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.29</font><span style={{visibility: 'hidden'}}>route.FetchAsync</span>
...
- `options` `RouteFetchOptions?` *(optional)*
  ...
  - `PostData` [byte]&#91;&#93;? *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fetch-option-post-data"/><a href="#route-fetch-option-post-data" class="list-anchor">#</a>
    ...
    If set changes the post data of request.
  - `PostData|PostDataByte|PostDataObject` [string]?|[byte]&#91;&#93;?|[object]? *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fetch-option-post-data-post-data-byte-post-data-object"/><a href="#route-fetch-option-post-data-post-data-byte-post-data-object" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>route.FulfillAsync</span>
...
- `options` `RouteFulfillOptions?` *(optional)*
  ...
  - `Json` [JsonElement]? *(optional)* <font size="2">Added in: v1.29</font><a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fulfill-option-json"/><a href="#route-fulfill-option-json" class="list-anchor">#</a>
