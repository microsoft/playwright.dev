...
- `options` &#60;`RouteFulfillOptions?`&#62;
  - `_response`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fulfill-option-response"/> &#60;[Response]?&#62; Intercepted response. Will be used to populate all response fields not explicitely overridden.<a href="#route-fulfill-option-response" class="list-anchor">#</a>
