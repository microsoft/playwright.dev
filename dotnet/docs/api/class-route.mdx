...
- `options` `RouteFetchOptions?` *(optional)*
  - `Data|DataByte|DataObject` [string]?|[byte]&#91;&#93;?|[object]? *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fetch-option-data-data-byte-data-object"/><a href="#route-fetch-option-data-data-byte-data-object" class="list-anchor">#</a>
