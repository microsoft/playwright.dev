...
```csharp
await Keyboard.InsertTextAsync(text);
```
...
```csharp
await Keyboard.PressAsync(key, options);
```
...
- `options` &#60;`KeyboardPressOptions?`&#62;
  - `Delay` &#60;[double]?&#62; Time to wait between `keydown` and `keyup` in milliseconds. Defaults to 0.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-press-option-delay"/><a href="#keyboard-press-option-delay" class="list-anchor">#</a>
...
```csharp
await Keyboard.TypeAsync(text, options);
```
...
- `options` &#60;`KeyboardTypeOptions?`&#62;
  - `Delay` &#60;[double]?&#62; Time to wait between key presses in milliseconds. Defaults to 0.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-type-option-delay"/><a href="#keyboard-type-option-delay" class="list-anchor">#</a>
