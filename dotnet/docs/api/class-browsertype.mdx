...
- `options` `BrowserTypeLaunchPersistentContextOptions?` *(optional)*
  ...
  - `Contrast` `enum ForcedColors { NoPreference, More, Null }?` *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-launch-persistent-context-option-contrast"/><a href="#browser-type-launch-persistent-context-option-contrast" class="list-anchor">#</a>
