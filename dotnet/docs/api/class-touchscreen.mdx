...
- `x`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="touchscreen-x-param-x"/> &#60;[double]&#62;<a href="#touchscreen-x-param-x" class="list-anchor">#</a>
- `y`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="touchscreen-y-param-y"/> &#60;[double]&#62;<a href="#touchscreen-y-param-y" class="list-anchor">#</a>
