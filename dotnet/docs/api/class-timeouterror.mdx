...
TimeoutError is emitted whenever certain operations are terminated due to timeout, e.g. [`method: Locator.waitFor`] or [BrowserType.LaunchAsync()](/api/class-browsertype.mdx#browser-type-launch).
