...
- `options` &#60;`BrowserNewContextOptions?`&#62;
  ...
  - `HarFallback`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-context-option-har-fallback"/> &#60;`enum HarFallback { Abort, Continue }?`&#62; If set to 'abort' any request not found in the HAR file will be aborted. If set to'continue' missing requests will be sent to the network. Defaults to 'abort'.<a href="#browser-new-context-option-har-fallback" class="list-anchor">#</a>
  - `HarPath`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-context-option-har-path"/> &#60;[string]?&#62; Path to a [HAR](http://www.softwareishard.com/blog/har-12-spec) file with prerecorded network data. If the HAR file contains an entry with the matching URL and HTTP method, then the entry's headers, status and body will be used to fulfill the network request. An entry resulting in a redirect will be followed automatically. If `path` is a relative path, then it is resolved relative to the current working directory.<a href="#browser-new-context-option-har-path" class="list-anchor">#</a>
  - `HarUrlFilter`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-context-option-har-url-filter"/> &#60;[string]?|[Regex]?&#62; A glob pattern or regular expression to match request URL while routing. Only requests with URL matching the pattern will be surved from the HAR file. If not specified, all requests are served from the HAR file.<a href="#browser-new-context-option-har-url-filter" class="list-anchor">#</a>
...
- `options` &#60;`BrowserNewPageOptions?`&#62;
  ...
  - `Geolocation`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-page-option-geolocation"/> &#60;Geolocation?&#62;<a href="#browser-new-page-option-geolocation" class="list-anchor">#</a>
    ...
    - `Longitude` &#60;[double]&#62; Longitude between -180 and 180.
    - `Accuracy` &#60;[double]?&#62; Non-negative accuracy value. Defaults to `0`.
  - `HarFallback`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-page-option-har-fallback"/> &#60;`enum HarFallback { Abort, Continue }?`&#62; If set to 'abort' any request not found in the HAR file will be aborted. If set to'continue' missing requests will be sent to the network. Defaults to 'abort'.<a href="#browser-new-page-option-har-fallback" class="list-anchor">#</a>
  - `HarPath`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-page-option-har-path"/> &#60;[string]?&#62; Path to a [HAR](http://www.softwareishard.com/blog/har-12-spec) file with prerecorded network data. If the HAR file contains an entry with the matching URL and HTTP method, then the entry's headers, status and body will be used to fulfill the network request. An entry resulting in a redirect will be followed automatically. If `path` is a relative path, then it is resolved relative to the current working directory.<a href="#browser-new-page-option-har-path" class="list-anchor">#</a>
  - `HarUrlFilter`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-page-option-har-url-filter"/> &#60;[string]?|[Regex]?&#62; A glob pattern or regular expression to match request URL while routing. Only requests with URL matching the pattern will be surved from the HAR file. If not specified, all requests are served from the HAR file.<a href="#browser-new-page-option-har-url-filter" class="list-anchor">#</a>
