...
- `options` `BrowserNewContextOptions?` *(optional)*
  ...
  - `ClientCertificates` [IEnumerable]?&lt;ClientCertificates&gt; *(optional)* <font size="2">Added in: 1.46</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-context-option-client-certificates"/><a href="#browser-new-context-option-client-certificates" class="list-anchor">#</a>
    ...
    - `Certs` [IEnumerable]&lt;Certs&gt; <font size="2">Added in: 1.46</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-context-option-certs"/><a href="#browser-new-context-option-certs" class="list-anchor">#</a>
...
- `options` `BrowserNewPageOptions?` *(optional)*
  ...
  - `ClientCertificates` [IEnumerable]?&lt;ClientCertificates&gt; *(optional)* <font size="2">Added in: 1.46</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-page-option-client-certificates"/><a href="#browser-new-page-option-client-certificates" class="list-anchor">#</a>
    - `Url` [string] <font size="2">Added in: 1.46</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-page-option-url"/><a href="#browser-new-page-option-url" class="list-anchor">#</a>
      ...
      Glob pattern to match the URLs that the certificate is valid for.
    - `Certs` [IEnumerable]&lt;Certs&gt; <font size="2">Added in: 1.46</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-page-option-certs"/><a href="#browser-new-page-option-certs" class="list-anchor">#</a>
