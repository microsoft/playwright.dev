...
- `options` &#60;`BrowserNewContextOptions?`&#62;
  ...
  - `RecordHarUrlFilter|RecordHarUrlFilterRegex`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-context-option-record-har-url-filter-record-har-url-filter-regex"/> &#60;[string]?|[Regex]?&#62;<a href="#browser-new-context-option-record-har-url-filter-record-har-url-filter-regex" class="list-anchor">#</a>
...
- `options` &#60;`BrowserNewPageOptions?`&#62;
  ...
  - `RecordHarUrlFilter|RecordHarUrlFilterRegex`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-page-option-record-har-url-filter-record-har-url-filter-regex"/> &#60;[string]?|[Regex]?&#62;<a href="#browser-new-page-option-record-har-url-filter-record-har-url-filter-regex" class="list-anchor">#</a>
