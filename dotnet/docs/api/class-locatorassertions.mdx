...
- [Expect(Locator).ToBeCheckedAsync(options)](./api/class-locatorassertions.mdx#locator-assertions-to-be-checked)
- [Expect(Locator).ToBeDisabledAsync(options)](./api/class-locatorassertions.mdx#locator-assertions-to-be-disabled)
- [Expect(Locator).ToBeEditableAsync(options)](./api/class-locatorassertions.mdx#locator-assertions-to-be-editable)
- [Expect(Locator).ToBeEmptyAsync(options)](./api/class-locatorassertions.mdx#locator-assertions-to-be-empty)
- [Expect(Locator).ToBeEnabledAsync(options)](./api/class-locatorassertions.mdx#locator-assertions-to-be-enabled)
- [Expect(Locator).ToBeFocusedAsync(options)](./api/class-locatorassertions.mdx#locator-assertions-to-be-focused)
- [Expect(Locator).ToBeHiddenAsync(options)](./api/class-locatorassertions.mdx#locator-assertions-to-be-hidden)
- [Expect(Locator).ToBeVisibleAsync(options)](./api/class-locatorassertions.mdx#locator-assertions-to-be-visible)
- [Expect(Locator).ToContainTextAsync(expected, options)](./api/class-locatorassertions.mdx#locator-assertions-to-contain-text)
- [Expect(Locator).ToHaveAttributeAsync(name, value, options)](./api/class-locatorassertions.mdx#locator-assertions-to-have-attribute)
- [Expect(Locator).ToHaveClassAsync(expected, options)](./api/class-locatorassertions.mdx#locator-assertions-to-have-class)
- [Expect(Locator).ToHaveCountAsync(count, options)](./api/class-locatorassertions.mdx#locator-assertions-to-have-count)
- [Expect(Locator).ToHaveCSSAsync(name, value, options)](./api/class-locatorassertions.mdx#locator-assertions-to-have-css)
- [Expect(Locator).ToHaveIdAsync(id, options)](./api/class-locatorassertions.mdx#locator-assertions-to-have-id)
- [Expect(Locator).ToHaveJSPropertyAsync(name, value, options)](./api/class-locatorassertions.mdx#locator-assertions-to-have-js-property)
- [Expect(Locator).ToHaveTextAsync(expected, options)](./api/class-locatorassertions.mdx#locator-assertions-to-have-text)
- [Expect(Locator).ToHaveValueAsync(value, options)](./api/class-locatorassertions.mdx#locator-assertions-to-have-value)
