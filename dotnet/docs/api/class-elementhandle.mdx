...
- `values` [string]? | [ElementHandle]? | [IEnumerable]?&lt;[string]&gt; | `SelectOption` | [IEnumerable]?&lt;[ElementHandle]&gt; | [IEnumerable]?&lt;`SelectOption`&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="element-handle-select-option-option-values"/><a href="#element-handle-select-option-option-values" class="list-anchor">#</a>
  ...
  - `Index` [int]? *(optional)* <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="element-handle-select-option-option-index"/><a href="#element-handle-select-option-option-index" class="list-anchor">#</a>
...
- `files` [string] | [IEnumerable]&lt;[string]&gt; | `FilePayload` | [IEnumerable]&lt;`FilePayload`&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="element-handle-set-input-files-option-files"/><a href="#element-handle-set-input-files-option-files" class="list-anchor">#</a>
  ...
  - `MimeType` [string] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="element-handle-set-input-files-option-mime-type"/><a href="#element-handle-set-input-files-option-mime-type" class="list-anchor">#</a>
    ...
    File type
  - `Buffer` [byte]&#91;&#93; <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="element-handle-set-input-files-option-buffer"/><a href="#element-handle-set-input-files-option-buffer" class="list-anchor">#</a>
