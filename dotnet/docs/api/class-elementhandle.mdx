...
ElementHandle instances can be used as an argument in [Page.EvalOnSelectorAsync(selector, expression, …)](./api/class-page.mdx#pageevalonselectorasyncselector-expression-) and [Page.EvaluateAsync(expression, …)](./api/class-page.mdx#pageevaluateasyncexpression-) methods.
...
- [ElementHandle.ScreenshotAsync(…)](./api/class-elementhandle.mdx#elementhandlescreenshotasync)
- [ElementHandle.ScrollIntoViewIfNeededAsync(…)](./api/class-elementhandle.mdx#elementhandlescrollintoviewifneededasync)
- [ElementHandle.SelectOptionAsync(values, …)](./api/class-elementhandle.mdx#elementhandleselectoptionasyncvalues-)
- [ElementHandle.SelectTextAsync(…)](./api/class-elementhandle.mdx#elementhandleselecttextasync)
- [ElementHandle.SetInputFilesAsync(files, …)](./api/class-elementhandle.mdx#elementhandlesetinputfilesasyncfiles-)
- [ElementHandle.TapAsync(…)](./api/class-elementhandle.mdx#elementhandletapasync)
...
- [ElementHandle.WaitForElementStateAsync(state, …)](./api/class-elementhandle.mdx#elementhandlewaitforelementstateasyncstate-)
- [ElementHandle.WaitForSelectorAsync(selector, …)](./api/class-elementhandle.mdx#elementhandlewaitforselectorasyncselector-)
...
## ElementHandle.DispatchEventAsync(type, …)
...
If `expression` returns a [Promise], then [ElementHandle.EvalOnSelectorAsync(selector, expression, …)](./api/class-elementhandle.mdx#elementhandleevalonselectorasyncselector-expression-) would wait for the promise to resolve and return its value.
...
If `expression` returns a [Promise], then [ElementHandle.EvalOnSelectorAllAsync(selector, expression, …)](./api/class-elementhandle.mdx#elementhandleevalonselectorallasyncselector-expression-) would wait for the promise to resolve and return its value.
...
To send fine-grained keyboard events, use [ElementHandle.TypeAsync(text, …)](./api/class-elementhandle.mdx#elementhandletypeasynctext-).
...
## ElementHandle.ScrollIntoViewIfNeededAsync(…)
- `timeout` <[double]> Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the [BrowserContext.SetDefaultTimeout(timeout)](./api/class-browsercontext.mdx#browsercontextsetdefaulttimeouttimeout) or [Page.SetDefaultTimeout(timeout)](./api/class-page.mdx#pagesetdefaulttimeouttimeout) methods.
- returns: <[void]>
...
## ElementHandle.SelectOptionAsync(values, …)
- `noWaitAfter` <[boolean]> Actions that initiate navigations are waiting for these navigations to happen and for pages to start loading. You can opt out of waiting via setting this flag. You would only need this option in the exceptional cases such as navigating to inaccessible pages. Defaults to `false`.
- `timeout` <[double]> Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the [BrowserContext.SetDefaultTimeout(timeout)](./api/class-browsercontext.mdx#browsercontextsetdefaulttimeouttimeout) or [Page.SetDefaultTimeout(timeout)](./api/class-page.mdx#pagesetdefaulttimeouttimeout) methods.
...
To press a special key, like `Control` or `ArrowDown`, use [ElementHandle.PressAsync(key, …)](./api/class-elementhandle.mdx#elementhandlepressasynckey-).

An example of typing into a text field and then submitting the form:

## ElementHandle.UncheckAsync(…)
- `force` <[boolean]> Whether to bypass the [actionability](./actionability.mdx) checks. Defaults to `false`.
- `noWaitAfter` <[boolean]> Actions that initiate navigations are waiting for these navigations to happen and for pages to start loading. You can opt out of waiting via setting this flag. You would only need this option in the exceptional cases such as navigating to inaccessible pages. Defaults to `false`.
- `position` <`Position`> A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
  - `x` <[double]>
...
## ElementHandle.WaitForElementStateAsync(state, …)
...
## ElementHandle.WaitForSelectorAsync(selector, …)
- `selector` <[string]> A selector to query for. See [working with selectors](./selectors.mdx) for more details.
...
:::note
This method does not work across navigations, use [Page.WaitForSelectorAsync(selector, …)](./api/class-page.mdx#pagewaitforselectorasyncselector-) instead.
:::
