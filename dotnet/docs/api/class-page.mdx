...
- [Page.RunAndWaitForEventAsync(options)](./api/class-page.mdx#pagerunandwaitforeventasyncoptions)
...
- [Page.WaitForEventAsync(options)](./api/class-page.mdx#pagewaitforeventasyncoptions)
...
- [Page.WaitForRequestAsync(urlOrPredicate, options)](./api/class-page.mdx#pagewaitforrequestasyncurlorpredicate-options)
- [Page.WaitForResponseAsync(urlOrPredicate, options)](./api/class-page.mdx#pagewaitforresponseasyncurlorpredicate-options)
...
## Page.RunAndWaitForEventAsync(options)
- `options` <`PageRunAndWaitForEventOptions`>
...
## Page.WaitForEventAsync(options)
...
:::note
In most cases, you should use [Page.RunAndWaitForEventAsync(options)](./api/class-page.mdx#pagerunandwaitforeventasyncoptions).
:::
...
Shortcut for main frame's [Frame.WaitForNavigationAsync(options)](./api/class-frame.mdx#framewaitfornavigationasyncoptions).

## Page.WaitForRequestAsync(urlOrPredicate, options)
...
## Page.WaitForResponseAsync(urlOrPredicate, options)
