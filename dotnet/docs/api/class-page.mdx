...
* After executing the handler, Playwright will ensure that overlay that triggered the handler is not visible anymore. You can opt-out of this behavior with `allowStayingVisible`.
...
An example with a custom callback on every actionability check. It uses a `<body>` locator that is always visible, so the handler is called before every actionability check. It is important to specify `allowStayingVisible`, because the handler does not hide the `<body>` element.
...
- `handler` [Action]&lt;[Locator]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-add-locator-handler-option-handler"/><a href="#page-add-locator-handler-option-handler" class="list-anchor">#</a>
...
- `options` `PageAddLocatorHandlerOptions?` *(optional)*
  - `AllowStayingVisible` [bool]? *(optional)* <font size="2">Added in: v1.44</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-add-locator-handler-option-allow-staying-visible"/><a href="#page-add-locator-handler-option-allow-staying-visible" class="list-anchor">#</a>
...
- `handler` [Action]&lt;[Locator]&gt; <font size="2">Added in: v1.44</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-add-locator-handler-option-handler"/><a href="#page-add-locator-handler-option-handler" class="list-anchor">#</a>
  
  Handler passed to [Page.AddLocatorHandlerAsync()](/api/class-page.mdx#page-add-locator-handler).
...
Removes locator handler added by [Page.AddLocatorHandlerAsync()](/api/class-page.mdx#page-add-locator-handler).
