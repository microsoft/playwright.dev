...
- `options` `PagePdfOptions?` *(optional)*
  ...
  - `Margin` Margin? *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-pdf-option-margin"/><a href="#page-pdf-option-margin" class="list-anchor">#</a>
    - `Top` [string]? *(optional)* <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-pdf-option-top"/><a href="#page-pdf-option-top" class="list-anchor">#</a>
      
      Top margin, accepts values labeled with units. Defaults to `0`.
    - `Right` [string]? *(optional)* <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-pdf-option-right"/><a href="#page-pdf-option-right" class="list-anchor">#</a>
      
      Right margin, accepts values labeled with units. Defaults to `0`.
    - `Bottom` [string]? *(optional)* <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-pdf-option-bottom"/><a href="#page-pdf-option-bottom" class="list-anchor">#</a>
      
      Bottom margin, accepts values labeled with units. Defaults to `0`.
    - `Left` [string]? *(optional)* <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-pdf-option-left"/><a href="#page-pdf-option-left" class="list-anchor">#</a>
...
- `values` [string]? | [ElementHandle]? | [IEnumerable]?&lt;[string]&gt; | `SelectOption` | [IEnumerable]?&lt;[ElementHandle]&gt; | [IEnumerable]?&lt;`SelectOption`&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-select-option-option-values"/><a href="#page-select-option-option-values" class="list-anchor">#</a>
  - `Value` [string]? *(optional)* <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-select-option-option-value"/><a href="#page-select-option-option-value" class="list-anchor">#</a>
    
    Matches by `option.value`. Optional.
  - `Label` [string]? *(optional)* <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-select-option-option-label"/><a href="#page-select-option-option-label" class="list-anchor">#</a>
    
    Matches by `option.label`. Optional.
  - `Index` [int]? *(optional)* <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-select-option-option-index"/><a href="#page-select-option-option-index" class="list-anchor">#</a>
...
- `files` [string] | [IEnumerable]&lt;[string]&gt; | `FilePayload` | [IEnumerable]&lt;`FilePayload`&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-set-input-files-option-files"/><a href="#page-set-input-files-option-files" class="list-anchor">#</a>
  - `Name` [string] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-set-input-files-option-name"/><a href="#page-set-input-files-option-name" class="list-anchor">#</a>
    
    File name
  - `MimeType` [string] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-set-input-files-option-mime-type"/><a href="#page-set-input-files-option-mime-type" class="list-anchor">#</a>
    
    File type
  - `Buffer` [byte]&#91;&#93; <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-set-input-files-option-buffer"/><a href="#page-set-input-files-option-buffer" class="list-anchor">#</a>
