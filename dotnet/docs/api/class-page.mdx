...
- `options` `PageRouteFromHAROptions?` *(optional)*
  - `Content` `enum HarContentPolicy { Omit, Embed, Attach }?` *(optional)* <font size="2">Added in: v1.32</font><a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="page-route-from-har-option-content"/><a href="#page-route-from-har-option-content" class="list-anchor">#</a>
  - `Mode` `enum HarMode { Full, Minimal }?` *(optional)* <font size="2">Added in: v1.32</font><a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="page-route-from-har-option-mode"/><a href="#page-route-from-har-option-mode" class="list-anchor">#</a>
