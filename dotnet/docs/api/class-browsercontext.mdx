...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.event Close</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.event Page</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>browserContext.event Request</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>browserContext.event RequestFailed</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>browserContext.event RequestFinished</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>browserContext.event Response</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.AddCookiesAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.AddInitScriptAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.ClearCookiesAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.ClearPermissionsAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.CloseAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.CookiesAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.ExposeBindingAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.ExposeFunctionAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.GrantPermissionsAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.NewPageAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.RouteAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.23</font><span style={{visibility: 'hidden'}}>browserContext.RouteFromHARAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>browserContext.RunAndWaitForPageAsync</span>
...
- `options` `BrowserContextRunAndWaitForPageOptions?` *(optional)*
  ...
  - `Timeout` [double]? *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-wait-for-page-option-timeout"/><a href="#browser-context-wait-for-page-option-timeout" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>browserContext.WaitForPageAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.SetExtraHTTPHeadersAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.SetGeolocationAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.SetOfflineAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.StorageStateAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.UnrouteAsync</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.16</font><span style={{visibility: 'hidden'}}>browserContext.APIRequest</span>
