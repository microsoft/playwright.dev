...
#### Parameters
- `script` &#60;[string]|[string]&#62; Script to be evaluated in all pages in the browser context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-add-init-script-option-script"/><a href="#browser-context-add-init-script-option-script" class="list-anchor">#</a>
...
#### Parameters
- `urls` &#60;[string]?|[IEnumerable]?<[string]>&#62; Optional list of URLs.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-cookies-option-urls"/><a href="#browser-context-cookies-option-urls" class="list-anchor">#</a>
...
```csharp
await BrowserContext.ExposeBindingAsync(name, callback, options);
```
...
- `callback` &#60;[Action]<BindingSource, T, [TResult]>&#62; Callback function that will be called in the Playwright's context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-expose-binding-option-callback"/><a href="#browser-context-expose-binding-option-callback" class="list-anchor">#</a>
...
```csharp
await BrowserContext.ExposeFunctionAsync(name, callback);
```
...
- `callback` &#60;[Action]<T, [TResult]>&#62; Callback function that will be called in the Playwright's context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-expose-function-option-callback"/><a href="#browser-context-expose-function-option-callback" class="list-anchor">#</a>
...
```csharp
await BrowserContext.RouteAsync(url, handler, options);
```
...
- `handler` &#60;[Action]<[Route]>&#62; handler function to route the request.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-route-option-handler"/><a href="#browser-context-route-option-handler" class="list-anchor">#</a>
...
- `options` &#60;`BrowserContextRouteFromHAROptions?`&#62;
  - `NotFound` &#60;`enum HarNotFound { Abort, Fallback }?`&#62; If set to 'abort' any request not found in the HAR file will be aborted.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-route-from-har-option-not-found"/><a href="#browser-context-route-from-har-option-not-found" class="list-anchor">#</a>
...
- `options` &#60;`BrowserContextRunAndWaitForPageOptions?`&#62;
  - `Predicate` &#60;[Func]<[Page]?, bool>&#62; Receives the [Page] object and resolves to truthy value when the waiting should resolve.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-wait-for-page-option-predicate"/><a href="#browser-context-wait-for-page-option-predicate" class="list-anchor">#</a>
...
- `action` &#60;[Func]<[Task]>&#62; Action that triggers the event. <font size="2">Added in: v1.12</font><a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-wait-for-page-option-action"/><a href="#browser-context-wait-for-page-option-action" class="list-anchor">#</a>
...
```csharp
await BrowserContext.SetGeolocationAsync(geolocation);
```
...
#### Parameters
- `url` &#60;[string]|[Regex]|[Func]<[string], bool>&#62; A glob pattern, regex pattern or predicate receiving [URL] used to register a routing with [BrowserContext.RouteAsync();](/api/class-browsercontext.mdx#browser-context-route).<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-unroute-option-url"/><a href="#browser-context-unroute-option-url" class="list-anchor">#</a>
- `handler` &#60;[Action]<[Route]?>&#62; Optional handler function used to register a routing with [BrowserContext.RouteAsync();](/api/class-browsercontext.mdx#browser-context-route).<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-unroute-option-handler"/><a href="#browser-context-unroute-option-handler" class="list-anchor">#</a>
