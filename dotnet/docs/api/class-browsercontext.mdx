...
- [BrowserContext.RunAndWaitForPageAsync(action, options)](./api/class-browsercontext.mdx#browsercontextrunandwaitforpageasyncaction-options)
...
- [BrowserContext.WaitForPageAsync(action, options)](./api/class-browsercontext.mdx#browsercontextwaitforpageasyncaction-options)
...
## BrowserContext.RunAndWaitForPageAsync(action, options)
...
## BrowserContext.WaitForPageAsync(action, options)
- `action` <[Func]<[Task]>> Action that triggers the event.
- returns: <[Page]>
