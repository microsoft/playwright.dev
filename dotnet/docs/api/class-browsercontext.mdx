...
- [BrowserContext.CookiesAsync(…)](./api/class-browsercontext.mdx#browsercontextcookiesasync)
...
Adds cookies into this browser context. All pages within this context will have these cookies installed. Cookies can be obtained via [BrowserContext.CookiesAsync(…)](./api/class-browsercontext.mdx#browsercontextcookiesasync).
