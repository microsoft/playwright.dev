...
If you have a [Locator] object pointing to an `iframe` it can be converted to [FrameLocator] using [Locator.EnterFrame](/api/class-locator.mdx#locator-enter-frame).

**Converting FrameLocator to Locator**

If you have a [FrameLocator] object it can be converted to [Locator] pointing to the same `iframe` using [FrameLocator.ExitFrame](/api/class-framelocator.mdx#frame-locator-exit-frame).
...
### ExitFrame {#frame-locator-exit-frame}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.43</font><x-search>frameLocator.ExitFrame</x-search>
...
**Returns**
- [Locator]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-locator-exit-frame-return"/><a href="#frame-locator-exit-frame-return" class="list-anchor">#</a>
...
- `options` `FrameLocatorLocatorOptions?` *(optional)*
  ...
  - `HasNot` [Locator]? *(optional)* <font size="2">Added in: v1.33</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-locator-locator-option-has-not"/><a href="#frame-locator-locator-option-has-not" class="list-anchor">#</a>
    ...
    Note that outer and inner locators must belong to the same frame. Inner locator must not contain [FrameLocator]s.
  - `HasNotText|HasNotTextRegex` [string]?|[Regex]? *(optional)* <font size="2">Added in: v1.33</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-locator-locator-option-has-not-text-has-not-text-regex"/><a href="#frame-locator-locator-option-has-not-text-has-not-text-regex" class="list-anchor">#</a>
