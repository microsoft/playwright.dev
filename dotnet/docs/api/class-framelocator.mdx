...
- `options` &#60;`FrameLocatorGetByRoleOptions?`&#62;
  ...
  - `Name`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="frame-locator-get-by-role-option-name"/> &#60;[string]?|[Regex]?&#62; Option to match the [accessible name](https://w3c.github.io/accname/#dfn-accessible-name). By default, matching is case-insensitive and searches for a substring, use `exact` to control this behavior.<a href="#frame-locator-get-by-role-option-name" class="list-anchor">#</a>
