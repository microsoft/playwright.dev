...
If this [APIRequestContext] is obtained via [BrowserContext.APIRequest](/api/class-browsercontext.mdx#browser-context-request) or [Page.APIRequest](/api/class-page.mdx#page-request), it will keep working until its owning [BrowserContext] closes.

If this [APIRequestContext] was created by [ApiRequest.NewContextAsync()](/api/class-apirequest.mdx#api-request-new-context), this method discards all its resources, calling any method on disposed [APIRequestContext] will throw an exception.
