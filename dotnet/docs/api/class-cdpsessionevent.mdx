---
id: class-cdpsessionevent
title: "CDPSessionEvent"
---
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: 1.30</font><x-search>cdpSessionEvent.EventName</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.30</font><x-search>cdpSessionEvent.event OnEvent</x-search>

**Usage**

```csharp
CdpSessionEvent.OnEvent += async data => {};
```
