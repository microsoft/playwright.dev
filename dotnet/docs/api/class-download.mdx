...
- [Download.CreateReadStreamAsync()](./api/class-download.mdx#downloadcreatereadstreamasync)
- [Download.DeleteAsync()](./api/class-download.mdx#downloaddeleteasync)
- [Download.FailureAsync()](./api/class-download.mdx#downloadfailureasync)
- [Download.Page](./api/class-download.mdx#downloadpage)
- [Download.PathAsync()](./api/class-download.mdx#downloadpathasync)
- [Download.SaveAsAsync(path)](./api/class-download.mdx#downloadsaveasasyncpath)
...
## Download.CreateReadStreamAsync()
- returns: <[null]|[Stream]>

Returns readable stream for current download or `null` if download failed.

## Download.DeleteAsync()
- returns: <[void]>

Deletes the downloaded file. Will wait for the download to finish if necessary.

## Download.FailureAsync()
- returns: <[null]|[string]>
