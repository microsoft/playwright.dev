...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="accessibility-options-param-options"/> &#60;`AccessibilitySnapshotOptions?`&#62;<a href="#accessibility-options-param-options" class="list-anchor">#</a>
  - `InterestingOnly`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="accessibility-interesting-only-param-interesting-only"/> &#60;[boolean]?&#62; Prune uninteresting nodes from the tree. Defaults to `true`.<a href="#accessibility-interesting-only-param-interesting-only" class="list-anchor">#</a>
  - `Root`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="accessibility-root-param-root"/> &#60;[ElementHandle]?&#62; The root DOM element for the snapshot. Defaults to the whole page.<a href="#accessibility-root-param-root" class="list-anchor">#</a>
