...
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-sizes-return"/> &#60;Sizes&#62;<a href="#request-sizes-return" class="list-anchor">#</a>
  ...
  - `requestHeadersSize` &#60;[double]&#62; Total number of bytes from the start of the HTTP request message until (and including) the double CRLF before the body.
  - `responseBodySize` &#60;[int]&#62; Size of the received response body in bytes.
  - `responseHeadersSize` &#60;[double]&#62; Total number of bytes from the start of the HTTP response message until (and including) the double CRLF before the body.
  - `responseTransferSize` &#60;[double]&#62; Total number of bytes received for the request.
