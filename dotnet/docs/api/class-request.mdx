...
- [Request.RawHeadersAsync()](./api/class-request.mdx#request-raw-headers)
...
**DEPRECATED**  Use [Request.RawHeadersAsync()](./api/class-request.mdx#request-raw-headers) instead.
...
## Request.RawHeadersAsync() {#request-raw-headers}
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-raw-headers-return"/> &#60;[Headers]&#62;<a href="#request-raw-headers-return" class="list-anchor">#</a>
...
Returns resource size information for given request. Requires the response to be finished via [Response.FinishedAsync()](./api/class-response.mdx#response-finished) to ensure the info is available.
