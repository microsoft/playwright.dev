...
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-service-worker-return"/> &#60;[Worker]?&#62;<a href="#request-service-worker-return" class="list-anchor">#</a>
