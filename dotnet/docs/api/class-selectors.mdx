...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="selectors-register-param-options"/> &#60;`SelectorsRegisterOptions?`&#62;<a href="#selectors-register-param-options" class="list-anchor">#</a>
