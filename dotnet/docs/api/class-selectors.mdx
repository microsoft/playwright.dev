...
- [Selectors.RegisterAsync(name, script, …)](./api/class-selectors.mdx#selectorsregisterasyncname-script-)

## Selectors.RegisterAsync(name, script, …)
...
- `script` <[string]|[string]> Script that evaluates to a selector engine instance.
