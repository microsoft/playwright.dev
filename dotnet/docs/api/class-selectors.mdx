...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="selectors-register-option-options"/> &#60;`SelectorsRegisterOptions?`&#62;<a href="#selectors-register-option-options" class="list-anchor">#</a>
