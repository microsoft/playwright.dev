...
All the options are available in the [configuration file](./test-configuration.mdx). However, selected options can be passed to a command line and take a priority over the configuration file.
