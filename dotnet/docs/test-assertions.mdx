...
- [Expect(Locator).ToContainClassAsync(expected, options)](./test-assertions.mdx#locator-assertions-to-contain-class)
...
## Expect(Locator).ToContainClassAsync(expected, options) {#locator-assertions-to-contain-class}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.24</font>

- `expected`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="locator-assertions-to-contain-class-option-expected"/> &#60;[string]|[IEnumerable]<[string]>&#62; Expected classnames, whitespace separated. When passing an array, the given classes must be present on the locator elements.<a href="#locator-assertions-to-contain-class-option-expected" class="list-anchor">#</a>
- `options` &#60;`LocatorAssertionsToContainClassOptions?`&#62;
  - `IgnoreCase`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="locator-assertions-to-contain-class-option-ignore-case"/> &#60;[bool]?&#62; Whether to perform case-insensitive match.<a href="#locator-assertions-to-contain-class-option-ignore-case" class="list-anchor">#</a>
  - `Timeout`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="locator-assertions-to-contain-class-option-timeout"/> &#60;[double]?&#62; Time to retry the assertion for.<a href="#locator-assertions-to-contain-class-option-timeout" class="list-anchor">#</a>
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="locator-assertions-to-contain-class-return"/> &#60;[void]&#62;<a href="#locator-assertions-to-contain-class-return" class="list-anchor">#</a>

Ensures the [Locator] points to an element that contains the given CSS class (or multiple). In contrast to [Expect(Locator).ToHaveClassAsync(expected, options)](./test-assertions.mdx#locator-assertions-to-have-class) which requires that the [Locator] has exactly the provided classes, `toContainClass` verifies that the [Locator] has a subset (or all) of the given CSS classes.
...
Ensures the [Locator] points to an element with given CSS classes. This needs to be a full match or using a relaxed regular expression. For matching partial class names, use [Expect(Locator).ToContainClassAsync(expected, options)](./test-assertions.mdx#locator-assertions-to-contain-class).
...
- `urlOrRegExp`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="page-assertions-to-have-url-option-url-or-reg-exp"/> &#60;[string]|[Regex]&#62; Expected substring or RegExp. <font size="2">Added in: v1.18</font><a href="#page-assertions-to-have-url-option-url-or-reg-exp" class="list-anchor">#</a>
