...
- [Expect(ApiResponse).NotToBeOKAsync()](./test-assertions.mdx#api-response-assertions-not-to-be-ok)
...
- `values`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="locator-assertions-to-have-values-option-values"/> &#60;[IEnumerable]<[string]|[Regex]>&#62; Expected options currently selected.<a href="#locator-assertions-to-have-values-option-values" class="list-anchor">#</a>
