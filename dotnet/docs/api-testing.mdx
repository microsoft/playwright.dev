...
The following examples rely on the MSTest, NUnit, xUnit or xUnit v3 [base classes](./test-runners.mdx) which create a Playwright and Page instance for each test.
