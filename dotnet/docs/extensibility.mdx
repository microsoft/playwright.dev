...
Playwright supports custom selector engines, registered with [Selectors.RegisterAsync(name, options)](./api/class-selectors.mdx#selectorsregisterasyncname-options).
