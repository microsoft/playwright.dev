...
You can specify where to persist downloaded files using the `downloadsPath` option in [BrowserType.LaunchAsync(…)](./api/class-browsertype.mdx#browsertypelaunchasync).
