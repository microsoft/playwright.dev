...
- new options:
  ...
  * `trial` option to dry-run actions in [Page.Check(selector[, options])](./api/class-page.mdx#pagecheckselector-options), [Page.Uncheck(selector[, options])](./api/class-page.mdx#pageuncheckselector-options), [Page.Click(selector[, options])](./api/class-page.mdx#pageclickselector-options), [Page.DblClickAsync(selector[, options])](./api/class-page.mdx#pagedblclickasyncselector-options), [Page.Hover(selector[, options])](./api/class-page.mdx#pagehoverselector-options) and [Page.Tap(selector[, options])](./api/class-page.mdx#pagetapselector-options)
...
- [Page.SelectOption(selector[, options], values)](./api/class-page.mdx#pageselectoptionselector-options-values) now waits for the options to be present.
