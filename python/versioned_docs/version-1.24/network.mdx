...
To modify a response use [APIRequestContext] to get original response and then pass the response to [route.fulfill(**kwargs)](./api/class-route.mdx#route-fulfill). You can override individual fields on the response via options:
