...
You can specify where to persist downloaded files using the `downloads_path` option in [browser_type.launch(**kwargs)](./api/class-browsertype.mdx#browser_typelaunchkwargs).
