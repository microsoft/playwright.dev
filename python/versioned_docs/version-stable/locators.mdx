...
If you'd like to target one of the two or more elements, and you don't know which one it will be, use [locator.or_()](/api/class-locator.mdx#locator-or) to create a locator that matches any of the alternatives.
