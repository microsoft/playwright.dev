...
- [locator.is_checked()](/api/class-locator.mdx#locator-is-checked)
- [locator.is_disabled()](/api/class-locator.mdx#locator-is-disabled)
- [locator.is_editable()](/api/class-locator.mdx#locator-is-editable)
- [locator.is_enabled()](/api/class-locator.mdx#locator-is-enabled)
- [locator.is_hidden()](/api/class-locator.mdx#locator-is-hidden)
- [locator.is_visible()](/api/class-locator.mdx#locator-is-visible)
