...
**Returns**
- [NoneType]|[pathlib.Path]<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="download-path-return"/><a href="#download-path-return" class="list-anchor">#</a>

---

### save_as {#download-save-as}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>download.save_as</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>download.suggested_filename</span>
