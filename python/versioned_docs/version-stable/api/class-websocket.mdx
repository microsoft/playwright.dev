...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>webSocket.on("close")</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>webSocket.on("framereceived")</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>webSocket.on("framesent")</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>webSocket.on("socketerror")</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>webSocket.expect_event</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>webSocket.is_closed</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>webSocket.wait_for_event</span>
