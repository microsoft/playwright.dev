...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.33</font><x-search>browserContext.on("console")</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.33</font><x-search>browserContext.on("dialog")</x-search>
