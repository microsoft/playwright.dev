...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>tracing.start</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.15</font><span style={{visibility: 'hidden'}}>tracing.start_chunk</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.12</font><span style={{visibility: 'hidden'}}>tracing.stop</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.15</font><span style={{visibility: 'hidden'}}>tracing.stop_chunk</span>
