...
- `name` [str]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-append-option-name"/><a href="#form-data-append-option-name" class="list-anchor">#</a>
  ...
  Field name.
- `value` [str] | [bool] | [int] | [Union]\[[str], [pathlib.Path]\] | [Dict]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-append-option-value"/><a href="#form-data-append-option-value" class="list-anchor">#</a>
  - `name` [str]
...
- `name` [str]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-set-option-name"/><a href="#form-data-set-option-name" class="list-anchor">#</a>
  ...
  Field name.
- `value` [str] | [bool] | [int] | [Union]\[[str], [pathlib.Path]\] | [Dict]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="form-data-set-option-value"/><a href="#form-data-set-option-value" class="list-anchor">#</a>
  - `name` [str]
