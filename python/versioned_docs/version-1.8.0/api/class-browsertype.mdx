...
- [browser_type.launch(**options)](./api/class-browsertype.mdx#browser_typelaunchoptions)
...
>
> In [browser_type.launch(**options)](./api/class-browsertype.mdx#browser_typelaunchoptions) above, any mention of Chromium also applies to Chrome.
>
