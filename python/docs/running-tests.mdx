...
Since Playwright runs in Node.js, you can debug it with your debugger of choice. Playwright comes with the Playwright Inspector which allows you to step through Playwright API calls, see their debug logs and explore [selectors](./selectors.mdx).
