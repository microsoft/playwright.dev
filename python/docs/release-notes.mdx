...
### Assertions
- [expect(locator).to_have_attribute(name, **kwargs)](/test-assertions.mdx#locator-assertions-to-have-attribute-2) can now be used for asserting attribute existence.
