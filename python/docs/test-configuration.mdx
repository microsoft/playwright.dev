...
- `launchOptions` - Browser launch options match [browser_type.launch(**kwargs)](./api/class-browsertype.mdx#browser-type-launch) method.
- `contextOptions` - Context options match [browser.new_context(**kwargs)](./api/class-browser.mdx#browser-new-context) method.
