...
The port gets then passed over to Playwright as a `base_url` when creating the context [browser.new_context(**kwargs)](./api/class-browser.mdx#browser-new-context).
