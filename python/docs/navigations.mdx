...
Clicking an element could trigger asynchronous processing before initiating the navigation. In these cases, it is recommended to explicitly call [page.expect_navigation(**options)](./api/class-page.mdx#pageexpect_navigationoptions). For example:
...
Clicking an element could trigger multiple navigations. In these cases, it is recommended to explicitly [page.expect_navigation(**options)](./api/class-page.mdx#pageexpect_navigationoptions) to a specific url. For example:
