...
In lazy-loaded pages, it can be useful to wait until an element is visible with [page.wait_for_selector(selector, **kwargs)](./api/class-page.mdx#page-wait-for-selector). Alternatively, page interactions like [page.click(selector, **kwargs)](./api/class-page.mdx#page-click) auto-wait for elements.
