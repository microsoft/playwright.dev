...
#### Parameters
- `interesting_only` &#60;[bool]&#62; Prune uninteresting nodes from the tree. Defaults to `true`.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="accessibility-snapshot-option-interesting-only"/><a href="#accessibility-snapshot-option-interesting-only" class="list-anchor">#</a>
