...
- `interesting_only`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="accessibility-interesting-only-param-interesting-only"/> &#60;[bool]&#62; Prune uninteresting nodes from the tree. Defaults to `true`.<a href="#accessibility-interesting-only-param-interesting-only" class="list-anchor">#</a>
