...
- `interesting_only`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="accessibility-snapshot-param-interesting-only"/> &#60;[bool]&#62; Prune uninteresting nodes from the tree. Defaults to `true`.<a href="#accessibility-snapshot-param-interesting-only" class="list-anchor">#</a>
- `root`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="accessibility-snapshot-param-root"/> &#60;[ElementHandle]&#62; The root DOM element for the snapshot. Defaults to the whole page.<a href="#accessibility-snapshot-param-root" class="list-anchor">#</a>
