...
- `name` <[str]> If specified, the trace is going to be saved into the file with the given name inside the `traces_dir` folder specified in [browser_type.launch(**kwargs)](./api/class-browsertype.mdx#browser-type-launch).
