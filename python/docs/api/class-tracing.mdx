...
- `sources`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-start-option-sources"/> &#60;[bool]&#62; Whether to include source files for trace actions.<a href="#tracing-start-option-sources" class="list-anchor">#</a>
- `title`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-start-option-title"/> &#60;[str]&#62; Trace name to be shown in the Trace Viewer.<a href="#tracing-start-option-title" class="list-anchor">#</a>
...
- `title`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-start-chunk-option-title"/> &#60;[str]&#62; Trace name to be shown in the Trace Viewer.<a href="#tracing-start-chunk-option-title" class="list-anchor">#</a>
