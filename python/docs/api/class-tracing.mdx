...
- `path`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="tracing-stop-option-path"/> &#60;[Union]\[[str], [pathlib.Path]\]&#62; Export trace into the file with the given name.<a href="#tracing-stop-option-path" class="list-anchor">#</a>
