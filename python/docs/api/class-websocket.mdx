...
- [web_socket.expect_event(event, **options)](./api/class-websocket.mdx#web_socketexpect_eventevent-options)
- [web_socket.is_closed()](./api/class-websocket.mdx#web_socketis_closed)
- [web_socket.url](./api/class-websocket.mdx#web_socketurl)
- [web_socket.wait_for_event(event, **options)](./api/class-websocket.mdx#web_socketwait_for_eventevent-options)
...
:::note
In most cases, you should use [web_socket.expect_event(event, **options)](./api/class-websocket.mdx#web_socketexpect_eventevent-options).
:::
