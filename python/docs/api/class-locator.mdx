...
- `files` [Union]\[[str], [pathlib.Path]\] | [List]\[[Union]\[[str], [pathlib.Path]\]\] | [Dict] | [List]\[[Dict]\]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-set-input-files-option-files"/><a href="#locator-set-input-files-option-files" class="list-anchor">#</a>
  - `name` [str] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-set-input-files-option-name"/><a href="#locator-set-input-files-option-name" class="list-anchor">#</a>
    
    File name
  - `mimeType` [str] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-set-input-files-option-mime-type"/><a href="#locator-set-input-files-option-mime-type" class="list-anchor">#</a>
    
    File type
  - `buffer` [bytes] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-set-input-files-option-buffer"/><a href="#locator-set-input-files-option-buffer" class="list-anchor">#</a>
