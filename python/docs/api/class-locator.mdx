...
**Arguments**
- `selector` [str]<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="locator-frame-locator-option-selector-or-locator"/><a href="#locator-frame-locator-option-selector-or-locator" class="list-anchor">#</a>
