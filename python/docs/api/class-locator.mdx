...
### snapshot_for_ai {#locator-snapshot-for-ai}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>locator.snapshot_for_ai</x-search>
...
```python
locator.snapshot_for_ai()
locator.snapshot_for_ai(**kwargs)
```
...
**Returns**
- [Dict]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-snapshot-for-ai-return"/><a href="#locator-snapshot-for-ai-return" class="list-anchor">#</a>
  - `full` [str]
...
### to_code {#locator-to-code}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>locator.to_code</x-search>
...
**Returns**
- [str]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-to-code-return"/><a href="#locator-to-code-return" class="list-anchor">#</a>
