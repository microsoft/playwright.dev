...
- `has_text` [str]|[Pattern] *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="locator-filter-1-option-has-text"/><a href="#locator-filter-1-option-has-text" class="list-anchor">#</a>
