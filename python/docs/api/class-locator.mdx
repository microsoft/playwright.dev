...
### viewport_ratio {#locator-viewport-ratio}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.30</font><x-search>locator.viewport_ratio</x-search>
