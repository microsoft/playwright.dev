...
- `files` [Union]\[[str], [pathlib.Path]\] | [List]\[[Union]\[[str], [pathlib.Path]\]\] | [Dict] | [List]\[[Dict]\]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-set-input-files-option-files"/><a href="#locator-set-input-files-option-files" class="list-anchor">#</a>
  - `name` [str]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-set-input-files-option-files-name"/><a href="#locator-set-input-files-option-files-name" class="list-anchor">#</a>
    
    File name
  - `mimeType` [str]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-set-input-files-option-files-mime-type"/><a href="#locator-set-input-files-option-files-mime-type" class="list-anchor">#</a>
    
    File type
  - `buffer` [bytes]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-set-input-files-option-files-buffer"/><a href="#locator-set-input-files-option-files-buffer" class="list-anchor">#</a>
