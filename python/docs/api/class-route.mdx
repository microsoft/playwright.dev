...
- `post_data` [str]|[bytes] *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-continue-option-post-data"/><a href="#route-continue-option-post-data" class="list-anchor">#</a>
...
- `method` [str] *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fallback-option-method"/><a href="#route-fallback-option-method" class="list-anchor">#</a>
  ...
  If set changes the request method (e.g. GET or POST).
- `post_data` [str]|[bytes] *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fallback-option-post-data"/><a href="#route-fallback-option-post-data" class="list-anchor">#</a>
...
**Arguments**
- `data` [str]|[bytes]|[Serializable] *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fetch-option-data"/><a href="#route-fetch-option-data" class="list-anchor">#</a>
