...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>request.existing_response</x-search>
...
**Returns**
- [NoneType] | [Response]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="request-existing-response-return"/><a href="#request-existing-response-return" class="list-anchor">#</a>
