...
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-headers-array-return"/> &#60;[List]\[[List]\[[str]\]\]&#62;<a href="#request-headers-array-return" class="list-anchor">#</a>
