...
- [request.service_worker](./api/class-request.mdx#request-service-worker)
...
## request.service_worker {#request-service-worker}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.24</font>

- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-service-worker-return"/> &#60;[NoneType]|[Worker]&#62;<a href="#request-service-worker-return" class="list-anchor">#</a>
