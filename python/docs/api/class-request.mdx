...
- [request.raw_headers()](./api/class-request.mdx#request-raw-headers)
...
**DEPRECATED**  Use [request.raw_headers()](./api/class-request.mdx#request-raw-headers) instead.
...
## request.raw_headers() {#request-raw-headers}
