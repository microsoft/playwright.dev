...
[PageError] class represents objects created by context when there are unhandled execeptions thrown on the pages and dispatched via the [browser_context.on("pageerror")](/api/class-browsercontext.mdx#browser-context-event-page-error) event.
...
**Returns**
- [NoneType]|[Page]<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="page-error-page-return"/><a href="#page-error-page-return" class="list-anchor">#</a>
