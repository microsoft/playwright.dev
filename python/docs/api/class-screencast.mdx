...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>screencast.hide_actions</x-search>
...
**Returns**
- [NoneType]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-hide-actions-return"/><a href="#screencast-hide-actions-return" class="list-anchor">#</a>

---

### hide_overlays {/* #screencast-hide-overlays */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>screencast.hide_overlays</x-search>
...
**Returns**
- [NoneType]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-hide-overlays-return"/><a href="#screencast-hide-overlays-return" class="list-anchor">#</a>

---

### show_actions {/* #screencast-show-actions */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>screencast.show_actions</x-search>
...
**Arguments**
- `cursor` "none" | "pointer" *(optional)* <font size="2">Added in: v1.61</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-show-actions-option-cursor"/><a href="#screencast-show-actions-option-cursor" class="list-anchor">#</a>
...
- `font_size` [int] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-show-actions-option-font-size"/><a href="#screencast-show-actions-option-font-size" class="list-anchor">#</a>
...
- `style` [Dict] *(optional)* <font size="2">Added in: v1.64</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-show-actions-option-style"/><a href="#screencast-show-actions-option-style" class="list-anchor">#</a>
  - `point` [str] *(optional)*
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>screencast.show_chapter</x-search>
...
**Arguments**
- `title` [str]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-show-chapter-option-title"/><a href="#screencast-show-chapter-option-title" class="list-anchor">#</a>
  
  Title text displayed prominently in the overlay.
- `description` [str] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-show-chapter-option-description"/><a href="#screencast-show-chapter-option-description" class="list-anchor">#</a>
...
**Returns**
- [NoneType]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-show-chapter-return"/><a href="#screencast-show-chapter-return" class="list-anchor">#</a>

---

### show_overlay {/* #screencast-show-overlay */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>screencast.show_overlay</x-search>
...
**Arguments**
- `html` [str]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-show-overlay-option-html"/><a href="#screencast-show-overlay-option-html" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>screencast.show_overlays</x-search>
...
**Returns**
- [NoneType]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-show-overlays-return"/><a href="#screencast-show-overlays-return" class="list-anchor">#</a>
...
**Arguments**
- `fps` [int] *(optional)* <font size="2">Added in: v1.64</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-start-option-fps"/><a href="#screencast-start-option-fps" class="list-anchor">#</a>
...
- `on_frame` [Callable]\[[Dict]\]:[Promise] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-start-option-on-frame"/><a href="#screencast-start-option-on-frame" class="list-anchor">#</a>
  - `data` [bytes]
...
- `path` [Union]\[[str], [pathlib.Path]\] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-start-option-path"/><a href="#screencast-start-option-path" class="list-anchor">#</a>
...
- `size` [Dict] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-start-option-size"/><a href="#screencast-start-option-size" class="list-anchor">#</a>
  - `width` [int]
...
**Returns**
- [NoneType]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-stop-return"/><a href="#screencast-stop-return" class="list-anchor">#</a>
