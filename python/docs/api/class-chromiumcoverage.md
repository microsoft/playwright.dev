...
- [chromium_coverage.start_css_coverage(**options)](./api/class-chromiumcoverage.md#chromiumcoveragestartcsscoverageoptions)
- [chromium_coverage.start_js_coverage(**options)](./api/class-chromiumcoverage.md#chromiumcoveragestartjscoverageoptions)
- [chromium_coverage.stop_css_coverage()](./api/class-chromiumcoverage.md#chromiumcoveragestopcsscoverage)
- [chromium_coverage.stop_js_coverage()](./api/class-chromiumcoverage.md#chromiumcoveragestopjscoverage)

## chromium_coverage.start_css_coverage(**options)
- `reset_on_navigation` <[boolean]> Whether to reset coverage on every navigation. Defaults to `true`.
- returns: <[Promise]>

Returns coverage is started

## chromium_coverage.start_js_coverage(**options)
- `report_anonymous_scripts` <[boolean]> Whether anonymous scripts generated by the page should be reported. Defaults to `false`.
- `reset_on_navigation` <[boolean]> Whether to reset coverage on every navigation. Defaults to `true`.
- returns: <[Promise]>
...
## chromium_coverage.stop_css_coverage()
...
## chromium_coverage.stop_js_coverage()
- returns: <[Promise]<[Array]<[Object]>>>
