...
- `path`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="download-path-param-path"/> &#60;[Union]\[[str], [pathlib.Path]\]&#62; Path where the download should be copied.<a href="#download-path-param-path" class="list-anchor">#</a>
