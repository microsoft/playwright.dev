...
**Arguments**
- `annotate` [Dict] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="video-start-option-annotate"/><a href="#video-start-option-annotate" class="list-anchor">#</a>
...
- `path` [Union]\[[str], [pathlib.Path]\] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="video-start-option-path"/><a href="#video-start-option-path" class="list-anchor">#</a>
