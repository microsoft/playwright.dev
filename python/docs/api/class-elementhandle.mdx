...
If `page_function` returns a [Promise], then [element_handle.eval_on_selector(selector, expression, **kwargs)](./api/class-elementhandle.mdx#element_handleeval_on_selectorselector-expression-kwargs) would wait for the promise to resolve and return its value.
...
If `page_function` returns a [Promise], then [element_handle.eval_on_selector_all(selector, expression, **kwargs)](./api/class-elementhandle.mdx#element_handleeval_on_selector_allselector-expression-kwargs) would wait for the promise to resolve and return its value.
