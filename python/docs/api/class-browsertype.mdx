...
- `pierce_frames` [bool] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-launch-persistent-context-option-pierce-frames"/><a href="#browser-type-launch-persistent-context-option-pierce-frames" class="list-anchor">#</a>
