...
- `api_request_fails_on_error_status` [bool] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-launch-persistent-context-option-api-request-fails-on-error-status"/><a href="#browser-type-launch-persistent-context-option-api-request-fails-on-error-status" class="list-anchor">#</a>
