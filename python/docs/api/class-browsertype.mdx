...
- `proxy` [Dict] *(optional)* <font size="2">Added in: v1.52</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-connect-option-proxy"/><a href="#browser-type-connect-option-proxy" class="list-anchor">#</a>
  - `server` [str]
...
- `proxy` [Dict] *(optional)* <font size="2">Added in: v1.52</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-connect-over-cdp-option-proxy"/><a href="#browser-type-connect-over-cdp-option-proxy" class="list-anchor">#</a>
  - `server` [str]
