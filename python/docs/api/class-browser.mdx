...
- `pierce_frames` [bool] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-context-option-pierce-frames"/><a href="#browser-new-context-option-pierce-frames" class="list-anchor">#</a>
  
  If set to true, all selectors in this context will pierce frames by default, as if every locator was created through [page.pierce_frames()](/api/class-page.mdx#page-pierce-frames). Defaults to `false`.
...
- `permissions` [List]\[[str]\] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-page-option-permissions"/><a href="#browser-new-page-option-permissions" class="list-anchor">#</a>
  ...
  A list of permissions to grant to all pages in this context. See [browser_context.grant_permissions()](/api/class-browsercontext.mdx#browser-context-grant-permissions) for more details. Defaults to none.
- `pierce_frames` [bool] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-page-option-pierce-frames"/><a href="#browser-new-page-option-pierce-frames" class="list-anchor">#</a>
