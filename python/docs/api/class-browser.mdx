...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.23</font><span style={{visibility: 'hidden'}}>browser.browser_type</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browser.is_connected</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.11</font><span style={{visibility: 'hidden'}}>browser.new_browser_cdp_session</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browser.new_context</span>
...
- `permissions` [List]\[[str]\] *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-context-option-permissions"/><a href="#browser-new-context-option-permissions" class="list-anchor">#</a>
  ...
  A list of permissions to grant to all pages in this context. See [browser_context.grant_permissions()](/api/class-browsercontext.mdx#browser-context-grant-permissions) for more details.
...
- `storage_state` [Union]\[[str], [pathlib.Path]\]|[Dict] *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-context-option-storage-state"/><a href="#browser-new-context-option-storage-state" class="list-anchor">#</a>
  ...
  Populates context with given storage state. This option can be used to initialize context with logged-in information obtained via [browser_context.storage_state()](/api/class-browsercontext.mdx#browser-context-storage-state). Either a path to the file with saved storage, or an object with the following fields:
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browser.new_page</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.11</font><span style={{visibility: 'hidden'}}>browser.start_tracing</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.11</font><span style={{visibility: 'hidden'}}>browser.stop_tracing</span>
