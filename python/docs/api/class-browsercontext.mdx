...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>browserContext.set_storage_state</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>browserContext.is_closed</x-search>
...
```python
browser_context.on("dialogclosed", handler)
```
