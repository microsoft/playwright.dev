...
### remove_cookies {#browser-context-remove-cookies}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.43</font><x-search>browserContext.remove_cookies</x-search>
...
**Arguments**
- `filter` [Dict]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-remove-cookies-option-filter"/><a href="#browser-context-remove-cookies-option-filter" class="list-anchor">#</a>
  - `name` [str] *(optional)*
...
**Returns**
- [NoneType]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-remove-cookies-return"/><a href="#browser-context-remove-cookies-return" class="list-anchor">#</a>
