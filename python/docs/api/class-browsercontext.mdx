...
Adds cookies into this browser context. All pages within this context will have these cookies installed. Cookies can be obtained via [browser_context.cookies(**options)](./api/class-browsercontext.mdx#browser_contextcookiesoptions).
...
See [page.expose_binding(name, callback, **options)](./api/class-page.mdx#pageexpose_bindingname-callback-options) for page-only version.
...
Returns all open pages in the context. Non visible pages, such as `"background_page"`, will not be listed here. You can find them using [chromium_browser_context.background_pages](./api/class-chromiumbrowsercontext.mdx#chromium_browser_contextbackground_pages).
...
:::note
Consider using [browser_context.grant_permissions(permissions, **options)](./api/class-browsercontext.mdx#browser_contextgrant_permissionspermissions-options) to grant permissions for the browser context pages to read its geolocation.
:::
...
:::note
In most cases, you should use [browser_context.expect_event(event, **options)](./api/class-browsercontext.mdx#browser_contextexpect_eventevent-options).
:::
