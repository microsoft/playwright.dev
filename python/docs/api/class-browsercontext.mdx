...
### is_closed_or_closing {#browser-context-is-closed-or-closing}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>browserContext.is_closed_or_closing</x-search>
...
```python
browser_context.is_closed_or_closing()
```
