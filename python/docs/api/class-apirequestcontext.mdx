...
If this [APIRequestContext] is obtained via [browser_context.request](/api/class-browsercontext.mdx#browser-context-request) or [page.request](/api/class-page.mdx#page-request), it will keep working until its owning [BrowserContext] closes.

If this [APIRequestContext] was created by [api_request.new_context()](/api/class-apirequest.mdx#api-request-new-context), this method discards all its resources, calling any method on disposed [APIRequestContext] will throw an exception.
