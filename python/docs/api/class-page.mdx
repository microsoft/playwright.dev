...
- `no_wait_for_finish` [bool] *(optional)* <font size="2">Added in: v1.41</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-route-option-no-wait-for-finish"/><a href="#page-route-option-no-wait-for-finish" class="list-anchor">#</a>
  
  If set to true, [page.close()](/api/class-page.mdx#page-close) and [browser_context.close()](/api/class-browsercontext.mdx#browser-context-close) will not wait for the handler to finish and all errors thrown by then handler after the page has been closed are silently caught. Defaults to false.
...
- `no_wait_for_active` [bool] *(optional)* <font size="2">Added in: v1.41</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-unroute-option-no-wait-for-active"/><a href="#page-unroute-option-no-wait-for-active" class="list-anchor">#</a>
  
  If set to true, [page.unroute()](/api/class-page.mdx#page-unroute) will not wait for current handler call (if any) to finish and all errors thrown by the handler after unrouting are silently caught. Defaults to false.
