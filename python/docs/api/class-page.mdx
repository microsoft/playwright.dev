...
- [page.add_init_script(**options)](./api/class-page.mdx#pageadd_init_scriptoptions)
- [page.add_script_tag(**options)](./api/class-page.mdx#pageadd_script_tagoptions)
- [page.add_style_tag(**options)](./api/class-page.mdx#pageadd_style_tagoptions)
...
- [page.dispatch_event(selector, type, **options)](./api/class-page.mdx#pagedispatch_eventselector-type-options)
- [page.emulate_media(**options)](./api/class-page.mdx#pageemulate_mediaoptions)
...
- [page.expect_console_message(**options)](./api/class-page.mdx#pageexpect_console_messageoptions)
- [page.expect_download(**options)](./api/class-page.mdx#pageexpect_downloadoptions)
- [page.expect_event(event, **options)](./api/class-page.mdx#pageexpect_eventevent-options)
- [page.expect_file_chooser(**options)](./api/class-page.mdx#pageexpect_file_chooseroptions)
- [page.expect_navigation(**options)](./api/class-page.mdx#pageexpect_navigationoptions)
- [page.expect_popup(**options)](./api/class-page.mdx#pageexpect_popupoptions)
- [page.expect_request(url_or_predicate, **options)](./api/class-page.mdx#pageexpect_requesturl_or_predicate-options)
- [page.expect_response(url_or_predicate, **options)](./api/class-page.mdx#pageexpect_responseurl_or_predicate-options)
- [page.expect_worker(**options)](./api/class-page.mdx#pageexpect_workeroptions)
- [page.expose_binding(name, callback, **options)](./api/class-page.mdx#pageexpose_bindingname-callback-options)
...
- [page.is_checked(selector, **options)](./api/class-page.mdx#pageis_checkedselector-options)
- [page.is_closed()](./api/class-page.mdx#pageis_closed)
- [page.is_disabled(selector, **options)](./api/class-page.mdx#pageis_disabledselector-options)
- [page.is_editable(selector, **options)](./api/class-page.mdx#pageis_editableselector-options)
- [page.is_enabled(selector, **options)](./api/class-page.mdx#pageis_enabledselector-options)
- [page.is_hidden(selector, **options)](./api/class-page.mdx#pageis_hiddenselector-options)
- [page.is_visible(selector, **options)](./api/class-page.mdx#pageis_visibleselector-options)
...
- [page.select_option(selector, **options)](./api/class-page.mdx#pageselect_optionselector-options)
- [page.set_content(html, **options)](./api/class-page.mdx#pageset_contenthtml-options)
...
- [page.set_input_files(selector, files, **options)](./api/class-page.mdx#pageset_input_filesselector-files-options)
...
- [page.unroute(url, **options)](./api/class-page.mdx#pageunrouteurl-options)
...
- [page.wait_for_event(event, **options)](./api/class-page.mdx#pagewait_for_eventevent-options)
...
- [page.wait_for_request(url_or_predicate, **options)](./api/class-page.mdx#pagewait_for_requesturl_or_predicate-options)
- [page.wait_for_response(url_or_predicate, **options)](./api/class-page.mdx#pagewait_for_responseurl_or_predicate-options)
...
Emitted when a JavaScript dialog appears, such as `alert`, `prompt`, `confirm` or `beforeunload`. Playwright can respond to the dialog via [dialog.accept(**options)](./api/class-dialog.mdx#dialogacceptoptions) or [dialog.dismiss()](./api/class-dialog.mdx#dialogdismiss) methods.
...
Emitted when a file chooser is supposed to appear, such as after clicking the  `<input type=file>`. Playwright can respond to it via setting the input files using [file_chooser.set_files(files, **options)](./api/class-filechooser.mdx#file_chooserset_filesfiles-options) that can be uploaded after that.
...
:::note
Use [page.wait_for_load_state(**options)](./api/class-page.mdx#pagewait_for_load_stateoptions) to wait until the page gets to a particular state (you should not need it in most cases).
:::
...
:::note
The order of evaluation of multiple scripts installed via [browser_context.add_init_script(**options)](./api/class-browsercontext.mdx#browser_contextadd_init_scriptoptions) and [page.add_init_script(**options)](./api/class-page.mdx#pageadd_init_scriptoptions) is not defined.
:::
...
Shortcut for main frame's [frame.add_script_tag(**options)](./api/class-frame.mdx#frameadd_script_tagoptions).
...
Shortcut for main frame's [frame.add_style_tag(**options)](./api/class-frame.mdx#frameadd_style_tagoptions).
...
- `selector` <[str]> A selector to search for element. If there are multiple elements satisfying the selector, the first will be used. See [working with selectors](./selectors.mdx#working-with-selectors) for more details.
...
- `selector` <[str]> A selector to query for. See [working with selectors](./selectors.mdx#working-with-selectors) for more details.
...
If `page_function` returns a [Promise], then [page.eval_on_selector(selector, expression, **options)](./api/class-page.mdx#pageeval_on_selectorselector-expression-options) would wait for the promise to resolve and return its value.
...
Shortcut for main frame's [frame.eval_on_selector(selector, expression, **options)](./api/class-frame.mdx#frameeval_on_selectorselector-expression-options).
...
If `page_function` returns a [Promise], then [page.eval_on_selector_all(selector, expression, **options)](./api/class-page.mdx#pageeval_on_selector_allselector-expression-options) would wait for the promise to resolve and return its value.
...
If the function passed to the [page.evaluate(expression, **options)](./api/class-page.mdx#pageevaluateexpression-options) returns a [Promise], then [page.evaluate(expression, **options)](./api/class-page.mdx#pageevaluateexpression-options) would wait for the promise to resolve and return its value.

If the function passed to the [page.evaluate(expression, **options)](./api/class-page.mdx#pageevaluateexpression-options) returns a non-[Serializable] value, then[ method: `Page.evaluate`] resolves to `undefined`. DevTools Protocol also supports transferring some additional values that are not serializable by `JSON`: `-0`, `NaN`, `Infinity`, `-Infinity`, and bigint literals.
...
[ElementHandle] instances can be passed as an argument to the [page.evaluate(expression, **options)](./api/class-page.mdx#pageevaluateexpression-options):
...
Shortcut for main frame's [frame.evaluate(expression, **options)](./api/class-frame.mdx#frameevaluateexpression-options).
...
The only difference between [page.evaluate(expression, **options)](./api/class-page.mdx#pageevaluateexpression-options) and [page.evaluate_handle(expression, **options)](./api/class-page.mdx#pageevaluate_handleexpression-options) is that [page.evaluate_handle(expression, **options)](./api/class-page.mdx#pageevaluate_handleexpression-options) returns in-page object (JSHandle).

If the function passed to the [page.evaluate_handle(expression, **options)](./api/class-page.mdx#pageevaluate_handleexpression-options) returns a [Promise], then [page.evaluate_handle(expression, **options)](./api/class-page.mdx#pageevaluate_handleexpression-options) would wait for the promise to resolve and return its value.
...
[JSHandle] instances can be passed as an argument to the [page.evaluate_handle(expression, **options)](./api/class-page.mdx#pageevaluate_handleexpression-options):
...
Shortcut for main frame's [frame.expect_navigation(**options)](./api/class-frame.mdx#frameexpect_navigationoptions).
...
See [browser_context.expose_binding(name, callback, **options)](./api/class-browsercontext.mdx#browser_contextexpose_bindingname-callback-options) for the context-wide version.

:::note
Functions installed via [page.expose_binding(name, callback, **options)](./api/class-page.mdx#pageexpose_bindingname-callback-options) survive navigations.
:::
...
This method waits for an element matching `selector`, waits for [actionability](./actionability.mdx) checks, focuses the element, fills it and triggers an `input` event after filling. If the element matching `selector` is not an `<input>`, `<textarea>` or `[contenteditable]` element, this method throws an error. Note that you can pass an empty string to clear the input field.
...
`page.pdf()` generates a pdf of the page with `print` css media. To generate a pdf with `screen` media, call [page.emulate_media(**options)](./api/class-page.mdx#pageemulate_mediaoptions) before calling `page.pdf()`:
...
Shortcut for main frame's [frame.select_option(selector, **options)](./api/class-frame.mdx#frameselect_optionselector-options)
...
In the case of multiple pages in a single browser, each page can have its own viewport size. However, [browser.new_context(**options)](./api/class-browser.mdx#browsernew_contextoptions) allows to set viewport size (and more) for all pages in the context at once.
...
:::note
[page.tap(selector, **options)](./api/class-page.mdx#pagetapselector-options) requires that the `has_touch` option of the browser context be set to true.
:::
...
To pass an argument to the predicate of [page.wait_for_function(expression, **options)](./api/class-page.mdx#pagewait_for_functionexpression-options) function:
...
Shortcut for main frame's [frame.wait_for_function(expression, **options)](./api/class-frame.mdx#framewait_for_functionexpression-options).
...
Shortcut for main frame's [frame.wait_for_load_state(**options)](./api/class-frame.mdx#framewait_for_load_stateoptions).
...
Shortcut for main frame's [frame.wait_for_navigation(**options)](./api/class-frame.mdx#framewait_for_navigationoptions).
