...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>page.aria_snapshot</x-search>
...
- `mode` "ai" | "default" *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-aria-snapshot-option-mode"/><a href="#page-aria-snapshot-option-mode" class="list-anchor">#</a>
...
- `timeout` [float] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-aria-snapshot-option-timeout"/><a href="#page-aria-snapshot-option-timeout" class="list-anchor">#</a>
...
**Returns**
- [str]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-aria-snapshot-return"/><a href="#page-aria-snapshot-return" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>page.cancel_pick_locator</x-search>
...
**Returns**
- [NoneType]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-cancel-pick-locator-return"/><a href="#page-cancel-pick-locator-return" class="list-anchor">#</a>

---

### clear_console_messages {/* #page-clear-console-messages */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>page.clear_console_messages</x-search>
...
**Returns**
- [NoneType]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-clear-console-messages-return"/><a href="#page-clear-console-messages-return" class="list-anchor">#</a>

---

### clear_page_errors {/* #page-clear-page-errors */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>page.clear_page_errors</x-search>
...
**Returns**
- [NoneType]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-clear-page-errors-return"/><a href="#page-clear-page-errors-return" class="list-anchor">#</a>
...
**Arguments**
- `filter` "all" | "since-navigation" *(optional)* <font size="2">Added in: v1.59</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-console-messages-option-filter"/><a href="#page-console-messages-option-filter" class="list-anchor">#</a>
...
**Arguments**
- `include_shadow` [bool] *(optional)* <font size="2">Added in: v1.64</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-content-option-include-shadow"/><a href="#page-content-option-include-shadow" class="list-anchor">#</a>
...
- `no_wait_after` [bool] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-drag-and-drop-option-no-wait-after"/><a href="#page-drag-and-drop-option-no-wait-after" class="list-anchor">#</a>
  ...
  This option has no effect.
- `scroll` "auto" | "none" *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-drag-and-drop-option-scroll"/><a href="#page-drag-and-drop-option-scroll" class="list-anchor">#</a>
...
**Arguments**
- `selector` [str] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-frame-locator-option-selector"/><a href="#page-frame-locator-option-selector" class="list-anchor">#</a>
...
- `description` [str] | [Pattern] *(optional)* <font size="2">Added in: v1.60</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-get-by-role-option-description"/><a href="#page-get-by-role-option-description" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>page.hide_highlight</x-search>
...
**Returns**
- [NoneType]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-hide-highlight-return"/><a href="#page-hide-highlight-return" class="list-anchor">#</a>
...
**Arguments**
- `filter` "all" | "since-navigation" *(optional)* <font size="2">Added in: v1.59</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-page-errors-option-filter"/><a href="#page-page-errors-option-filter" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>page.pick_locator</x-search>
...
**Returns**
- [Locator]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-pick-locator-return"/><a href="#page-pick-locator-return" class="list-anchor">#</a>
...
- `timeout` [float] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-screenshot-option-timeout"/><a href="#page-screenshot-option-timeout" class="list-anchor">#</a>
  ...
  Maximum time in milliseconds. Defaults to `30000` (30 seconds). Pass `0` to disable timeout. The default value can be changed by using the [browser_context.set_default_timeout()](/api/class-browsercontext.mdx#browser-context-set-default-timeout) or [page.set_default_timeout()](/api/class-page.mdx#page-set-default-timeout) methods.
- `type` "png" | "jpeg" | "webp" *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-screenshot-option-type"/><a href="#page-screenshot-option-type" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.61</font><x-search>page.local_storage</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.61</font><x-search>page.session_storage</x-search>
...
### on("dialogclosed") {/* #page-event-dialog-closed */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.63</font><x-search>page.on("dialogclosed")</x-search>

Emitted when a JavaScript dialog has been closed, either by [dialog.accept()](/api/class-dialog.mdx#dialog-accept), by [dialog.dismiss()](/api/class-dialog.mdx#dialog-dismiss), or manually by the user in the headed browser.

**Usage**

```python
page.on("dialogclosed", handler)
```
...
- `scroll` "auto" | "none" *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-check-option-scroll"/><a href="#page-check-option-scroll" class="list-anchor">#</a>
...
- `position` [Dict] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-click-option-position"/><a href="#page-click-option-position" class="list-anchor">#</a>
  ...
  A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
- `scroll` "auto" | "none" *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-click-option-scroll"/><a href="#page-click-option-scroll" class="list-anchor">#</a>
...
- `position` [Dict] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-dblclick-option-position"/><a href="#page-dblclick-option-position" class="list-anchor">#</a>
  ...
  A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
- `scroll` "auto" | "none" *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-dblclick-option-scroll"/><a href="#page-dblclick-option-scroll" class="list-anchor">#</a>
...
- `position` [Dict] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-hover-option-position"/><a href="#page-hover-option-position" class="list-anchor">#</a>
  ...
  A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
- `scroll` "auto" | "none" *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-hover-option-scroll"/><a href="#page-hover-option-scroll" class="list-anchor">#</a>
...
- `position` [Dict] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-set-checked-option-position"/><a href="#page-set-checked-option-position" class="list-anchor">#</a>
  ...
  A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
- `scroll` "auto" | "none" *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-set-checked-option-scroll"/><a href="#page-set-checked-option-scroll" class="list-anchor">#</a>
...
- `position` [Dict] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-tap-option-position"/><a href="#page-tap-option-position" class="list-anchor">#</a>
  ...
  A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
- `scroll` "auto" | "none" *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-tap-option-scroll"/><a href="#page-tap-option-scroll" class="list-anchor">#</a>
...
- `position` [Dict] *(optional)* <font size="2">Added in: v1.11</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-uncheck-option-position"/><a href="#page-uncheck-option-position" class="list-anchor">#</a>
  ...
  A point to use relative to the top-left corner of element padding box. If not specified, uses some visible point of the element.
- `scroll` "auto" | "none" *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-uncheck-option-scroll"/><a href="#page-uncheck-option-scroll" class="list-anchor">#</a>
