...
### handle_locator {#page-handle-locator}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.42</font><x-search>page.handle_locator</x-search>
...
The handler will be executed before [actionability checks](../actionability.mdx) for each action, and also before each attempt of the [web assertions](../test-assertions.mdx). When no actions or assertions are executed, the handler will not be run at all, even if the interstitial element appears on the page.
...
**Arguments**
- `locator` [Locator]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-handle-locator-option-locator"/><a href="#page-handle-locator-option-locator" class="list-anchor">#</a>
  
  Locator that triggers the handler.
- `handler` [Callable]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-handle-locator-option-handler"/><a href="#page-handle-locator-option-handler" class="list-anchor">#</a>
...
**Returns**
- [NoneType]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-handle-locator-return"/><a href="#page-handle-locator-return" class="list-anchor">#</a>
