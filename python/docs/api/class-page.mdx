...
See also [locator.filter()](/api/class-locator.mdx#locator-filter-1) that allows to match by another criteria, like an accessible role, and then filter by the text content.
