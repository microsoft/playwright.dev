...
#### Parameters
- `prompt_text` &#60;[str]&#62; A text to enter in prompt. Does not cause any effects if the dialog's `type` is not prompt. Optional.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="dialog-accept-option-prompt-text"/><a href="#dialog-accept-option-prompt-text" class="list-anchor">#</a>
