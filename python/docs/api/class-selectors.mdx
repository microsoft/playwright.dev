...
- `script` [str]<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="selectors-register-option-script"/><a href="#selectors-register-option-script" class="list-anchor">#</a>
