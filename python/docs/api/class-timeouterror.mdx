...
TimeoutError is emitted whenever certain operations are terminated due to timeout, e.g. [`method: Locator.waitFor`] or [browser_type.launch()](/api/class-browsertype.mdx#browser-type-launch).
