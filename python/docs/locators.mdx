...
If you'd like to target one of the two or more elements, and you don't know which one it will be, use [locator.or_()](/api/class-locator.mdx#locator-or) to create a locator that matches all of the alternatives.
...
possibly throwing the ["strict mode violation" error](#strictness). In this case, you can use [locator.first](/api/class-locator.mdx#locator-first) to only match one of them.
:::
