...
If you absolutely must use CSS or XPath locators, you can use [page.locator()](/api/class-page.mdx#page-locator) to create a locator that takes a [selector](./selectors.mdx) describing how to find an element in the page. Playwright supports CSS and XPath selectors, and auto-detects them if you omit `css=` or `xpath=` prefix.
