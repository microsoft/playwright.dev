...
:::caution
Using [locator.first](/api/class-locator.mdx#locator-first), [locator.last](/api/class-locator.mdx#locator-last), and [locator.nth(index)](/api/class-locator.mdx#locator-nth) is discouraged since it disables the concept of strictness, and as your page changes, Playwright may click on an element you did not intend. It's better to make your locator more specific. Learn more below in [Filtering Locators](#filtering-locators) and the [selectors guide](./#selectors).
:::
