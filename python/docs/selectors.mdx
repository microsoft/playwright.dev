...
`:nth-match()` is also useful to wait until a specified number of elements appear, using [page.wait_for_selector(selector, **options)](./api/class-page.mdx#pagewait_for_selectorselector-options).
