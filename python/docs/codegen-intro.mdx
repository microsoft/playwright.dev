...
###### 
<ProgressiveImage image={require("../images/getting-started/record-test-python.webp")} alt="recording a test" />
...
###### 
<ProgressiveImage image={require("../images/getting-started/pick-locator-python.webp")} alt="picking a locator" />
