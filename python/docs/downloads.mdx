...
You can specify where to persist downloaded files using the `downloads_path` option in [browser_type.launch()](/api/class-browsertype.mdx#browser-type-launch).
