...
```bash
docker run -it --rm --ipc=host mcr.microsoft.com/playwright/python:v1.40.0-jammy /bin/bash
```
...
```bash
docker run -it --rm --ipc=host --user pwuser --security-opt seccomp=seccomp_profile.json mcr.microsoft.com/playwright/python:v1.40.0-jammy /bin/bash
```
...
- `:v1.40.0` - Playwright v1.40.0 release docker image based on Ubuntu 22.04 LTS (Jammy Jellyfish).
- `:v1.40.0-jammy` - Playwright v1.40.0 release docker image based on Ubuntu 22.04 LTS (Jammy Jellyfish).
- `:v1.40.0-focal` - Playwright v1.40.0 release docker image based on Ubuntu 20.04 LTS (Focal Fossa).
