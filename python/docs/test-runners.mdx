...
- `browser_type_launch_args`: Override launch arguments for [browser_type.launch(**kwargs)](./api/class-browsertype.mdx#browser_typelaunchkwargs). It should return a Dict.
- `browser_context_args`: Override the options for [browser.new_context(**kwargs)](./api/class-browser.mdx#browsernew_contextkwargs). It should return a Dict.
