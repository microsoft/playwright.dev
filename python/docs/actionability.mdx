...
Attached check differs between selector-based and handle-based actions, like [page.click(selector, **options)](./api/class-page.mdx#pageclickselector-options) as opposite to [element_handle.click(**options)](./api/class-elementhandle.mdx#element_handleclickoptions):
