...
→ browser_click { target: "e15" }    // "Proceed to checkout"
→ browser_fill_form { fields: [
    { target: "e30", value: "Alice Smith" },
    { target: "e32", value: "123 Main St" },
    { target: "e34", value: "94102" }
  ]}
→ browser_click { target: "e40" }    // "Place order"
→ browser_snapshot
