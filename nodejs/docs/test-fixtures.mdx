...
We assume a `TodoPage` class that helps interacting with a "todo list" page of the web app, following the [Page Object Model](./pom.mdx) pattern. It uses Playwright's `page` internally.
