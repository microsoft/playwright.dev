...
<ProgressiveImage image={require("../images/getting-started/vscode-extension.webp")} alt="install playwright extension" />
...
<ProgressiveImage image={require("../images/getting-started/install-playwright.webp")} alt="install playwright" />
...
<ProgressiveImage image={require("../images/getting-started/install-browsers.webp")} alt="install browsers" />
...
<ProgressiveImage image={require("../images/getting-started/testing-sidebar.webp")} alt="Testing Sidebar" />
...
<ProgressiveImage image={require("../images/getting-started/run-single-test.webp")} alt="run a single test" />
...
<ProgressiveImage image={require("../images/getting-started/run-all-tests.webp")} alt="run all tests" />
...
<ProgressiveImage image={require("../images/getting-started/select-projects.webp")} alt="Selecting projects to run tests on" />
...
<ProgressiveImage image={require("../images/getting-started/show-browser.webp")} alt="show browsers while running tests" />
...
-   **Using Breakpoints**: Set a breakpoint by clicking in the gutter next to a line number. Right-click the test and select **Debug Test**. The test will pause at your breakpoint, allowing you to inspect variables and step through the code.
  ...
  <ProgressiveImage image={require("../images/getting-started/debug-mode.webp")} alt="setting debug mode" />
-   **Live Debugging**: With **Show Browsers** enabled, click on a locator in your code. Playwright will highlight the corresponding element in the browser, making it easy to verify locators.
  ...
  <ProgressiveImage image={require("../images/getting-started/live-debugging.webp")} alt="live debugging in vs code" />
...
<ProgressiveImage image={require("../images/getting-started/error-messaging.webp")} alt="error messaging in vs code" />
...
<ProgressiveImage image={require("../images/getting-started/fix-with-ai.webp")} alt="fix with ai in vs code" />
...
<ProgressiveImage image={require("../images/getting-started/trace-viewer-debug.webp")} alt="trace viewer debugging" />
...
<ProgressiveImage image={require("../images/getting-started/record-new-test.webp")} alt="record a new test" />
...
<ProgressiveImage image={require("../images/getting-started/record-at-cursor.webp")} alt="record at cursor" />
...
<ProgressiveImage image={require("../images/getting-started/pick-locator.webp")} alt="pick locators" />
...
<ProgressiveImage image={require("../images/getting-started/setup-tests.webp")} alt="setup tests in vscode" />
...
<ProgressiveImage image={require("../images/getting-started/global-setup.webp")} alt="running global setup" />
...
<ProgressiveImage image={require("../images/getting-started/selecting-configuration.webp")} alt="Selecting a configuration file" />
