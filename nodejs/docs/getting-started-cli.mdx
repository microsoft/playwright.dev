...
This guide is for anyone who wants to use Playwright with the CLI. If you prefer to install using the VS Code Extension then please see the [Getting Started (VS Code)](./getting-started-vscode.mdx) docs.
