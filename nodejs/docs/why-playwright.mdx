...
* **Capabilities to cover all scenarios**. Support for [file downloads](./network.mdx) and [uploads](./input.mdx), out-of-process iframes, native [input events](./input.mdx), and even [dark mode](./emulation.mdx).
