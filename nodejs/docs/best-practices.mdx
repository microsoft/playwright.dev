...
You can also reuse the signed-in state in the tests with [setup project](./auth.mdx#basic-shared-account-in-all-tests). That way you can log in only once and then skip the log in step for all of the tests.
