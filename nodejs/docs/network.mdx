...
To modify a response use [APIRequestContext] to get original response and then pass the response to [route.fulfill([options])](./api/class-route.mdx#route-fulfill). You can override individual fields on the reponse via options:
