...
PWDEBUG also enables source maps for [`page.evaluate` executions](./core-concepts.mdx#evaluation). This improves the debugging experience for JavaScript executions in the page context.
