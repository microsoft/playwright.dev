...
- [androidInput.drag(from, to, steps)](./api/class-androidinput.mdx#androidinputdragfrom-to-steps)
- [androidInput.press(key)](./api/class-androidinput.mdx#androidinputpresskey)
- [androidInput.swipe(from, segments, steps)](./api/class-androidinput.mdx#androidinputswipefrom-segments-steps)
- [androidInput.tap(point)](./api/class-androidinput.mdx#androidinputtappoint)
- [androidInput.type(text)](./api/class-androidinput.mdx#androidinputtypetext)
