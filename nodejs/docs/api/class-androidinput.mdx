...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>androidInput.drag</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>androidInput.press</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>androidInput.swipe</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>androidInput.tap</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>androidInput.type</span>
