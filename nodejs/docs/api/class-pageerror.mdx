...
[PageError] class represents objects created by context when there are unhandled execeptions thrown on the pages and dispatched via the [browserContext.on('pageerror')](/api/class-browsercontext.mdx#browser-context-event-page-error) event.
