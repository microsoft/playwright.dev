...
- `name`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-option-name"/> &#60;[string]&#62;<a href="#test-info-attach-option-name" class="list-anchor">#</a>
- `options` &#60;[Object]&#62;
  - `body`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-option-body"/> &#60;[string]|[Buffer]&#62;<a href="#test-info-attach-option-body" class="list-anchor">#</a>
  - `contentType`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-option-content-type"/> &#60;[void]|[string]&#62;<a href="#test-info-attach-option-content-type" class="list-anchor">#</a>
  - `path`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-option-path"/> &#60;[string]&#62;<a href="#test-info-attach-option-path" class="list-anchor">#</a>
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-return"/> &#60;[void]&#62;<a href="#test-info-attach-return" class="list-anchor">#</a>
