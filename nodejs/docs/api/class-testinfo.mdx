...
- [testInfo.storage()](/api/class-testinfo.mdx#test-info-storage)
...
## testInfo.storage() {#test-info-storage}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.28</font>

- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-storage-return"/> &#60;[Storage]&#62;<a href="#test-info-storage-return" class="list-anchor">#</a>
