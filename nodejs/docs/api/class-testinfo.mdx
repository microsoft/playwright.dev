...
Skips the currently running test. This is similar to [test.skip(titleOrCondition, testFunctionOrDescription)](./api/class-test.mdx#test-skip).
...
* `'skipped'` for skipped tests, e.g. with [test.skip(titleOrCondition, testFunctionOrDescription)](./api/class-test.mdx#test-skip);
