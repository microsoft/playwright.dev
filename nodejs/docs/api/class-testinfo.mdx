...
- [testInfo.attach(path[, options])](./api/class-testinfo.mdx#test-info-attach-1)
- [testInfo.attach(body, name[, options])](./api/class-testinfo.mdx#test-info-attach-2)
...
## testInfo.attach(path[, options]) {#test-info-attach-1}
- `path`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-1-option-path"/> &#60;[string]&#62;<a href="#test-info-attach-1-option-path" class="list-anchor">#</a>
- `options` &#60;[Object]&#62;
  - `contentType`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-1-option-content-type"/> &#60;[void]|[string]&#62;<a href="#test-info-attach-1-option-content-type" class="list-anchor">#</a>
  - `name`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-1-option-name"/> &#60;[void]|[string]&#62;<a href="#test-info-attach-1-option-name" class="list-anchor">#</a>
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-1-return"/> &#60;[void]&#62;<a href="#test-info-attach-1-return" class="list-anchor">#</a>

Attach a file from disk to the current test. Some reporters show test attachments. The `name` and `contentType` will be inferred by default from the `path`, but you can optionally override either of these.
...
:::note
[testInfo.attach(path[, options])](./api/class-testinfo.mdx#test-info-attach-1) automatically takes care of copying attachments to a location that is accessible to reporters, even if you were to delete the attachment after awaiting the attach call.
:::

## testInfo.attach(body, name[, options]) {#test-info-attach-2}
- `body`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-2-option-body"/> &#60;[string]|[Buffer]&#62;<a href="#test-info-attach-2-option-body" class="list-anchor">#</a>
- `name`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-2-option-name"/> &#60;[string]&#62;<a href="#test-info-attach-2-option-name" class="list-anchor">#</a>
- `options` &#60;[Object]&#62;
  - `contentType`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-2-option-content-type"/> &#60;[void]|[string]&#62;<a href="#test-info-attach-2-option-content-type" class="list-anchor">#</a>
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="test-info-attach-2-return"/> &#60;[void]&#62;<a href="#test-info-attach-2-return" class="list-anchor">#</a>
...
Marks the currently running test as "fixme". The test will be skipped, but the intention is to fix it. This is similar to [test.fixme()](./api/class-test.mdx#test-fixme-2).
...
To safely add a file from disk as an attachment, please use [testInfo.attach(path[, options])](./api/class-testinfo.mdx#test-info-attach-1) instead of directly pushing onto this array. For inline attachments, use [testInfo.attach(path[, options])](./api/class-testinfo.mdx#test-info-attach-1).
