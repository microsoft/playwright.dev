...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="accessibility-snapshot-param-options"/> &#60;[Promise]<[Object]>&#62;<a href="#accessibility-snapshot-param-options" class="list-anchor">#</a>
