...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="accessibility-snapshot-option-options"/> &#60;[Object]&#62;<a href="#accessibility-snapshot-option-options" class="list-anchor">#</a>
