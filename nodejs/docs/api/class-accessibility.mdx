...
**Parameters**
- `options?` &#60;[Object]&#62;
  - `interestingOnly?` &#60;[boolean]&#62; Prune uninteresting nodes from the tree. Defaults to `true`.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="accessibility-snapshot-option-interesting-only"/><a href="#accessibility-snapshot-option-interesting-only" class="list-anchor">#</a>
