...
**Arguments**
- `onFrame` [function]\([Object]\):[Promise]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-start-option-on-frame"/><a href="#screencast-start-option-on-frame" class="list-anchor">#</a>
  - `data` [Buffer]
...
- `options` [Object] *(optional)*
  - `annotate` [Object] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-start-option-annotate"/><a href="#screencast-start-option-annotate" class="list-anchor">#</a>
  ...
  - `preferredSize` [Object] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="screencast-start-option-preferred-size"/><a href="#screencast-start-option-preferred-size" class="list-anchor">#</a>
    - `width` [number]
...
Stops the screencast started with [screencast.start()](/api/class-screencast.mdx#screencast-start).
