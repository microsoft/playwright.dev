...
- `key`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-key-param-key"/> &#60;[string]&#62; Name of the key to press or a character to generate, such as `ArrowLeft` or `a`.<a href="#keyboard-key-param-key" class="list-anchor">#</a>
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-options-param-options"/> &#60;[Object]&#62;<a href="#keyboard-options-param-options" class="list-anchor">#</a>
  - `delay`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-delay-param-delay"/> &#60;[number]&#62; Time to wait between `keydown` and `keyup` in milliseconds. Defaults to 0.<a href="#keyboard-delay-param-delay" class="list-anchor">#</a>
...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-options-param-options"/> &#60;[Object]&#62;<a href="#keyboard-options-param-options" class="list-anchor">#</a>
  - `delay`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-delay-param-delay"/> &#60;[number]&#62; Time to wait between key presses in milliseconds. Defaults to 0.<a href="#keyboard-delay-param-delay" class="list-anchor">#</a>
