...
- `key`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-down-param-key"/> &#60;[Promise]<[string]>&#62; Name of the key to press or a character to generate, such as `ArrowLeft` or `a`.<a href="#keyboard-down-param-key" class="list-anchor">#</a>
...
- `text`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-insert-text-param-text"/> &#60;[Promise]<[string]>&#62; Sets input to the specified text value.<a href="#keyboard-insert-text-param-text" class="list-anchor">#</a>
...
- `key`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-press-param-key"/> &#60;[Promise]<[string]>&#62; Name of the key to press or a character to generate, such as `ArrowLeft` or `a`.<a href="#keyboard-press-param-key" class="list-anchor">#</a>
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-press-param-options"/> &#60;[Promise]<[Object]>&#62;<a href="#keyboard-press-param-options" class="list-anchor">#</a>
...
- `text`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-type-param-text"/> &#60;[Promise]<[string]>&#62; A text to type into a focused element.<a href="#keyboard-type-param-text" class="list-anchor">#</a>
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-type-param-options"/> &#60;[Promise]<[Object]>&#62;<a href="#keyboard-type-param-options" class="list-anchor">#</a>
...
- `key`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="keyboard-up-param-key"/> &#60;[Promise]<[string]>&#62; Name of the key to press or a character to generate, such as `ArrowLeft` or `a`.<a href="#keyboard-up-param-key" class="list-anchor">#</a>
