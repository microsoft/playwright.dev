...
The base directory, relative to the config file, for snapshot files created with `toMatchSnapshot` and `toHaveScreenshot`. Defaults to [testProject.testDir](./api/class-testproject.mdx#test-project-test-dir).
