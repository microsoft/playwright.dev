...
- [testProject.projectSetup](./api/class-testproject.mdx#test-project-project-setup)
- [testProject.projectTeardown](./api/class-testproject.mdx#test-project-project-teardown)
...
## testProject.projectSetup {#test-project-project-setup}
...
Project setup is similar to [testConfig.globalSetup](./api/class-testconfig.mdx#test-config-global-setup), but it is only executed if at least one test from this particular project should be run. Learn more about [global setup and teardown](../test-advanced.mdx#global-setup-and-teardown).
...
## testProject.projectTeardown {#test-project-project-teardown}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.25</font>

- type: &#60;[string]&#62;

Path to the project-specifc teardown file. This file will be required and run after all the tests from this project. It must export a single function. See also [testProject.projectSetup](./api/class-testproject.mdx#test-project-project-setup).

Project teardown is similar to [testConfig.globalTeardown](./api/class-testconfig.mdx#test-config-global-teardown), but it is only executed if at least one test from this particular project did run. Learn more about [global setup and teardown](../test-advanced.mdx#global-setup-and-teardown).
