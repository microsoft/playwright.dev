...
**Arguments**
- `expected` [RegExp]<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="generic-assertions-to-match-option-expected"/><a href="#generic-assertions-to-match-option-expected" class="list-anchor">#</a>
