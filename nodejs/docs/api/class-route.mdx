...
- `options` [Object] *(optional)*
  ...
  - `postData` [string]|[Buffer] *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-continue-option-post-data"/><a href="#route-continue-option-post-data" class="list-anchor">#</a>
...
- `options` [Object] *(optional)*
  ...
  - `method` [string] *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fallback-option-method"/><a href="#route-fallback-option-method" class="list-anchor">#</a>
    ...
    If set changes the request method (e.g. GET or POST).
  - `postData` [string]|[Buffer] *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fallback-option-post-data"/><a href="#route-fallback-option-post-data" class="list-anchor">#</a>
...
**Arguments**
- `options` [Object] *(optional)*
  - `data` [string]|[Buffer]|[Serializable] *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fetch-option-data"/><a href="#route-fetch-option-data" class="list-anchor">#</a>
