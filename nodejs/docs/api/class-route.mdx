...
- `options` [Object] *(optional)*
  ...
  - `signal` [AbortSignal] *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="route-fetch-option-signal"/><a href="#route-fetch-option-signal" class="list-anchor">#</a>
