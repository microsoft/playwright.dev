...
- `errorCode`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-abort-param-error-code"/> &#60;[Promise]<[string]>&#62; Optional error code. Defaults to `failed`, could be one of the following:<a href="#route-abort-param-error-code" class="list-anchor">#</a>
...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-continue-param-options"/> &#60;[Promise]<[Object]>&#62;<a href="#route-continue-param-options" class="list-anchor">#</a>
...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="route-fulfill-param-options"/> &#60;[Promise]<[Object]>&#62;<a href="#route-fulfill-param-options" class="list-anchor">#</a>
