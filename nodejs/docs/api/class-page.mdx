...
- `options` [Object] *(optional)*
  - `allowStayingVisible` [boolean] *(optional)* <font size="2">Added in: v1.44</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-add-locator-handler-option-allow-staying-visible"/><a href="#page-add-locator-handler-option-allow-staying-visible" class="list-anchor">#</a>
...
Removes locator handler added by [page.addLocatorHandler()](/api/class-page.mdx#page-add-locator-handler).

**Usage**

```js
await page.removeLocatorHandler(locator, handler);
```
...
- `handler` [function]\([Locator]\):[Promise]&lt;[Object]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-remove-locator-handler-option-handler"/><a href="#page-remove-locator-handler-option-handler" class="list-anchor">#</a>
  
  Handler passed to [page.addLocatorHandler()](/api/class-page.mdx#page-add-locator-handler).
