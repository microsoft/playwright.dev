...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>page.inspector</x-search>
...
**Returns**
- [Inspector]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-inspector-return"/><a href="#page-inspector-return" class="list-anchor">#</a>
