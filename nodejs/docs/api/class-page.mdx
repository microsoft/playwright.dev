...
### handleLocator {#page-handle-locator}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.42</font><x-search>page.handleLocator</x-search>
...
- `handler` [function]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-handle-locator-option-handler"/><a href="#page-handle-locator-option-handler" class="list-anchor">#</a>
...
**Returns**
- [Promise]&lt;[void]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-handle-locator-return"/><a href="#page-handle-locator-return" class="list-anchor">#</a>
