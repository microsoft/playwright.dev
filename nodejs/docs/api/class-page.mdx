...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.58</font><x-search>page.agent</x-search>
...
**Arguments**
- `options` [Object] *(optional)*
  - `cache` [Object] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-agent-option-cache"/><a href="#page-agent-option-cache" class="list-anchor">#</a>
  ...
  - `secrets` [Object]&lt;[string], [string]&gt; *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-agent-option-secrets"/><a href="#page-agent-option-secrets" class="list-anchor">#</a>
    
    Secrets to hide from the LLM.
  - `systemPrompt` [string] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-agent-option-system-prompt"/><a href="#page-agent-option-system-prompt" class="list-anchor">#</a>
    
    System prompt for the agent's loop.

**Returns**
- [Promise]&lt;[PageAgent]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-agent-return"/><a href="#page-agent-return" class="list-anchor">#</a>
