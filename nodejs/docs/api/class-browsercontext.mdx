...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.addCookies</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.addInitScript</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.11</font><span style={{visibility: 'hidden'}}>browserContext.backgroundPages</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.clearCookies</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.clearPermissions</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.exposeBinding</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.exposeFunction</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.grantPermissions</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.11</font><span style={{visibility: 'hidden'}}>browserContext.newCDPSession</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.newPage</span>
...
- `handler` [function]\([Route], [Request]\)<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-route-option-handler"/><a href="#browser-context-route-option-handler" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.23</font><span style={{visibility: 'hidden'}}>browserContext.routeFromHAR</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.11</font><span style={{visibility: 'hidden'}}>browserContext.serviceWorkers</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.setDefaultNavigationTimeout</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.setDefaultTimeout</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.setExtraHTTPHeaders</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.setGeolocation</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.setOffline</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.storageState</span>
...
- `handler` [function]\([Route], [Request]\) *(optional)*<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-context-unroute-option-handler"/><a href="#browser-context-unroute-option-handler" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.waitForEvent</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browserContext.setHTTPCredentials</span>
