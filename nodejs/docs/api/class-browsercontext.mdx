...
- `options` [Object] *(optional)*
  - `noWaitForFinish` [boolean] *(optional)* <font size="2">Added in: v1.41</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-route-option-no-wait-for-finish"/><a href="#browser-context-route-option-no-wait-for-finish" class="list-anchor">#</a>
...
await browserContext.unroute(url, handler, options);
```
...
- `options` [Object] *(optional)*
  - `noWaitForActive` [boolean] *(optional)* <font size="2">Added in: v1.41</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-unroute-option-no-wait-for-active"/><a href="#browser-context-unroute-option-no-wait-for-active" class="list-anchor">#</a>
