...
Returns all open pages in the context. Non visible pages, such as `"background_page"`, will not be listed here. You can find them using [chromiumBrowserContext.backgroundPages()](./api/class-chromiumbrowsercontext.mdx#chromiumbrowsercontextbackgroundpages).
