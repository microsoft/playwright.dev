...
- `options` [Object] *(optional)*
  - `noWaitAfter` [boolean] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="file-chooser-set-files-option-no-wait-after"/><a href="#file-chooser-set-files-option-no-wait-after" class="list-anchor">#</a>
    ...
    This option has no effect.
  - `signal` [AbortSignal] *(optional)* <font size="2">Added in: v1.61</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="file-chooser-set-files-option-signal"/><a href="#file-chooser-set-files-option-signal" class="list-anchor">#</a>
