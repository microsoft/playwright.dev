...
- `files` [string] | [Array]&lt;[string]&gt; | [Object] | [Array]&lt;[Object]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="file-chooser-set-files-option-files"/><a href="#file-chooser-set-files-option-files" class="list-anchor">#</a>
  ...
  - `mimeType` [string]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="file-chooser-set-files-option-files-mime-type"/><a href="#file-chooser-set-files-option-files-mime-type" class="list-anchor">#</a>
    ...
    File type
  - `buffer` [Buffer]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="file-chooser-set-files-option-files-buffer"/><a href="#file-chooser-set-files-option-files-buffer" class="list-anchor">#</a>
