...
**Returns**
- [number]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="console-message-timestamp-return"/><a href="#console-message-timestamp-return" class="list-anchor">#</a>
