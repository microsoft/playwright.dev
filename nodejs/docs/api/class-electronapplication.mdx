...
**Parameters**
- `page` &#60;[Page]&#62; Page to retrieve the window for.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-browser-window-option-page"/><a href="#electron-application-browser-window-option-page" class="list-anchor">#</a>
...
**Parameters**
- `pageFunction` &#60;[function]|[Electron]&#62; Function to be evaluated in the worker context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-evaluate-option-expression"/><a href="#electron-application-evaluate-option-expression" class="list-anchor">#</a>
- `arg?` &#60;[EvaluationArgument]&#62; Optional argument to pass to `pageFunction`.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-evaluate-option-arg"/><a href="#electron-application-evaluate-option-arg" class="list-anchor">#</a>
...
**Parameters**
- `pageFunction` &#60;[function]|[Electron]&#62; Function to be evaluated in the worker context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-evaluate-handle-option-expression"/><a href="#electron-application-evaluate-handle-option-expression" class="list-anchor">#</a>
- `arg?` &#60;[EvaluationArgument]&#62; Optional argument to pass to `pageFunction`.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-evaluate-handle-option-arg"/><a href="#electron-application-evaluate-handle-option-arg" class="list-anchor">#</a>
...
**Parameters**
- `event` &#60;[string]&#62; Event name, same one typically passed into `*.on(event)`.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-wait-for-event-option-event"/><a href="#electron-application-wait-for-event-option-event" class="list-anchor">#</a>
- `optionsOrPredicate?` &#60;[function]|[Object]&#62; Either a predicate that receives an event or an options object. Optional.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-wait-for-event-option-options-or-predicate"/><a href="#electron-application-wait-for-event-option-options-or-predicate" class="list-anchor">#</a>
