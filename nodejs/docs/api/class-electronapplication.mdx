...
- `page`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-browser-window-param-page"/> &#60;[Promise]<[Page]>&#62; Page to retrieve the window for.<a href="#electron-application-browser-window-param-page" class="list-anchor">#</a>
...
- `pageFunction`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-evaluate-param-expression"/> &#60;[Promise]<[function]|[Electron]>&#62; Function to be evaluated in the worker context.<a href="#electron-application-evaluate-param-expression" class="list-anchor">#</a>
- `arg`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-evaluate-param-arg"/> &#60;[Promise]<[EvaluationArgument]>&#62; Optional argument to pass to `pageFunction`.<a href="#electron-application-evaluate-param-arg" class="list-anchor">#</a>
...
- `pageFunction`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-evaluate-handle-param-expression"/> &#60;[Promise]<[function]|[Electron]>&#62; Function to be evaluated in the worker context.<a href="#electron-application-evaluate-handle-param-expression" class="list-anchor">#</a>
- `arg`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-evaluate-handle-param-arg"/> &#60;[Promise]<[EvaluationArgument]>&#62;<a href="#electron-application-evaluate-handle-param-arg" class="list-anchor">#</a>
...
- `event`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-wait-for-event-param-event"/> &#60;[Promise]<[string]>&#62; Event name, same one typically passed into `*.on(event)`.<a href="#electron-application-wait-for-event-param-event" class="list-anchor">#</a>
- `optionsOrPredicate`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-wait-for-event-param-options-or-predicate"/> &#60;[Promise]<[function]|[Object]>&#62; Either a predicate that receives an event or an options object. Optional.<a href="#electron-application-wait-for-event-param-options-or-predicate" class="list-anchor">#</a>
