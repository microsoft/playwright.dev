...
- `page`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-page-param-page"/> &#60;[Page]&#62; Page to retrieve the window for.<a href="#electron-application-page-param-page" class="list-anchor">#</a>
...
- `pageFunction`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-expression-param-expression"/> &#60;[function]|[Electron]&#62; Function to be evaluated in the worker context.<a href="#electron-application-expression-param-expression" class="list-anchor">#</a>
- `arg`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-arg-param-arg"/> &#60;[EvaluationArgument]&#62; Optional argument to pass to `pageFunction`.<a href="#electron-application-arg-param-arg" class="list-anchor">#</a>
...
- `pageFunction`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-expression-param-expression"/> &#60;[function]|[Electron]&#62; Function to be evaluated in the worker context.<a href="#electron-application-expression-param-expression" class="list-anchor">#</a>
- `arg`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-arg-param-arg"/> &#60;[EvaluationArgument]&#62;<a href="#electron-application-arg-param-arg" class="list-anchor">#</a>
...
- `event`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-event-param-event"/> &#60;[string]&#62; Event name, same one typically passed into `*.on(event)`.<a href="#electron-application-event-param-event" class="list-anchor">#</a>
- `optionsOrPredicate`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="electron-application-options-or-predicate-param-options-or-predicate"/> &#60;[function]|[Object]&#62; Either a predicate that receives an event or an options object. Optional.<a href="#electron-application-options-or-predicate-param-options-or-predicate" class="list-anchor">#</a>
