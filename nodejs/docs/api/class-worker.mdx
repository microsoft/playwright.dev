...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>worker.disconnect</x-search>
...
- `options` [Object] *(optional)*
  - `reason` [string] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="worker-disconnect-option-reason"/><a href="#worker-disconnect-option-reason" class="list-anchor">#</a>
    
    The reason to be reported to the operations interrupted by the worker disconnect.

**Returns**
- [Promise]&lt;[void]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="worker-disconnect-return"/><a href="#worker-disconnect-return" class="list-anchor">#</a>
