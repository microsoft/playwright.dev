...
**Parameters**
- `pageFunction` &#60;[function]|[string]&#62; Function to be evaluated in the worker context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="worker-evaluate-option-expression"/><a href="#worker-evaluate-option-expression" class="list-anchor">#</a>
- `arg?` &#60;[EvaluationArgument]&#62; Optional argument to pass to `pageFunction`.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="worker-evaluate-option-arg"/><a href="#worker-evaluate-option-arg" class="list-anchor">#</a>
...
**Parameters**
- `pageFunction` &#60;[function]|[string]&#62; Function to be evaluated in the worker context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="worker-evaluate-handle-option-expression"/><a href="#worker-evaluate-handle-option-expression" class="list-anchor">#</a>
- `arg?` &#60;[EvaluationArgument]&#62; Optional argument to pass to `pageFunction`.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="worker-evaluate-handle-option-arg"/><a href="#worker-evaluate-handle-option-arg" class="list-anchor">#</a>
