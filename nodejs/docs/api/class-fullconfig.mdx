...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.61</font><x-search>fullConfig.argv</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.61</font><x-search>fullConfig.failOnFlakyTests</x-search>
...
### filteredProjects {/* #full-config-filtered-projects */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.64</font><x-search>fullConfig.filteredProjects</x-search>

List of projects that were selected to run, after applying the `--project` command line filter. When no filter is specified, this is the same as [fullConfig.projects](/api/class-fullconfig.mdx#full-config-projects).

**Usage**

```js
fullConfig.filteredProjects
```
...
**Type**
- [string] | [Array]&lt;[Object]&gt; | "list" | "dot" | "line" | "github" | "json" | "junit" | "null" | "html" | "perfetto"
  - `0` [string]
...
**Type**
- "all" | "changed" | "missing" | "none" | "default"
