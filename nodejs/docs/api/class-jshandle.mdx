...
JSHandle instances can be used as an argument in [page.$eval(selector, pageFunction[, arg])](./api/class-page.mdx#page-eval-on-selector), [page.evaluate(pageFunction[, arg])](./api/class-page.mdx#page-evaluate) and [page.evaluateHandle(pageFunction[, arg])](./api/class-page.mdx#page-evaluate-handle) methods.
...
- `pageFunction`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-evaluate-param-expression"/> &#60;[Promise]<[function]|[string]>&#62; Function to be evaluated in the page context.<a href="#js-handle-evaluate-param-expression" class="list-anchor">#</a>
- `arg`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-evaluate-param-arg"/> &#60;[Promise]<[EvaluationArgument]>&#62; Optional argument to pass to `pageFunction`.<a href="#js-handle-evaluate-param-arg" class="list-anchor">#</a>
...
- `pageFunction`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-evaluate-handle-param-expression"/> &#60;[Promise]<[function]|[string]>&#62; Function to be evaluated in the page context.<a href="#js-handle-evaluate-handle-param-expression" class="list-anchor">#</a>
- `arg`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-evaluate-handle-param-arg"/> &#60;[Promise]<[EvaluationArgument]>&#62; Optional argument to pass to `pageFunction`.<a href="#js-handle-evaluate-handle-param-arg" class="list-anchor">#</a>
...
- `propertyName`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-get-property-param-property-name"/> &#60;[Promise]<[string]>&#62; property to get<a href="#js-handle-get-property-param-property-name" class="list-anchor">#</a>
