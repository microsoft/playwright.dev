...
```js
await jsHandle.evaluate(pageFunction);
await jsHandle.evaluate(pageFunction, arg);
```

#### Parameters
- `pageFunction` &#60;[function]|[string]&#62; Function to be evaluated in the page context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-evaluate-option-expression"/><a href="#js-handle-evaluate-option-expression" class="list-anchor">#</a>
- `arg?` &#60;[EvaluationArgument]&#62; Optional argument to pass to `pageFunction`.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-evaluate-option-arg"/><a href="#js-handle-evaluate-option-arg" class="list-anchor">#</a>
...
#### Parameters
- `pageFunction` &#60;[function]|[string]&#62; Function to be evaluated in the page context.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-evaluate-handle-option-expression"/><a href="#js-handle-evaluate-handle-option-expression" class="list-anchor">#</a>
- `arg?` &#60;[EvaluationArgument]&#62; Optional argument to pass to `pageFunction`.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-evaluate-handle-option-arg"/><a href="#js-handle-evaluate-handle-option-arg" class="list-anchor">#</a>
...
#### Parameters
- `propertyName` &#60;[string]&#62; property to get<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="js-handle-get-property-option-property-name"/><a href="#js-handle-get-property-option-property-name" class="list-anchor">#</a>
