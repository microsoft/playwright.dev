...
- `options` [Object] *(optional)*
  ...
  - `serialize` [Array]&lt;"Map" | "Set"&gt; *(optional)* <font size="2">Added in: v1.64</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="js-handle-evaluate-option-serialize"/><a href="#js-handle-evaluate-option-serialize" class="list-anchor">#</a>
...
- `options` [Object] *(optional)*
  ...
  - `serialize` [Array]&lt;"Map" | "Set"&gt; *(optional)* <font size="2">Added in: v1.64</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="js-handle-evaluate-handle-option-serialize"/><a href="#js-handle-evaluate-handle-option-serialize" class="list-anchor">#</a>
