...
**Returns**
- [null] | [Object]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="debugger-paused-details-return"/><a href="#debugger-paused-details-return" class="list-anchor">#</a>
  - `location` [Object]
    - `file` [string]
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>debugger.requestPause</x-search>
...
**Returns**
- [Promise]&lt;[void]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="debugger-request-pause-return"/><a href="#debugger-request-pause-return" class="list-anchor">#</a>
