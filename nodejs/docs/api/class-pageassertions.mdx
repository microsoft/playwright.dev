...
- `options` [Object] *(optional)*
  - `signal` [AbortSignal] *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-assertions-to-have-title-option-signal"/><a href="#page-assertions-to-have-title-option-signal" class="list-anchor">#</a>
...
**Arguments**
- `url` [string] | [RegExp] | [URLPattern] | [function]\([URL]\):[boolean] <font size="2">Added in: v1.18</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-assertions-to-have-url-option-url"/><a href="#page-assertions-to-have-url-option-url" class="list-anchor">#</a>
...
- `options` [Object] *(optional)*
  ...
  - `signal` [AbortSignal] *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-assertions-to-have-url-option-signal"/><a href="#page-assertions-to-have-url-option-signal" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>pageAssertions.toMatchAriaSnapshot(expected)</x-search>
...
**Arguments**
- `expected` [string]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-assertions-to-match-aria-snapshot-option-expected"/><a href="#page-assertions-to-match-aria-snapshot-option-expected" class="list-anchor">#</a>
- `options` [Object] *(optional)*
  - `signal` [AbortSignal] *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-assertions-to-match-aria-snapshot-option-signal"/><a href="#page-assertions-to-match-aria-snapshot-option-signal" class="list-anchor">#</a>
    
    An optional [`AbortSignal`](https://developer.mozilla.org/en-US/docs/Web/API/AbortSignal) that can cancel the assertion. Aborting the signal fails the assertion like a timeout: if the signal is aborted while the assertion is retrying, or is already aborted before the assertion starts, the assertion fails without retrying further.
  - `timeout` [number] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-assertions-to-match-aria-snapshot-option-timeout"/><a href="#page-assertions-to-match-aria-snapshot-option-timeout" class="list-anchor">#</a>
    
    Time to retry the assertion for in milliseconds. Defaults to `timeout` in `TestConfig.expect`.

**Returns**
- [Promise]&lt;[void]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-assertions-to-match-aria-snapshot-return"/><a href="#page-assertions-to-match-aria-snapshot-return" class="list-anchor">#</a>

---

### toMatchAriaSnapshot(options) {/* #page-assertions-to-match-aria-snapshot-2 */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>pageAssertions.toMatchAriaSnapshot(options)</x-search>
...
**Arguments**
- `options` [Object] *(optional)*
  - `name` [string] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-assertions-to-match-aria-snapshot-2-option-name"/><a href="#page-assertions-to-match-aria-snapshot-2-option-name" class="list-anchor">#</a>
  ...
  - `signal` [AbortSignal] *(optional)* <font size="2">Added in: v1.62</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-assertions-to-match-aria-snapshot-2-option-signal"/><a href="#page-assertions-to-match-aria-snapshot-2-option-signal" class="list-anchor">#</a>
    
    An optional [`AbortSignal`](https://developer.mozilla.org/en-US/docs/Web/API/AbortSignal) that can cancel the assertion. Aborting the signal fails the assertion like a timeout: if the signal is aborted while the assertion is retrying, or is already aborted before the assertion starts, the assertion fails without retrying further.
  - `timeout` [number] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-assertions-to-match-aria-snapshot-2-option-timeout"/><a href="#page-assertions-to-match-aria-snapshot-2-option-timeout" class="list-anchor">#</a>
    
    Time to retry the assertion for in milliseconds. Defaults to `timeout` in `TestConfig.expect`.

**Returns**
- [Promise]&lt;[void]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="page-assertions-to-match-aria-snapshot-2-return"/><a href="#page-assertions-to-match-aria-snapshot-2-return" class="list-anchor">#</a>
