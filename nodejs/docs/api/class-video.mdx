...
#### Parameters
- `path` &#60;[string]&#62; Path where the video should be saved.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="video-save-as-option-path"/><a href="#video-save-as-option-path" class="list-anchor">#</a>
