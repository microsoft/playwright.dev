...
- `options` [Object] *(optional)*
  - `annotate` [Object] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="video-start-option-annotate"/><a href="#video-start-option-annotate" class="list-anchor">#</a>
