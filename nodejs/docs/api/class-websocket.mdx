...
**Parameters**
- `event` &#60;[string]&#62; Event name, same one would pass into `webSocket.on(event)`.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="web-socket-wait-for-event-option-event"/><a href="#web-socket-wait-for-event-option-event" class="list-anchor">#</a>
- `optionsOrPredicate?` &#60;[function]|[Object]&#62; Either a predicate that receives an event or an options object. Optional.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="web-socket-wait-for-event-option-options-or-predicate"/><a href="#web-socket-wait-for-event-option-options-or-predicate" class="list-anchor">#</a>
...
- `options?` &#60;[Object]&#62;
  - `predicate?` &#60;[function]&#62; Receives the event data and resolves to truthy value when the waiting should resolve.<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="web-socket-wait-for-event-option-predicate"/><a href="#web-socket-wait-for-event-option-predicate" class="list-anchor">#</a>
