...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.8</font><span style={{visibility: 'hidden'}}>browser.on('disconnected')</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.11</font><span style={{visibility: 'hidden'}}>browser.newBrowserCDPSession</span>
