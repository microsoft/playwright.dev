...
- `options` [Object] *(optional)*
  ...
  - `metadata` [Object]&lt;[string], [Object]&gt; *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-bind-option-metadata"/><a href="#browser-bind-option-metadata" class="list-anchor">#</a>
    
    Additional metadata to associate with the browser server.
  - `port` [number] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-bind-option-port"/><a href="#browser-bind-option-port" class="list-anchor">#</a>
...
**Returns**
- [Promise]&lt;[Object]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-bind-return"/><a href="#browser-bind-return" class="list-anchor">#</a>
  - `endpoint` [string]
...
- `options` [Object] *(optional)*
  ...
  - `clientCertificates` [Array]&lt;[Object]&gt; *(optional)* <font size="2">Added in: v1.46</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-context-option-client-certificates"/><a href="#browser-new-context-option-client-certificates" class="list-anchor">#</a>
    - `origin` [string]
    ...
    - `noCertificate` [boolean] *(optional)*
  ...
  - `httpCredentials` [Object] | [Array]&lt;[Object]&gt; *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-context-option-http-credentials"/><a href="#browser-new-context-option-http-credentials" class="list-anchor">#</a>
    - `username` [string]
...
- `options` [Object] *(optional)*
  ...
  - `bypassCSP` [boolean] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-page-option-bypass-csp"/><a href="#browser-new-page-option-bypass-csp" class="list-anchor">#</a>
    ...
    Toggles bypassing page's Content-Security-Policy. Defaults to `false`.
  - `clientCertificates` [Array]&lt;[Object]&gt; *(optional)* <font size="2">Added in: v1.46</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-page-option-client-certificates"/><a href="#browser-new-page-option-client-certificates" class="list-anchor">#</a>
    - `origin` [string]
  ...
  - `hasTouch` [boolean] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-page-option-has-touch"/><a href="#browser-new-page-option-has-touch" class="list-anchor">#</a>
    ...
    Specifies if viewport supports touch events. Defaults to false. Learn more about [mobile emulation](../emulation.mdx#devices).
  - `httpCredentials` [Object] | [Array]&lt;[Object]&gt; *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-new-page-option-http-credentials"/><a href="#browser-new-page-option-http-credentials" class="list-anchor">#</a>
    - `username` [string]
...
**Returns**
- [Promise]&lt;[void]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-unbind-return"/><a href="#browser-unbind-return" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browser.on('context')</x-search>
