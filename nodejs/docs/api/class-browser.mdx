...
- `options?` &#60;[Object]&#62;
  ...
  - `forcedColors?`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-context-option-forced-colors"/> &#60;"active"|"none"&#62; Emulates `'forced-colors'` media feature, supported values are `'active'`, `'none'`. See [page.emulateMedia([options])](./api/class-page.mdx#page-emulate-media) for more details. Defaults to `'none'`.<a href="#browser-new-context-option-forced-colors" class="list-anchor">#</a>
  ...
  - `har?`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-context-option-har"/> &#60;[Object]&#62; If specified the network requests that are made in the context will be served from the HAR file.<a href="#browser-new-context-option-har" class="list-anchor">#</a>
...
- `options?` &#60;[Object]&#62;
  ...
  - `forcedColors?`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-page-option-forced-colors"/> &#60;"active"|"none"&#62; Emulates `'forced-colors'` media feature, supported values are `'active'`, `'none'`. See [page.emulateMedia([options])](./api/class-page.mdx#page-emulate-media) for more details. Defaults to `'none'`.<a href="#browser-new-page-option-forced-colors" class="list-anchor">#</a>
  ...
  - `geolocation?`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-page-option-geolocation"/> &#60;[Object]&#62;<a href="#browser-new-page-option-geolocation" class="list-anchor">#</a>
    ...
    - `longitude` &#60;[number]&#62; Longitude between -180 and 180.
    - `accuracy?` &#60;[number]&#62; Non-negative accuracy value. Defaults to `0`.
  - `har?`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-page-option-har"/> &#60;[Object]&#62; If specified the network requests that are made in the context will be served from the HAR file.<a href="#browser-new-page-option-har" class="list-anchor">#</a>
    - `path` &#60;[string]&#62; Path to a [HAR](http://www.softwareishard.com/blog/har-12-spec) file with prerecorded network data. If the HAR file contains an entry with the matching URL and HTTP method, then the entry's headers, status and body will be used to fulfill the network request. An entry resulting in a redirect will be followed automatically. If `path` is a relative path, then it is resolved relative to the current working directory.
    - `fallback?` &#60;"abort"|"continue"&#62; If set to 'abort' any request not found in the HAR file will be aborted. If set to'continue' missing requests will be sent to the network. Defaults to 'abort'.
    - `urlFilter?` &#60;[string]|[RegExp]&#62; A glob pattern or regular expression to match request URL while routing. Only requests with URL matching the pattern will be surved from the HAR file. If not specified, all requests are served from the HAR file.
