...
- `options?` &#60;[Object]&#62;
  ...
  - `serviceWorkers?`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-context-option-service-workers"/> &#60;"allow"|"block"&#62; `"allow"`: [Service Workers](https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API) can be registered by sites.<a href="#browser-new-context-option-service-workers" class="list-anchor">#</a>
