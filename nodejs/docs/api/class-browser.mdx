...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>browser.launchOptions</x-search>

Returns the launch options that were used to launch this browser. The return type matches the options accepted by [browserType.launch()](/api/class-browsertype.mdx#browser-type-launch).
...
**Returns**
- [Object]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-launch-options-return"/><a href="#browser-launch-options-return" class="list-anchor">#</a>
...
### userDataDir {#browser-user-data-dir}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>browser.userDataDir</x-search>

Returns the user data directory that the browser was launched with, or `null` if the browser was launched without a persistent context.
...
**Returns**
- [null] | [string]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-user-data-dir-return"/><a href="#browser-user-data-dir-return" class="list-anchor">#</a>
