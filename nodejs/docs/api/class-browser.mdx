...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-context-param-options"/> &#60;[Promise]<[Object]>&#62;<a href="#browser-new-context-param-options" class="list-anchor">#</a>
...
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-new-page-param-options"/> &#60;[Promise]<[Object]>&#62;<a href="#browser-new-page-param-options" class="list-anchor">#</a>
...
- `page`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-start-tracing-param-page"/> &#60;[Promise]<[Page]>&#62; Optional, if specified, tracing includes screenshots of the given page.<a href="#browser-start-tracing-param-page" class="list-anchor">#</a>
- `options`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="browser-start-tracing-param-options"/> &#60;[Promise]<[Object]>&#62;<a href="#browser-start-tracing-param-options" class="list-anchor">#</a>
