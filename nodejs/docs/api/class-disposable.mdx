...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.59</font><x-search>disposable.dispose</x-search>
...
**Returns**
- [Promise]&lt;[void]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="disposable-dispose-return"/><a href="#disposable-dispose-return" class="list-anchor">#</a>
