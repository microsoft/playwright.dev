...
- type: &#60;[Object]|[Array]<[Object]>&#62;
  ...
  - `timeout?` &#60;[number]&#62; How long to wait for the process to start up and be available in milliseconds. The same timeout is also used to terminate the process. Defaults to 60000.
