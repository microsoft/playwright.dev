...
- [testConfig.configFile](/api/class-testconfig.mdx#test-config-config-file)
...
- [testConfig.groups](/api/class-testconfig.mdx#test-config-groups)
...
## testConfig.configFile {#test-config-config-file}
...
## testConfig.groups {#test-config-groups}
