...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.62</font><x-search>testConfig.httpCache</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.62</font><x-search>testConfig.retryStrategy</x-search>
