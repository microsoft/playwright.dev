...
The maximum number of retry attempts given to failed tests. By default failing tests are not reried. Learn more about [test retries](./test-retries.mdx#retries).
