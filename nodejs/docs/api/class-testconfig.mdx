...
- [testConfig.attachments](./api/class-testconfig.mdx#test-config-attachments)
...
- [testConfig.screenshotsDir](./api/class-testconfig.mdx#test-config-screenshots-dir)
...
## testConfig.attachments {#test-config-attachments}
- type: &#60;[Array]<[Object]>&#62;
...
:::note
This does not include test-level attachments. See [testInfo.attach(name[, options])](./api/class-testinfo.mdx#test-info-attach) and [testInfo.attachments](./api/class-testinfo.mdx#test-info-attachments) for working with test-level attachments.
:::
...
- type: &#60;[Object]&#62;
  ...
  - `toHaveScreenshot` &#60;[Object]&#62;
    ...
    - `animations` &#60;"allow"|"disable"&#62; See `animations` in [page.screenshot([options])](./api/class-page.mdx#page-screenshot). Defaults to `"disable"`.
    - `fonts` &#60;"ready"|"nowait"&#62; See `fonts` in [page.screenshot([options])](./api/class-page.mdx#page-screenshot). Defaults to `"ready"`.
    - `size` &#60;"css"|"device"&#62; See `size` in [page.screenshot([options])](./api/class-page.mdx#page-screenshot). Defaults to `"css"`.
...
## testConfig.screenshotsDir {#test-config-screenshots-dir}
- type: &#60;[string]&#62;
...
- type: &#60;[Object]&#62;
  ...
  - `port` &#60;[number]&#62; Port to wait on for the web server (exactly one of `port` or `url` is required)
  ...
  - `timeout` &#60;[number]&#62; Maximum duration to wait on until the web server is ready
