...
### botName {#test-config-bot-name}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.41</font><x-search>testConfig.botName</x-search>

Unique name of the environment where the tests run. It may be composed of, e.g., operating system name and test run parameters. Test reporters can access the name via `TestProject.botName` property.
