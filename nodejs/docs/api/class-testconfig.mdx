...
- type: &#60;[Object]&#62;
  ...
  - `toMatchSnapshot` &#60;[Object]&#62;
    - `threshold` &#60;[number]&#62; an acceptable percieved color difference in the [YIQ color space](https://en.wikipedia.org/wiki/YIQ) between pixels in compared images, between zero (strict) and one (lax). Defaults to `0.2`.
    - `pixelCount` &#60;[number]&#62; an acceptable amount of pixels that could be different, unset by default.
    - `pixelRatio` &#60;[number]&#62; an acceptable ratio of pixels that are different to the total amount of pixels, between `0` and `1` , unset by default.
