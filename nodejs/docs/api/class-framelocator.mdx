...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.63</font><x-search>frameLocator.get</x-search>
...
**Arguments**
- `by` [By]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-locator-get-option-by"/><a href="#frame-locator-get-option-by" class="list-anchor">#</a>
  
  Page-free locator built with [playwright.by](/api/class-playwright.mdx#playwright-by).

**Returns**
- [Locator]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-locator-get-return"/><a href="#frame-locator-get-return" class="list-anchor">#</a>
...
- `options` [Object] *(optional)*
  ...
  - `description` [string] | [RegExp] *(optional)* <font size="2">Added in: v1.60</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="frame-locator-get-by-role-option-description"/><a href="#frame-locator-get-by-role-option-description" class="list-anchor">#</a>
