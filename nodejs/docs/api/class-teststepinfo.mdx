...
### annotations {/* #test-step-info-annotations */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.58</font><x-search>testStepInfo.annotations</x-search>
