...
Unconditionally skip the currently running step. Test step is immediately aborted. This is similar to [test.step.skip()](/api/class-test.mdx#test-step-skip).
...
Conditionally skips the currently running step with an optional description. This is similar to [test.step.skip()](/api/class-test.mdx#test-step-skip).
