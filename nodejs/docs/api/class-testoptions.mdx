...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.46</font><x-search>testOptions.clientCertificates</x-search>
...
### contrast {/* #test-options-contrast */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.50</font><x-search>testOptions.contrast</x-search>
...
### forcedColors {/* #test-options-forced-colors */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.50</font><x-search>testOptions.forcedColors</x-search>
...
### reducedMotion {/* #test-options-reduced-motion */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.50</font><x-search>testOptions.reducedMotion</x-search>
...
**Type**
- [null] | "reduce" | "no-preference"

---

### screen {/* #test-options-screen */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.64</font><x-search>testOptions.screen</x-search>
...
- [Object] | "off" | "on" | "retain-on-failure" | "on-first-retry" | "retain-on-first-failure" | "retain-on-failure-and-retries"
  ...
  - `snapshots` [boolean] | [Object] *(optional)*
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.62</font><x-search>testOptions.reuseContext</x-search>
