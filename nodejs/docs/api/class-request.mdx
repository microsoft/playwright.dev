...
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-all-headers-return"/> &#60;[Promise]<[Headers]>&#62;<a href="#request-all-headers-return" class="list-anchor">#</a>
...
**DEPRECATED** Incomplete list of headers as seen by the rendering engine. Use [request.allHeaders()](./api/class-request.mdx#request-all-headers) instead.
