...
- [request.rawHeaders()](./api/class-request.mdx#request-raw-headers)
...
**DEPRECATED**  Use [request.rawHeaders()](./api/class-request.mdx#request-raw-headers) instead.
...
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-post-data-json-return"/> &#60;[null]|[Object]&#62;<a href="#request-post-data-json-return" class="list-anchor">#</a>

Returns parsed request's body for `form-urlencoded` and JSON as a fallback if any.

When the response is `application/x-www-form-urlencoded` then a key/value object of the values will be returned. Otherwise it will be parsed as JSON.

## request.rawHeaders() {#request-raw-headers}
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-raw-headers-return"/> &#60;[Promise]<[Headers]>&#62;<a href="#request-raw-headers-return" class="list-anchor">#</a>
...
- returns:<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="request-sizes-return"/> &#60;[Object]&#62;<a href="#request-sizes-return" class="list-anchor">#</a>
  ...
  - `responseBodySize` &#60;[number]&#62; Size of the received response body in bytes.
  ...
  - `responseTransferSize` &#60;[number]&#62; Total number of bytes received for the request.

Returns resource size information for given request. Requires the response to be finished via [response.finished()](./api/class-response.mdx#response-finished) to ensure the info is available.
