...
### toMatchAriaSnapshot {#locator-assertions-to-match-aria-snapshot}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.49</font><x-search>locatorAssertions.toMatchAriaSnapshot</x-search>
