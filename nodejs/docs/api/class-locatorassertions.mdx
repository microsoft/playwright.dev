...
- `options` [Object] *(optional)*
  - `partial` [boolean] *(optional)* <font size="2">Added in: v1.52</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="locator-assertions-to-have-class-option-partial"/><a href="#locator-assertions-to-have-class-option-partial" class="list-anchor">#</a>
