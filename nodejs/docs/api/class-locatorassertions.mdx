...
- [locatorAssertions.toBeChecked()](./api/class-locatorassertions.mdx#locator-assertions-to-be-checked)
...
## locatorAssertions.toBeChecked() {#locator-assertions-to-be-checked}
