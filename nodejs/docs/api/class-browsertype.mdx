...
- `options` [Object] *(optional)*
  ...
  - `noDefaults` [boolean] *(optional)* <font size="2">Added in: v1.53</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-connect-over-cdp-option-no-defaults"/><a href="#browser-type-connect-over-cdp-option-no-defaults" class="list-anchor">#</a>
...
**Arguments**
- `options` [Object] *(optional)*
  - `allowClientNetwork` [string] *(optional)* <font size="2">Added in: v1.60</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-launch-server-option-allow-client-network"/><a href="#browser-type-launch-server-option-allow-client-network" class="list-anchor">#</a>
