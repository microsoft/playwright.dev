...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserType.connectToWorker</x-search>
...
**Arguments**
- `endpoint` [string]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-connect-to-worker-option-endpoint"/><a href="#browser-type-connect-to-worker-option-endpoint" class="list-anchor">#</a>
  
  A CDP websocket endpoint or http url to connect to. For example `http://localhost:9229/` or `ws://127.0.0.1:9229/something`.
- `options` [Object] *(optional)*
  - `timeout` [number] *(optional)*<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-connect-to-worker-option-timeout"/><a href="#browser-type-connect-to-worker-option-timeout" class="list-anchor">#</a>
    
    Maximum time in milliseconds to wait for the connection to be established. Defaults to `30000` (30 seconds). Pass `0` to disable timeout.

**Returns**
- [Promise]&lt;[Worker]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-type-connect-to-worker-return"/><a href="#browser-type-connect-to-worker-return" class="list-anchor">#</a>
