...
* [reporter.onConfigure()](/api/class-reporter.mdx#reporter-on-configure) is called once config has been resolved.
...
* [reporter.onExit()](/api/class-reporter.mdx#reporter-on-exit) is called before test runner exits.
...
### onConfigure {#reporter-on-configure}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.30</font><x-search>reporter.onConfigure</x-search>
...
**Arguments**
- `config` [TestConfig]<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="reporter-on-configure-option-config"/><a href="#reporter-on-configure-option-config" class="list-anchor">#</a>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.30</font><x-search>reporter.onExit</x-search>
