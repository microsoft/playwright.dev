...
- `result` [Object]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="reporter-on-end-option-result"/><a href="#reporter-on-end-option-result" class="list-anchor">#</a>
  - `status` "passed" | "failed" | "timedout" | "interrupted" <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="reporter-on-end-option-status"/><a href="#reporter-on-end-option-status" class="list-anchor">#</a>
    
    Test run status.
  - `startTime` [Date] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="reporter-on-end-option-start-time"/><a href="#reporter-on-end-option-start-time" class="list-anchor">#</a>
    
    Test run start wall time.
  - `duration` [number] <font size="2">Added in: v1.0</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="reporter-on-end-option-duration"/><a href="#reporter-on-end-option-duration" class="list-anchor">#</a>
