...
- `error` [TestError]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="reporter-on-error-option-error"/><a href="#reporter-on-error-option-error" class="list-anchor">#</a>
  ...
  The error.
- `workerInfo` [WorkerInfo] *(optional)* <font size="2">Added in: v1.60</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="reporter-on-error-option-worker-info"/><a href="#reporter-on-error-option-worker-info" class="list-anchor">#</a>
...
### preprocessSuite {/* #reporter-preprocess-suite */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.61</font><x-search>reporter.preprocessSuite</x-search>
...
```js
await reporter.preprocessSuite(config, suite);
```

**Arguments**
- `config` [FullConfig]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="reporter-preprocess-suite-option-config"/><a href="#reporter-preprocess-suite-option-config" class="list-anchor">#</a>
  
  Resolved configuration.
- `suite` [Suite]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="reporter-preprocess-suite-option-suite"/><a href="#reporter-preprocess-suite-option-suite" class="list-anchor">#</a>
  ...
  The suite ignores the `--shard` argument: it always contains the full, un-sharded corpus. Playwright applies its built-in sharding after [reporter.preprocessSuite()](/api/class-reporter.mdx#reporter-preprocess-suite) returns, unless the returned `implementsSharding` is `true`.

**Returns**
- [Promise]&lt;[Object]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="reporter-preprocess-suite-return"/><a href="#reporter-preprocess-suite-return" class="list-anchor">#</a>
  - `implementsSharding` [boolean] *(optional)*
    
    When `true`, Playwright skips its built-in shard filter for this run, leaving sharding to the reporter (typically implemented by calling [testCase.exclude()](/api/class-testcase.mdx#test-case-exclude) on out-of-shard tests).
