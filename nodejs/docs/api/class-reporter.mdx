...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.62</font><x-search>reporter.preprocess</x-search>
...
**Arguments**
- `params` [Object]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="reporter-preprocess-option-params"/><a href="#reporter-preprocess-option-params" class="list-anchor">#</a>
  - `config` [FullConfig]
...
**Returns**
- [Promise]&lt;[void]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="reporter-preprocess-return"/><a href="#reporter-preprocess-return" class="list-anchor">#</a>
