...
- [reporter.onStepBegin(test, result, result)](./api/class-reporter.mdx#reporter-on-step-begin)
- [reporter.onStepEnd(test, result, result)](./api/class-reporter.mdx#reporter-on-step-end)
...
## reporter.onStepBegin(test, result, result) {#reporter-on-step-begin}
- `test`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="reporter-on-step-begin-option-test"/> &#60;[TestCase]&#62; Test that has been started.<a href="#reporter-on-step-begin-option-test" class="list-anchor">#</a>
...
- `result`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="reporter-on-step-begin-option-step"/> &#60;[TestStep]&#62; Test step instance.<a href="#reporter-on-step-begin-option-step" class="list-anchor">#</a>
...
## reporter.onStepEnd(test, result, result) {#reporter-on-step-end}
- `test`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="reporter-on-step-end-option-test"/> &#60;[TestCase]&#62; Test that has been finished.<a href="#reporter-on-step-end-option-test" class="list-anchor">#</a>
...
- `result`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="reporter-on-step-end-option-step"/> &#60;[TestStep]&#62; Test step instance.<a href="#reporter-on-step-end-option-step" class="list-anchor">#</a>
