...
**Returns**
- [Array]&lt;[string]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="web-socket-route-protocols-return"/><a href="#web-socket-route-protocols-return" class="list-anchor">#</a>
