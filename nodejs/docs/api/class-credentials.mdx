...
**Returns**
- [Promise]&lt;[void]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="credentials-set-user-verified-return"/><a href="#credentials-set-user-verified-return" class="list-anchor">#</a>
