...
- `options?` &#60;[Object]&#62;
  ...
  - `port?`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="android-devices-option-port"/> &#60;[number]&#62; Optional port to establish ADB server connection.<a href="#android-devices-option-port" class="list-anchor">#</a>
