...
Playwright has **experimental** support for Android automation. See [here](./mobile.mdx) for more information. You can access android namespace via:
...
- `timeout`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="android-set-default-timeout-param-timeout"/> &#60;[Promise]<[number]>&#62; Maximum time in milliseconds<a href="#android-set-default-timeout-param-timeout" class="list-anchor">#</a>
