...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.28</font><span style={{visibility: 'hidden'}}>android.connect</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>android.devices</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.28</font><span style={{visibility: 'hidden'}}>android.launchServer</span>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.9</font><span style={{visibility: 'hidden'}}>android.setDefaultTimeout</span>
