...
- `options?` &#60;[Object]&#62;
  - `host?`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="android-devices-option-host"/> &#60;[string]&#62; Optional host to establish ADB server connection. Default to `127.0.0.1`.<a href="#android-devices-option-host" class="list-anchor">#</a>
  - `omitDriverInstall?`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="android-devices-option-omit-driver-install"/> &#60;[boolean]&#62; Prevents automatic playwright driver installation on attach. Assumes that the drivers have been installed already.<a href="#android-devices-option-omit-driver-install" class="list-anchor">#</a>
  - `port?`<a aria-hidden="true" tabindex="-1" class="list-anchor-link" id="android-devices-option-port"/> &#60;[number]&#62; Optional port to establish ADB server connection. Default to `5037`.<a href="#android-devices-option-port" class="list-anchor">#</a>
