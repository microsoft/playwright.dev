...
- `--ignore-snapshots` or `-i`: Whether to ignore [snapshots](./test-snapshots.mdx). Use this when snapshot expectations are known to be different, e.g. running tests on Linux against Windows screenshots.
