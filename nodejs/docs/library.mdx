...
| Assertions | No built-in Web-First Assertions | [Web-First assertions](./test-assertions.mdx) like: <ul><li>[expect(page).toHaveTitle()](/test-assertions.mdx#page-assertions-to-have-title)</li><li>[expect(page).toHaveScreenshot()](/test-assertions.mdx#page-assertions-to-have-screenshot-1)</li></ul> which auto-wait and retry for the condition to be met.|
