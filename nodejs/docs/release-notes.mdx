...
It is now possible to call [test.describe()](/api/class-test.mdx#test-describe-2) to create suites without a title. This is useful for giving a group of tests a common option with [test.use()](/api/class-test.mdx#test-use).
