...
| [expect(locator).toBeEditable()](/api/class-locatorassertions.mdx#locator-assertions-to-be-editable) | Element is enabled |
...
| [expect(locator).toIntersectViewport()](/api/class-locatorassertions.mdx#locator-assertions-to-intersect-viewport) | Element intersects viewport |
