...
```bash
docker pull mcr.microsoft.com/playwright:v1.41.2-jammy
```
...
```bash
docker run -it --rm --ipc=host mcr.microsoft.com/playwright:v1.41.2-jammy /bin/bash
```
...
```bash
docker run -it --rm --ipc=host --user pwuser --security-opt seccomp=seccomp_profile.json mcr.microsoft.com/playwright:v1.41.2-jammy /bin/bash
```
...
- `:v1.41.2` - Playwright v1.41.2 release docker image based on Ubuntu 22.04 LTS (Jammy Jellyfish).
- `:v1.41.2-jammy` - Playwright v1.41.2 release docker image based on Ubuntu 22.04 LTS (Jammy Jellyfish).
- `:v1.41.2-focal` - Playwright v1.41.2 release docker image based on Ubuntu 20.04 LTS (Focal Fossa).
...
RUN npx -y playwright@1.41.2 install --with-deps
```
