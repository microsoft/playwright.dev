...
<ProgressiveImage image={require("../images/getting-started/html-report-failed-tests.webp")} alt="playwright html report" />
...
<ProgressiveImage image={require("../images/getting-started/html-report-trace.webp")} alt="playwright html report detailed view" />
...
<ProgressiveImage image={require("../images/getting-started/trace-viewer-failed-test.webp")} alt="playwright trace viewer" />
