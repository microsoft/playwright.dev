...
Traces are normally run in a Continuous Integration(CI) environment as locally you can use [debugging](/debug.mdx) methods to debug tests. However should you want to run traces locally you can use `--retries=1`.
