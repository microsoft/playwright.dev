...
<ProgressiveImage image={require("../images/getting-started/run-tests-cli.webp")} alt="tests running in command line" />
...
<ProgressiveImage image={require("../images/getting-started/ui-mode.webp")} alt="UI Mode" />
...
<ProgressiveImage image={require("../images/getting-started/ui-mode-error.webp")} alt="showing errors in ui mode" />
...
<ProgressiveImage image={require("../images/getting-started/ui-mode-pick-locator.webp")} alt="pick locator in ui mode" />
...
<ProgressiveImage image={require("../images/getting-started/run-tests-debug.webp")} alt="Debugging Tests with the Playwright inspector" />
...
<ProgressiveImage image={require("../images/getting-started/run-tests-pick-locator.webp")} alt="Locator picker in the Playwright Inspector" />
...
<ProgressiveImage image={require("../images/getting-started/html-report.webp")} alt="HTML Report" />
...
<ProgressiveImage image={require("../images/getting-started/html-report-detail.webp")} alt="HTML Reporter detail view" />
