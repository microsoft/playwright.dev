...
**What you will learn:**
- [How to use GitHub Actions to run your tests](./ci-intro.mdx#github-actions)
- [How to create a repo and push to GitHub](./ci-intro.mdx#create-a-repo-and-push-to-github)
- [How to open the workflows](./ci-intro.mdx#opening-the-workflows)
- [How to view the test logs](./ci-intro.mdx#viewing-test-logs)
- [How to download the report from GitHub](./ci-intro.mdx#downloading-the-html-report)
- [How to view the report](./ci-intro.mdx#viewing-the-html-report)
...
- [Learn how to use Selectors](/locators.mdx#selectors)
