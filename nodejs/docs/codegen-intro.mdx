...
###### 
<ProgressiveImage image={require("../images/getting-started/record-test-js.webp")} alt="Recording a test" />
...
###### 
<ProgressiveImage image={require("../images/getting-started/pick-locator-js.webp")} alt="picking a locator" />
