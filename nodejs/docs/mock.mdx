...
- [Verifying API calls](#verifying-api-calls)
- [Updating mock](#updating-mock)
...
page started loading. The easiest way to achieve that is to call [page.addInitScript(script[, arg])](./api/class-page.mdx#page-add-init-script):
