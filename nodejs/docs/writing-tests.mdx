...
Take a look at the example test included when installing Playwright to see how to write a test using [web first assertions](/test-assertions.mdx), [locators](/locators.mdx) and [selectors](/locators.mdx#selectors).
...
[Selectors](./locators.mdx#selectors) are strings that are used to create Locators. Playwright supports many different selectors like [Text](./locators.mdx#text-selector), [CSS](./locators.mdx#css-selector), [XPath](./locators.mdx#xpath-selectors) and many more. Learn more about available selectors and how to pick one in this [in-depth guide](./locators.mdx#selectors).
