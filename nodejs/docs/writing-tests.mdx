...
| Action | Description |
| :- | :- |
| [locator.check([options])](/api/class-locator.mdx#locator-check) | Check the input checkbox |
| [locator.click([options])](/api/class-locator.mdx#locator-click) | Click the element |
| [locator.uncheck([options])](/api/class-locator.mdx#locator-uncheck) | Uncheck the input checkbox |
| [locator.hover([options])](/api/class-locator.mdx#locator-hover) | Hover mouse over the element |
| [locator.fill(value[, options])](/api/class-locator.mdx#locator-fill) | Fill the form field (fast) |
| [locator.focus([options])](/api/class-locator.mdx#locator-focus) | Focus the element |
| [locator.press(key[, options])](/api/class-locator.mdx#locator-press) | Press single key |
| [locator.setInputFiles(files[, options])](/api/class-locator.mdx#locator-set-input-files) | Pick files to upload |
| [locator.selectOption(values[, options])](/api/class-locator.mdx#locator-select-option) | Select option in the drop down |
| [locator.type(text[, options])](/api/class-locator.mdx#locator-type) | Type text character by character (slow) |
...
| :- | :- |
| [expect(locator).toBeChecked([options])](/test-assertions.mdx#locator-assertions-to-be-checked) | Checkbox is checked |
| [expect(locator).toBeChecked([options])](/test-assertions.mdx#locator-assertions-to-be-checked) | Checkbox is checked |
| [expect(locator).toBeEnabled([options])](/test-assertions.mdx#locator-assertions-to-be-enabled) | Control is enabled |
| [expect(locator).toBeVisible([options])](/test-assertions.mdx#locator-assertions-to-be-visible) | Element is visible |
| [expect(locator).toContainText(expected[, options])](/test-assertions.mdx#locator-assertions-to-contain-text) | Element contains text |
| [expect(locator).toHaveAttribute(name, value[, options])](/test-assertions.mdx#locator-assertions-to-have-attribute) | Element has attribute |
| [expect(locator).toHaveCount(count[, options])](/test-assertions.mdx#locator-assertions-to-have-count) | List of elements has given length |
| [expect(locator).toHaveText(expected[, options])](/test-assertions.mdx#locator-assertions-to-have-text) | Element matches text |
| [expect(locator).toHaveValue(value[, options])](/test-assertions.mdx#locator-assertions-to-have-value) | Input element has value |
| [expect(page).toHaveTitle(titleOrRegExp[, options])](/test-assertions.mdx#page-assertions-to-have-title) | Page has title |
| [expect(page).toHaveURL(urlOrRegExp[, options])](/test-assertions.mdx#page-assertions-to-have-url) | Page has URL |
| [expect(page).toHaveScreenshot(name[, options])](/test-assertions.mdx#page-assertions-to-have-screenshot-1) | Page has screenshot |
