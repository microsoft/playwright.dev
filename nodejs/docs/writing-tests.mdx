...
| [locator.fill()](/api/class-locator.mdx#locator-fill) | Fill the form field (fast) |
...
| [locator.type()](/api/class-locator.mdx#locator-type) | Type text character by character (slow) |
...
| :- | :- |
| [expect(locator).toBeChecked()](/test-assertions.mdx#locator-assertions-to-be-checked) | Checkbox is checked |
| [expect(locator).toBeChecked()](/test-assertions.mdx#locator-assertions-to-be-checked) | Checkbox is checked |
| [expect(locator).toBeEnabled()](/test-assertions.mdx#locator-assertions-to-be-enabled) | Control is enabled |
| [expect(locator).toBeVisible()](/test-assertions.mdx#locator-assertions-to-be-visible) | Element is visible |
| [expect(locator).toContainText()](/test-assertions.mdx#locator-assertions-to-contain-text) | Element contains text |
| [expect(locator).toHaveAttribute()](/test-assertions.mdx#locator-assertions-to-have-attribute) | Element has attribute |
| [expect(locator).toHaveCount()](/test-assertions.mdx#locator-assertions-to-have-count) | List of elements has given length |
| [expect(locator).toHaveText()](/test-assertions.mdx#locator-assertions-to-have-text) | Element matches text |
| [expect(locator).toHaveValue()](/test-assertions.mdx#locator-assertions-to-have-value) | Input element has value |
| [expect(page).toHaveTitle()](/test-assertions.mdx#page-assertions-to-have-title) | Page has title |
| [expect(page).toHaveURL()](/test-assertions.mdx#page-assertions-to-have-url) | Page has URL |
| [expect(page).toHaveScreenshot()](/test-assertions.mdx#page-assertions-to-have-screenshot-1) | Page has screenshot |
