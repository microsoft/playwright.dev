...
A [`Browser`](api/class-browser.mdx#class-browser) refers to an instance of Chromium, Firefox
...
- [class `Browser`](api/class-browser.mdx)

<br/>

## Browser contexts

A [`BrowserContext`](api/class-browsercontext.mdx#class-browsercontext) is an isolated incognito-alike
...
- [class `BrowserContext`](api/class-browsercontext.mdx)
...
A Browser context can have multiple pages. A [`Page`](api/class-page.mdx#class-page)
...
A page can have one or more [Frame](api/class-frame.mdx#class-frame) objects attached to
...
- [class `Page`](api/class-page.mdx)
- [class `Frame`](api/class-frame.mdx)
- [page.frame()](./api/class-page.mdx#pageframeframeselector)
...
Actions like `click` and `fill` auto-wait for the element to be visible and [actionable](./actionability.mdx). For example, click will:
...
- [page.click()](./api/class-page.mdx#pageclickselector-options)
- [page.fill()](./api/class-page.mdx#pagefillselector-value-options)
- [page.waitForSelector()](./api/class-page.mdx#pagewaitforselectorselector-options)
...
The [`page.evaluate`](https://github.com/microsoft/playwright/blob/master/docs/api/class-page.mdx#pageevaluatepagefunction-arg) API can run a JavaScript function in the context
...
- [`page.evaluate()`](api/class-page.mdx#pageevaluatepagefunction-arg)
- [`frame.evaluate()`](api/class-frame.mdx#frameevaluatepagefunction-arg)
...
- [`JSHandle`](./api/class-jshandle.mdx#class-jshandle) to reference any JavaScript objects in the page
- [`ElementHandle`](./api/class-elementhandle.mdx#class-elementhandle) to reference DOM elements in the page

Note that since any DOM element in the page is also a JavaScript object,
Playwright's [`ElementHandle`](api/class-elementhandle.mdx) extends
[`JSHandle`](api/class-jshandle.mdx).

### Handles Lifecycle
- Handles can be acquired using the page methods [`page.evaluateHandle`](./api/class-page.mdx#pageevaluatehandlepagefunction-arg), [`page.$`](api/class-page.mdx#pageselector) or [`page.$$`](api/class-page.mdx#pageselector-1) or
  their frame counterparts [`frame.evaluateHandle`](./api/class-frame.mdx#frameevaluatehandlepagefunction-arg), [`frame.$`](api/class-frame.mdx#frameselector) or [`frame.$$`](api/class-frame.mdx#frameselector-1).
...
- Handles can be **manually disposed** using [`jsHandle.dispose`](./api/class-jshandle.mdx#jshandledispose) method.
...
Handles can also be passed as arguments to [`page.evaluate`](api/class-page.mdx#pageevaluatepagefunction-arg) function:
...
#### API reference
- [class `JSHandle`](api/class-jshandle.mdx)
- [class `ElementHandle`](api/class-elementhandle.mdx)
- [`page.evaluateHandle()`](api/class-page.mdx#pageevaluatehandlepagefunction-arg)
- [`page.$()`](api/class-page.mdx#pageselector)
- [`page.$$()`](api/class-page.mdx#pageselector-1)
- [`jsHandle.evaluate()`](./api/class-jshandle.mdx#jshandleevaluatepagefunction-arg)
