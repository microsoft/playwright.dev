...
Browser websocket endpoint which can be used as an argument to [browserType.connect(params)](api/class-browsertype.mdx#browsertypeconnectparams) to establish connection to the
browser.
