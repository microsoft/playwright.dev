...
- [elementHandle.scrollIntoViewIfNeeded()](api/class-elementhandle.mdx#elementhandlescrollintoviewifneeded)
- [elementHandle.selectOption(values[, options])](api/class-elementhandle.mdx#elementhandleselectoptionvalues-options)
- [elementHandle.selectText()](api/class-elementhandle.mdx#elementhandleselecttext)
