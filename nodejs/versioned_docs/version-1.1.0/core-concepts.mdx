...
Handles Lifetime:
- Handles can be acquired using the page methods [`page.evaluteHandle`](./api/class-page.mdx#pageevaluatehandlepagefunction-arg), [`page.$`](api/class-page.mdx#pageselector) or [`page.$$`](api/class-page.mdx#pageselector-1) or
