...
To learn more about navigation and loading, read [this document](loading.mdx).
...
Handles Lifetime:
- Handles can we be acquired using the page methods [`page.evaluteHandle`](./api/class-page.mdx#pageevaluatehandlepagefunction-arg), [`page.$`](api/class-page.mdx#pageselector) or [`page.$$`](api/class-page.mdx#pageselector-1) or
...
Alternatively, handles can be passed as arguments to [`page.evaluate`](api/class-page.mdx#pageevaluatepagefunction-arg) function:
...
- [`page.evaluteHandle`](api/class-page.mdx#pageevaluatehandlepagefunction-arg)
