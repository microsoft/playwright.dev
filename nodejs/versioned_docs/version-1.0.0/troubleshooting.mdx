...
In order to protect the host environment from untrusted web content, Chrome uses [multiple layers of sandboxing](https://chromium.googlesource.com/chromium/src/+/HEAD/docs/linux_sandboxing.mdx). For this to work properly,
...
#### [alternative] Setup [setuid sandbox](https://chromium.googlesource.com/chromium/src/+/HEAD/docs/linux_suid_sandbox_development.mdx)
...
> 👋 We run our tests for Playwright in a Docker container - see our [Docker setup](docker/README.mdx) for reference.
