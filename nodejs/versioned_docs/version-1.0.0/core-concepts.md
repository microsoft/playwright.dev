...
Handles Lifetime:
- Handles can we be acquired using the page methods [`page.evaluteHandle`](./api/class-page.md#pageevaluatehandlepagefunction-arg), [`page.$`](api/class-page.md#pageselector) or [`page.$$`](api/class-page.md#pageselector-1) or
