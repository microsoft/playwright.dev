...
You can also use [`browserContext.setHTTPCredentials`](./api/class-browser.mdx#browsercontextsethttpcredentialshttpcredentials) to update HTTP credentials of an existing context.
...
For every attachment downloaded by the page, [`"download"`](https://github.com/microsoft/playwright/blob/master/docs/api/class-page.mdx#event-download) event is emitted. If you create a browser context with the `acceptDownloads: true`, all these attachments are going to be downloaded into a temporary folder. You can obtain the download url, file system path and payload stream using the [`Download`](https://github.com/microsoft/playwright/blob/master/docs/api/class-download.mdx#class-download) object from the event.
...
- [`Download`](https://github.com/microsoft/playwright/blob/master/docs/class-download.mdx)
- [`page.on('download')`](api/class-page.mdx#event-download)
- [`page.waitForEvent(event)`](api/class-page.mdx#pagewaitforeventevent-optionsorpredicate)
...
- [class `Request`](./api/class-request.mdx#class-request)
- [class `Response`](./api/class-response.mdx#class-response)
...
- [`Route`](./api/class-route.mdx#class-route)
