...
- [expect(locator).toBeDisabled()](./api/class-locatorassertions.mdx#locator-assertions-to-be-disabled)
- [expect(locator).toBeEditable()](./api/class-locatorassertions.mdx#locator-assertions-to-be-editable)
- [expect(locator).toBeEmpty()](./api/class-locatorassertions.mdx#locator-assertions-to-be-empty)
- [expect(locator).toBeEnabled()](./api/class-locatorassertions.mdx#locator-assertions-to-be-enabled)
- [expect(locator).toBeFocused()](./api/class-locatorassertions.mdx#locator-assertions-to-be-focused)
- [expect(locator).toBeHidden()](./api/class-locatorassertions.mdx#locator-assertions-to-be-hidden)
- [expect(locator).toBeVisible()](./api/class-locatorassertions.mdx#locator-assertions-to-be-visible)
- [expect(locator).toContainText(expected[, options])](./api/class-locatorassertions.mdx#locator-assertions-to-contain-text)
- [expect(locator).toHaveAttribute(name, value)](./api/class-locatorassertions.mdx#locator-assertions-to-have-attribute)
- [expect(locator).toHaveClass(expected)](./api/class-locatorassertions.mdx#locator-assertions-to-have-class)
- [expect(locator).toHaveCount(count)](./api/class-locatorassertions.mdx#locator-assertions-to-have-count)
- [expect(locator).toHaveCSS(name, value)](./api/class-locatorassertions.mdx#locator-assertions-to-have-css)
- [expect(locator).toHaveId(id)](./api/class-locatorassertions.mdx#locator-assertions-to-have-id)
- [expect(locator).toHaveJSProperty(name, value)](./api/class-locatorassertions.mdx#locator-assertions-to-have-js-property)
- [expect(locator).toHaveText(expected[, options])](./api/class-locatorassertions.mdx#locator-assertions-to-have-text)
- [expect(locator).toHaveValue(value)](./api/class-locatorassertions.mdx#locator-assertions-to-have-value)
...
## expect(locator).toBeDisabled() {#locator-assertions-to-be-disabled}
...
## expect(locator).toBeEditable() {#locator-assertions-to-be-editable}
...
## expect(locator).toBeEmpty() {#locator-assertions-to-be-empty}
...
## expect(locator).toBeEnabled() {#locator-assertions-to-be-enabled}
...
## expect(locator).toBeFocused() {#locator-assertions-to-be-focused}
...
## expect(locator).toBeHidden() {#locator-assertions-to-be-hidden}
...
## expect(locator).toBeVisible() {#locator-assertions-to-be-visible}
...
## expect(locator).toHaveAttribute(name, value) {#locator-assertions-to-have-attribute}
...
## expect(locator).toHaveClass(expected) {#locator-assertions-to-have-class}
...
## expect(locator).toHaveCount(count) {#locator-assertions-to-have-count}
...
## expect(locator).toHaveCSS(name, value) {#locator-assertions-to-have-css}
...
## expect(locator).toHaveId(id) {#locator-assertions-to-have-id}
...
## expect(locator).toHaveJSProperty(name, value) {#locator-assertions-to-have-js-property}
...
## expect(locator).toHaveValue(value) {#locator-assertions-to-have-value}
