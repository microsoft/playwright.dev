...
[browser contexts](./core-concepts.mdx#browser-contexts). This isolation model
...
use [`browser.newContext`](./network.mdx#http-authentication).
...
[Input guide](./input.mdx) for more details.
...
- [`browserContext.cookies`](./api/class-browsercontext.mdx#browsercontextcookiesurls)
- [`browserContext.addCookies`](./api/class-browsercontext.mdx#browsercontextaddcookiescookies)
- [`page.evaluate`](./api/class-page.mdx#pageevaluatepagefunction-arg)
- [`browserContext.addInitScript`](./api/class-browsercontext.mdx#browsercontextaddinitscriptscript-arg)
...
and other local state. This disk location is called the [User data directory](https://chromium.googlesource.com/chromium/src/+/master/docs/user_data_dir.mdx).
...
### API reference
- [class `BrowserContext`](./api/class-browsercontext.mdx#class-browsercontext)
- [`browserType.launchPersistentContext`](./api/class-browsertype.mdx#browsertypelaunchpersistentcontextuserdatadir-options)
