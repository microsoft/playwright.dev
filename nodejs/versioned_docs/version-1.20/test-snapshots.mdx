...
You can pass various options to modify image comparison behavior - see [expect(screenshot).toMatchSnapshot(name[, options])](./test-assertions.mdx#screenshot-assertions-to-match-snapshot):
