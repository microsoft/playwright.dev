...
- [event: 'console'](api/class-page.mdx#event-console)
- [event: 'crash'](api/class-page.mdx#event-crash)
- [event: 'dialog'](api/class-page.mdx#event-dialog)
- [event: 'domcontentloaded'](api/class-page.mdx#event-domcontentloaded)
- [event: 'download'](api/class-page.mdx#event-download)
- [event: 'filechooser'](api/class-page.mdx#event-filechooser)
- [event: 'frameattached'](api/class-page.mdx#event-frameattached)
- [event: 'framedetached'](api/class-page.mdx#event-framedetached)
- [event: 'framenavigated'](api/class-page.mdx#event-framenavigated)
- [event: 'load'](api/class-page.mdx#event-load)
- [event: 'pageerror'](api/class-page.mdx#event-pageerror)
- [event: 'popup'](api/class-page.mdx#event-popup)
- [event: 'request'](api/class-page.mdx#event-request)
- [event: 'requestfailed'](api/class-page.mdx#event-requestfailed)
- [event: 'requestfinished'](api/class-page.mdx#event-requestfinished)
- [event: 'response'](api/class-page.mdx#event-response)
- [event: 'worker'](api/class-page.mdx#event-worker)
...
- [page.exposeBinding(name, playwrightBinding)](api/class-page.mdx#pageexposebindingname-playwrightbinding)
- [page.exposeFunction(name, playwrightFunction)](api/class-page.mdx#pageexposefunctionname-playwrightfunction)
...
Emitted when a JavaScript dialog appears, such as `alert`, `prompt`, `confirm` or `beforeunload`. Playwright can respond to the dialog via [Dialog]'s [accept](api/class-dialog.mdx#dialogacceptprompttext) or [dismiss](api/class-dialog.mdx#dialogdismiss) methods.
...
Emitted when a file chooser is supposed to appear, such as after clicking the  `<input type=file>`. Playwright can respond to it via setting the input files using [`fileChooser.setFiles`](api/class-filechooser.mdx#filechoosersetfilesfiles-options) that can be uploaded after that.
...
Emitted when the page opens a new tab or window. This event is emitted in addition to the [`browserContext.on('page')`](api/class-browsercontext.mdx#event-page), but only for popups relevant to this page.
...
In order to intercept and mutate requests, see [`page.route()`](#pagerouteurl-handler) or [`browserContext.route()`](api/class-browsercontext.mdx#browsercontextrouteurl-handler).
...
## page.$(selector)
- `selector` <[string]> A selector to query page for. See [working with selectors](/api/working-with-selectors.mdx)) for more details.
...
> **NOTE** The order of evaluation of multiple scripts installed via [browserContext.addInitScript(script[, arg])](api/class-browsercontext.mdx#browsercontextaddinitscriptscript-arg) and [page.addInitScript(script[, arg])](#pageaddinitscriptscript-arg) is not defined.
...
Shortcut for [page.mainFrame().addScriptTag(options)](api/class-frame.mdx#frameaddscripttagoptions).
...
Shortcut for [page.mainFrame().addStyleTag(options)](api/class-frame.mdx#frameaddstyletagoptions).
...
- `selector` <[string]> A selector to search for checkbox or radio button to check. If there are multiple elements satisfying the selector, the first will be checked. See [working with selectors](/api/working-with-selectors.mdx) for more details.
- `options` <[Object]>
...
This method waits for an element matching `selector`, waits for [actionability](./actionability.mdx) checks. Then, if the element is not already checked, this method scrolls the element into view and uses [elementHandle.click](api/class-elementhandle.mdx#elementhandleclickoptions) to click in the center of the element.

If there's no element matching `selector`, the method waits until a matching element appears in the DOM. If the element is detached during the [actionability](./actionability.mdx) checks, the action is retried.

Shortcut for [page.mainFrame().check(selector[, options])](api/class-frame.mdx#framecheckselector-options).

## page.click(selector[, options])
- `selector` <[string]> A selector to search for element to click. If there are multiple elements satisfying the selector, the first will be clicked. See [working with selectors](/api/working-with-selectors.mdx) for more details.
- `options` <[Object]>
...
This method waits for an element matching `selector`, waits for [actionability](./actionability.mdx) checks, then scrolls the element into view if needed and uses [page.mouse](#pagemouse) to click in the center of the element.

If there's no element matching `selector`, the method waits until a matching element appears in the DOM. If the element is detached during the [actionability](./actionability.mdx) checks, the action is retried.


Shortcut for [page.mainFrame().click(selector[, options])](api/class-frame.mdx#frameclickselector-options).
...
Browser-specific Coverage implementation, only available for Chromium atm. See [ChromiumCoverage](api/class-chromiumcoverage.mdx#class-chromiumcoverage) for more details.

## page.dblclick(selector[, options])
- `selector` <[string]> A selector to search for element to double click. If there are multiple elements satisfying the selector, the first will be double clicked. See [working with selectors](/api/working-with-selectors.mdx) for more details.
- `options` <[Object]>
  - `button` <"left"|"right"|"middle"> Defaults to `left`.
  - `delay` <[number]> Time to wait between `mousedown` and `mouseup` in milliseconds. Defaults to 0.
...
This method waits for an element matching `selector`, waits for [actionability](./actionability.mdx) checks, then scrolls the element into view if needed and uses [page.mouse](#pagemouse) to double click in the center of the element.
...
Shortcut for [page.mainFrame().dblclick(selector[, options])](api/class-frame.mdx#framedblclickselector-options).


## page.dispatchEvent(selector, type[, eventInit, options])
- `selector` <[string]> A selector to search for element to use. If there are multiple elements satisfying the selector, the first will be used. See [working with selectors](/api/working-with-selectors.mdx) for more details.
...
Shortcut for [page.mainFrame().evaluate(pageFunction[, arg])](api/class-frame.mdx#frameevaluatepagefunction-arg).
...
See [browserContext.exposeBinding(name, playwrightBinding)](api/class-browsercontext.mdx#browsercontextexposebindingname-playwrightbinding) for the context-wide version.
...
See [browserContext.exposeFunction(name, playwrightFunction)](api/class-browsercontext.mdx#browsercontextexposefunctionname-playwrightfunction) for context-wide exposed function.
...
This method waits for an element matching `selector`, waits for [actionability](./actionability.mdx) checks, focuses the element, fills it and triggers an `input` event after filling.
...
Shortcut for [page.mainFrame().fill()](api/class-frame.mdx#framefillselector-value-options)

## page.focus(selector[, options])
- `selector` <[string]> A selector of an element to focus. If there are multiple elements satisfying the selector, the first will be focused. See [working with selectors](/api/working-with-selectors.mdx) for more details.
- `options` <[Object]>
  - `timeout` <[number]> Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the [browserContext.setDefaultTimeout(timeout)](#browsercontextsetdefaulttimeouttimeout) or [page.setDefaultTimeout(timeout)](#pagesetdefaulttimeouttimeout) methods.
...
Shortcut for [page.mainFrame().focus(selector)](api/class-frame.mdx#framefocusselector-options).
...
- `selector` <[string]> A selector to search for an element. If there are multiple elements satisfying the selector, the first will be picked. See [working with selectors](/api/working-with-selectors.mdx) for more details.
...
- `options` <[Object]> Navigation parameters which might have the following properties:
  - `timeout` <[number]> Maximum navigation time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the [browserContext.setDefaultNavigationTimeout(timeout)](api/class-browsercontext.mdx#browsercontextsetdefaultnavigationtimeouttimeout), [browserContext.setDefaultTimeout(timeout)](#browsercontextsetdefaulttimeouttimeout), [page.setDefaultNavigationTimeout(timeout)](#pagesetdefaultnavigationtimeouttimeout) or [page.setDefaultTimeout(timeout)](#pagesetdefaulttimeouttimeout) methods.
...
Shortcut for [page.mainFrame().goto(url[, options])](api/class-frame.mdx#framegotourl-options)

## page.hover(selector[, options])
- `selector` <[string]> A selector to search for element to hover. If there are multiple elements satisfying the selector, the first will be hovered. See [working with selectors](/api/working-with-selectors.mdx) for more details.
- `options` <[Object]>
...
This method waits for an element matching `selector`, waits for [actionability](./actionability.mdx) checks, then scrolls the element into view if needed and uses [page.mouse](#pagemouse) to hover over the center of the element.

If there's no element matching `selector`, the method waits until a matching element appears in the DOM. If the element is detached during the [actionability](./actionability.mdx) checks, the action is retried.

Shortcut for [page.mainFrame().hover(selector[, options])](api/class-frame.mdx#framehoverselector-options).
...
- `selector` <[string]> A selector of an element to type into. If there are multiple elements satisfying the selector, the first will be used. See [working with selectors](/api/working-with-selectors.mdx) for more details.
...
Focuses the element, and then uses [`keyboard.down`](api/class-keyboard.mdx#keyboarddownkey) and [`keyboard.up`](api/class-keyboard.mdx#keyboardupkey).
...
Shortcut for [page.mainFrame().selectOption()](api/class-frame.mdx#frameselectoptionselector-values-options)
...
Shortcut for [page.mainFrame().title()](api/class-frame.mdx#frametitle).
...
To press a special key, like `Control` or `ArrowDown`, use [`keyboard.press`](api/class-keyboard.mdx#keyboardpresskey-options).
...
Shortcut for [page.mainFrame().type(selector, text[, options])](api/class-frame.mdx#frametypeselector-text-options).

## page.uncheck(selector, [options])
- `selector` <[string]> A selector to search for uncheckbox to check. If there are multiple elements satisfying the selector, the first will be checked. See [working with selectors](/api/working-with-selectors.mdx) for more details.
- `options` <[Object]>
  - `force` <[boolean]> Whether to bypass the [actionability](./actionability.mdx) checks. Defaults to `false`.
  - `noWaitAfter` <[boolean]> Actions that initiate navigations are waiting for these navigations to happen and for pages to start loading. You can opt out of waiting via setting this flag. You would only need this option in the exceptional cases such as navigating to inaccessible pages. Defaults to `false`.
  - `timeout` <[number]> Maximum time in milliseconds, defaults to 30 seconds, pass `0` to disable timeout. The default value can be changed by using the [browserContext.setDefaultTimeout(timeout)](#browsercontextsetdefaulttimeouttimeout) or [page.setDefaultTimeout(timeout)](#pagesetdefaulttimeouttimeout) methods.
...
This method waits for an element matching `selector`, waits for [actionability](./actionability.mdx) checks. Then, if the element is not already unchecked, this method scrolls the element into view and uses [elementHandle.click](#elementhandleclickoptions) to click in the center of the element.

If there's no element matching `selector`, the method waits until a matching element appears in the DOM. If the element is detached during the [actionability](./actionability.mdx) checks, the action is retried.

Shortcut for [page.mainFrame().uncheck(selector[, options])](api/class-frame.mdx#frameuncheckselector-options).
...
This is a shortcut for [page.mainFrame().url()](api/class-frame.mdx#frameurl)
...
Shortcut for [page.mainFrame().waitForFunction(pageFunction, arg, options]])](api/class-frame.mdx#framewaitforfunctionpagefunction-arg-options).
...
Shortcut for [page.mainFrame().waitForLoadState([options])](api/class-frame.mdx#framewaitforloadstatestate-options).
...
Shortcut for [page.mainFrame().waitForNavigation(options)](api/class-frame.mdx#framewaitfornavigationoptions).
...
- `selector` <[string]> A selector of an element to wait for. See [working with selectors](/api/working-with-selectors.mdx) for more details.
- `options` <[Object]>
...
```
Shortcut for [page.mainFrame().waitForSelector(selector[, options])](api/class-frame.mdx#framewaitforselectorselector-options).
