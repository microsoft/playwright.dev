...
- `selector` <[string]> A selector of an element to wait for, relative to the element handle. See [working with selectors](/api/working-with-selectors.mdx) for more details.
- `options` <[Object]>
...
> **NOTE** This method does not work across navigations, use [page.waitForSelector(selector[, options])](api/class-page.mdx#pagewaitforselectorselector-options) instead.
