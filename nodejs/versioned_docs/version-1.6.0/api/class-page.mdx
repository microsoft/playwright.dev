...
- [event: 'websocket'](api/class-page.mdx#event-websocket)
...
- [page.exposeBinding(name, playwrightBinding[, options])](api/class-page.mdx#pageexposebindingname-playwrightbinding-options)
...
See [browserContext.exposeBinding(name, playwrightBinding)](api/class-browsercontext.mdx#browsercontextexposebindingname-playwrightbinding-options) for the context-wide version.
...
- `selector` <[string]> A selector to search for element to tap. If there are multiple elements satisfying the selector, the first will be tapped. See [working with selectors](/api/working-with-selectors.mdx) for more details.
- `options` <[Object]>
...
Shortcut for [page.mainFrame().tap()](api/class-frame.mdx#framename).
