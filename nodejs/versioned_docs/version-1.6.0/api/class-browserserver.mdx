...
Browser websocket endpoint which can be used as an argument to [browserType.connect(options)](api/class-browsertype.mdx#browsertypeconnectoptions) to establish connection to the browser.
