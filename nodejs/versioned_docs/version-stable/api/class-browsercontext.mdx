...
**Returns**
- [Promise]&lt;[Disposable]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-expose-binding-return"/><a href="#browser-context-expose-binding-return" class="list-anchor">#</a>
...
**Returns**
- [Promise]&lt;[Disposable]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-expose-function-return"/><a href="#browser-context-expose-function-return" class="list-anchor">#</a>
...
**Arguments**
- `url` [string] | [RegExp] | [URLPattern] | [function]\([URL]\):[boolean]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-route-option-url"/><a href="#browser-context-route-option-url" class="list-anchor">#</a>
...
**Returns**
- [Promise]&lt;[Disposable]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-route-return"/><a href="#browser-context-route-return" class="list-anchor">#</a>
...
**Arguments**
- `httpCredentials` [null] | [Object] | [Array]&lt;[Object]&gt;<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-set-http-credentials-option-http-credentials"/><a href="#browser-context-set-http-credentials-option-http-credentials" class="list-anchor">#</a>
  - `username` [string]
...
**Arguments**
- `options` [Object] *(optional)*
  - `credentials` [boolean] *(optional)* <font size="2">Added in: v1.61</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-storage-state-option-credentials"/><a href="#browser-context-storage-state-option-credentials" class="list-anchor">#</a>
  ...
  - `opfs` [boolean] *(optional)* <font size="2">Added in: v1.63</font><a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-storage-state-option-opfs"/><a href="#browser-context-storage-state-option-opfs" class="list-anchor">#</a>
...
**Arguments**
- `url` [string] | [RegExp] | [URLPattern] | [function]\([URL]\):[boolean]<a aria-hidden="true" tabIndex="-1" class="list-anchor-link" id="browser-context-unroute-option-url"/><a href="#browser-context-unroute-option-url" class="list-anchor">#</a>
...
### on('dialogclosed') {/* #browser-context-event-dialog-closed */}

<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.63</font><x-search>browserContext.on('dialogclosed')</x-search>
...
```js
browserContext.on('dialogclosed', data => {});
```
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.on('download')</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.on('frameattached')</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.on('framedetached')</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.on('framenavigated')</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.on('pageclose')</x-search>
...
<font size="2" style={{position: "relative", top: "-20px"}}>Added in: v1.60</font><x-search>browserContext.on('pageload')</x-search>
