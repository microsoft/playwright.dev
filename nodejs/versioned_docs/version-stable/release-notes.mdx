...
- Retry blocks of code until all assertions pass:
  ...
  Read more in [our documentation](./test-assertions.mdx#retrying).
...
- New method `expect.poll` to wait for an arbitrary condition:
  ...
  `expect.poll` supports most synchronous matchers, like `.toBe()`, `.toContain()`, etc. Read more in [our documentation](./test-assertions.mdx#polling).
