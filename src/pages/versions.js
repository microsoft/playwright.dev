            ...
            <table>
              <tbody>
                <tr>
                  ...
                  <td>
                    <Link to={stableVersion.path + '/class-playwright'}>Documentation</Link>
                  </td>
                  <td>
            ...
            <table>
              <tbody>
                <tr>
                  <th>master</th>
                  <td>
                    <Link to={currentVersion.path + '/class-playwright'}>Documentation</Link>
                  </td>
                  <td>
              ...
              <tbody>
                {pastVersions.map((version) => (
                  <tr key={version.name}>
                    <th>{version.label}</th>
                    <td>
                      <Link to={version.path + '/class-playwright'}>Documentation</Link>
                    </td>
                    <td>
