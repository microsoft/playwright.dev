...
// TODO: what is this section? I'm not sure.
...
Install and Playwright MCP server in your VS Code by following [the instructions](./index.mdx#getting-started).

### 2. Exploration Prompt
