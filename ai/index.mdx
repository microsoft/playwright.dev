...
For more installation options and configuration details, refer to the guides on the sidebar, or see the [README](https://github.com/microsoft/playwright-mcp).
