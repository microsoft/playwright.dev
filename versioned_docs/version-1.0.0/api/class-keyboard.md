...
For finer control, you can use [`keyboard.down`](api/class-keyboard.md#keyboarddownkey), [`keyboard.up`](api/class-keyboard.md#keyboardupkey), and [`keyboard.insertText`](api/class-keyboard.md#keyboardinserttexttext) to manually fire events as if they were generated from a real keyboard.
