...
Handles Lifetime:
- Handles can we be acquired using the page methods [`page.evaluteHandle`](./class-page.md#pageevaluatehandlepagefunction-arg), [`page.$`](./class-page.md#pageselector) or [`page.$$`](./class-page.md#pageselector-1) or
...
Alternatively, handles can be passed as arguments to [`page.evaluate`](./class-page.md#pageevaluatepagefunction-arg) function:
...
- [`page.evaluteHandle`](./class-page.md#pageevaluatehandlepagefunction-arg)
