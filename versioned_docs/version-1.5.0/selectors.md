...
Selectors query elements on the web page for interactions, like [page.click](./class-page.md#pageclickselector-options), and to obtain `ElementHandle` through [page.$](./class-page.md#pageselector). Built-in selectors auto-pierce [shadow DOM](https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_shadow_DOM).
