...
Keyboard provides an api for managing a virtual keyboard. The high level api is [`keyboard.type`](./class-keyboard.md#keyboardtypetext-options), which takes raw characters and generates proper keydown, keypress/input, and keyup events on your page.

For finer control, you can use [`keyboard.down`](./class-keyboard.md#keyboarddownkey), [`keyboard.up`](./class-keyboard.md#keyboardupkey), and [`keyboard.insertText`](./class-keyboard.md#keyboardinserttexttext) to manually fire events as if they were generated from a real keyboard.
