...
**experimental**
Emitted when video recording has started for this page. The event will fire only if [`_recordVideos`](api/class-browser.md#browsernewcontextoptions) option is configured on the parent context.
