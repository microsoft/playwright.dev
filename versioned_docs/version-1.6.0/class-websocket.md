...
- [event: 'framereceived'](./class-websocket.md#event-framereceived)
- [event: 'framesent'](./class-websocket.md#event-framesent)
- [event: 'socketerror'](./class-websocket.md#event-socketerror)
