...
ElementHandle prevents DOM element from garbage collection unless the handle is [disposed](./class-jshandle.md#jshandledispose). ElementHandles are auto-disposed when their origin frame gets navigated.

ElementHandle instances can be used as an argument in [`page.$eval()`](#pageevalselector-pagefunction-arg) and [`page.evaluate()`](./class-page.md#pageevaluatepagefunction-arg) methods.
...
- [elementHandle.check([options])](./class-elementhandle.md#elementhandlecheckoptions)
- [elementHandle.click([options])](./class-elementhandle.md#elementhandleclickoptions)
- [elementHandle.contentFrame()](./class-elementhandle.md#elementhandlecontentframe)
- [elementHandle.dblclick([options])](./class-elementhandle.md#elementhandledblclickoptions)
- [elementHandle.dispatchEvent(type[, eventInit])](./class-elementhandle.md#elementhandledispatcheventtype-eventinit)
- [elementHandle.fill(value[, options])](./class-elementhandle.md#elementhandlefillvalue-options)
- [elementHandle.focus()](./class-elementhandle.md#elementhandlefocus)
- [elementHandle.getAttribute(name)](./class-elementhandle.md#elementhandlegetattributename)
- [elementHandle.hover([options])](./class-elementhandle.md#elementhandlehoveroptions)
...
- [elementHandle.ownerFrame()](./class-elementhandle.md#elementhandleownerframe)
- [elementHandle.press(key[, options])](./class-elementhandle.md#elementhandlepresskey-options)
- [elementHandle.screenshot([options])](./class-elementhandle.md#elementhandlescreenshotoptions)
- [elementHandle.scrollIntoViewIfNeeded([options])](./class-elementhandle.md#elementhandlescrollintoviewifneededoptions)
- [elementHandle.selectOption(values[, options])](./class-elementhandle.md#elementhandleselectoptionvalues-options)
- [elementHandle.selectText([options])](./class-elementhandle.md#elementhandleselecttextoptions)
- [elementHandle.setInputFiles(files[, options])](./class-elementhandle.md#elementhandlesetinputfilesfiles-options)
- [elementHandle.tap([options])](./class-elementhandle.md#elementhandletapoptions)
- [elementHandle.textContent()](./class-elementhandle.md#elementhandletextcontent)
- [elementHandle.toString()](./class-elementhandle.md#elementhandletostring)
- [elementHandle.type(text[, options])](./class-elementhandle.md#elementhandletypetext-options)
- [elementHandle.uncheck([options])](./class-elementhandle.md#elementhandleuncheckoptions)
- [elementHandle.waitForElementState(state[, options])](./class-elementhandle.md#elementhandlewaitforelementstatestate-options)
- [elementHandle.waitForSelector(selector[, options])](./class-elementhandle.md#elementhandlewaitforselectorselector-options)
<!-- GEN:stop -->
...
- `selector` <[string]> A selector to query element for. See [working with selectors](./working-with-selectors.md) for more details.
- returns: <[Promise]<[null]|[ElementHandle]>>

The method finds an element matching the specified selector in the `ElementHandle`'s subtree. See [Working with selectors](./working-with-selectors.md) for more details. If no elements match the selector, the return value resolves to `null`.

## elementHandle.$$(selector)
- `selector` <[string]> A selector to query element for. See [working with selectors](./working-with-selectors.md) for more details.
- returns: <[Promise]<[Array]<[ElementHandle]>>>

The method finds all elements matching the specified selector in the `ElementHandle`s subtree. See [Working with selectors](./working-with-selectors.md) for more details. If no elements match the selector, the return value resolves to `[]`.
...
The method finds an element matching the specified selector in the `ElementHandle`s subtree and passes it as a first argument to `pageFunction`. See [Working with selectors](./working-with-selectors.md) for more details. If no elements match the selector, the method throws an error.
...
The method finds all elements matching the specified selector in the `ElementHandle`'s subtree and passes an array of matched elements as a first argument to `pageFunction`. See [Working with selectors](./working-with-selectors.md) for more details.
...
Focuses the element, and then uses [`keyboard.down`](./class-keyboard.md#keyboarddownkey) and [`keyboard.up`](./class-keyboard.md#keyboardupkey).
...
- `selector` <[string]> A selector of an element to wait for, relative to the element handle. See [working with selectors](./working-with-selectors.md) for more details.
- `options` <[Object]>
...
> **NOTE** This method does not work across navigations, use [page.waitForSelector(selector[, options])](./class-page.md#pagewaitforselectorselector-options) instead.
