...
- [frame.page()](./class-frame.md#framepage)
...
- [frame.tap(selector[, options])](./class-frame.md#frametapselector-options)
...
- `selector` <[string]> A selector to search for element to tap. If there are multiple elements satisfying the selector, the first will be tapped. See [working with selectors](./working-with-selectors.md) for more details.
- `options` <[Object]>
