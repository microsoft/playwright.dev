...
A Browser is created when Playwright connects to a browser instance, either through [browserType.launch([options])](./class-browsertype.md#browsertypelaunchoptions) or
[browserType.connect(params)](./class-browsertype.md#browsertypeconnectparams).
...
testing frameworks should explicitly create [browser.newContext([options])](#browsernewcontextoptions) followed by the [browserContext.newPage()](./class-browsercontext.md#browsercontextnewpage) to
