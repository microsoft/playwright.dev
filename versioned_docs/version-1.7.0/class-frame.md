...
At every point of time, page exposes its current frame tree via the [page.mainFrame()](./class-page.md#pagemainframe) and [frame.childFrames()](./class-frame.md#framechildframes)
methods.
...
- [frame.addScriptTag(script)](./class-frame.md#frameaddscripttagscript)
- [frame.addStyleTag(style)](./class-frame.md#frameaddstyletagstyle)
...
selectors](./working-with-selectors.md) for more details. If no elements match the selector, the return value resolves to
`null`.
...
`pageFunction`. See [Working with selectors](./working-with-selectors.md) for more details. If no elements match the
...
as a first argument to `pageFunction`. See [Working with selectors](./working-with-selectors.md) for more details.
