...
Handles Lifetime:
- Handles can be acquired using the page methods [`page.evaluteHandle`](./class-page.md#pageevaluatehandlepagefunction-arg), [`page.$`](./class-page.md#pageselector) or [`page.$$`](./class-page.md#pageselector-1) or
