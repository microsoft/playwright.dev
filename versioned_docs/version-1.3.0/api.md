---
id: api
title: "Playwright API <!-- GEN:version -->v1.3.0<!-- GEN:stop–>"
---
...
This method waits for an element matching `selector`, waits for [actionability](./actionability.md) checks. Then, if the element is not already checked, this method scrolls the element into view and uses [elementHandle.click](api/class-elementhandle.md#elementhandleclickoptions) to click in the center of the element.
