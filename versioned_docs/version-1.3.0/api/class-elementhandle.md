...
This method waits for [actionability](./actionability.md) checks, then scrolls the element into view if needed and uses [page.mouse](api/class-page.md#pagemouse) to click in the center of the element.
